    ...
    <div class="row ">
        ...
        <div class="col-12 py-1">
            <!-- <button type="button" class="btn btn-sm  text-white bg-magenta fg-lighTaupe eng_xxxs" id="transactionbutton"
                name="transactionbutton"> <i class="fas fa-plus-square "></i>&nbsp;Add New1</button> -->
                <button type="button" class="btn btn-sm  text-white bg-magenta fg-lighTaupe eng_xxxs"  id="addbutton" name="addbutton"> <i class="fas fa-plus-square "></i>&nbsp;Add New</button>    
                        ...
                        <div class="row customformrow">
                            ...
                            <div class="col-md-6 py-2">
                                <input required type="text" class="form-control customform eng_xxxs fg-darkCrimson"
                                    ...
                                    placeholder="Section Name" maxlength="50" minlength="3">
                        ...
                        <div class="row customformrow">
                            ...
                            <div class="col-md-6 py-2">
                                <input required type="text" class="form-control customform eng_xxxs fg-darkCrimson"
                                    ...
                                    placeholder="Section Name in Malayalam" maxlength="50" minlength="3">
                                <p class="ErrP" id="malsectionnameerror" style="color:#FF0000;"></p>
                            </div> <!-- ./col-md-6 -->
                        </div> <!-- ./row -->
                        <div class="row customformrow">
...
$(document).ready(function() {
    ...
    $('#malsectionname').on('change ', function(e) {
        ...
        if (tested) { 
            $(e.target).siblings(".ErrP").css("display","none");
        }
        else{
        // $('#malsectionname').val('');
        $(e.target).siblings(".ErrP").css("display","block");
        }
...
$('#malsectiondetails').on('summernote.change', function(we, contents, $editable) {
    ...
    $(function() {
        $("#malsectionname").keypress(function(e) {
            // alert("ddd")
            // $("#maltitleerror").html("");
            var keyCode = e.keyCode || e.which;

            $("#malsectionnameerror").html("");
...
$("#addbutton").click(function(event) {
  // alert("fff");
        ...
        let url = "{{ url('webadmin/createappsectionlist') }}";
  ...
  var id = $(this).attr('id');
        event.preventDefault();
        let editurl = "/webadmin/editappsectionlist/"+id;
    ...
    //             $('#malsectiondetails').summernote('code', data.resultdata
    //                 .malsectiondetails);
    ...
    $(document).on('click', '.delete', function() {
        ...
        swal({
            text: "Do you want to delete the App section item?",
            buttons: ["No", "Yes"]
