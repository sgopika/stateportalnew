                ...
                <div id="form_section">
                    <div class="row customformrow">
                        <div class="col-md-6 py-2">
                            ...
                            <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> Width and heifht of the poster should be 560 x 420 pix.</small>
                        </div> <!-- ./col-md-6 -->
                        <div class="col-md-6 py-2">
                            <img src="{{url('Article')}}/{{$resultdata['poster']}}" alt="poster" style="width: 100px;height:100px;"  >
                            <iput type="hidden" id="poster_path" name="poster_path" value="{{url('Article')}}/{{$resultdata['poster']}}">
                    ...
                    <div class="row customformrow">
                        <div class="col-md-6 py-2">
                            <label for="IDNAME" class="eng_xxxs fg-darkBrown">Sub Title in English</label>
                    ...
                    <div class="row customformrow">
                        <div class="col-md-6 py-2">
                            <label for="IDNAME" class="eng_xxxs fg-darkBrown">Author in English</label>
                    ...
                    <div class="row customformrow">
                        <div class="col-md-12 py-2">
                            <label for="IDNAME" class="eng_xxxs fg-darkBrown">Brief in English</label>
                    ...
                    <div class="row customformrow">
                        <div class="col-md-12 py-2">
                            <label for="IDNAME" class="eng_xxxs fg-darkBrown">Content in English</label>
