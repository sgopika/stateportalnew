      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text"  required class="form-control customform eng_xxxs fg-darkCrimson" id="entooltip1" name="entooltip1" aria-describedby="HELPNAME" placeholder="Name" maxlength="50" minlength="3">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text"  required class="form-control customform eng_xxxs fg-darkCrimson" id="maltooltip1" name="maltooltip1" aria-describedby="HELPNAME" placeholder="Name in Malayalam" maxlength="50" minlength="3">
...
/*$('#ajaxmodalform').on('submit', function(event){ 
  ...
  $(document).on('click', '.delete', function(){
      ...
      swal(
            {
              title: "Deleting Gallery Album List",
              text: "Are you sure to delete Gallery Album List?",
              type: "warning",
              buttons: true,
              dangerMode: true
            })
              ...
              $.ajax({
                  ...
                  success:function(data)
                  {
                    ...
                    $('#loader').hide();
                      ...
                      swal({
                                                        title:'Gallery Album List Deleted',
                                                        text:data.success,
                                                        type:'info',                                               
