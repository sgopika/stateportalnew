...
<div class="row ">
  ...
  <div class="col-12 py-1 px-2 ">
    <p class="eng_xxs px-3 fg-darkBrown">Add App Department List </p>
  </div> <!-- ./col12 -->
          ...
          <div class="row customformrow">
            <div class="col-md-12 py-2">
              <label for="IDNAME" class="eng_xxxs fg-darkBrown">About in English</label>
                ...
                <textarea class="summernote" id="enabout" name="enabout" aria-describedby="HELPNAME" placeholder="Name" maxlength="3000000" minlength="3"></textarea>
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    $.ajax({
         ...
         { 
            ...
            if(data.success)
            {
              swal({title:'App Department List',
                    text:data.success,
                    type:'info',
