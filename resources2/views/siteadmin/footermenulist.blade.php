...
<div class="row ">
  <div class="col-12 py-2  ">
   ...
   <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Footer Menu </strong></p>
   </div>
 <div class="col-12 py-1">
...
<div class="modal fade"  id="transactionmodal" tabindex="-1" role="dialog" aria-labelledby="addmodalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="col-md-3 py-2">
        ...
        <div class="row customformrow">
          ...
          <div class="col-md-6 py-2">
              <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="alttext" name="alttext" aria-describedby="HELPNAME" placeholder="Name" maxlength="100" minlength="3">
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="Title in english">
...
<div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Title in malayalam">
...
<div class="row customformrow">
      <div class="col-md-12 py-2">
        ...
        <textarea id="summernoteeng" name="summernoteeng" class="summernote"></textarea>
        <p id="malnameerror" class="ErrP" style="display:none; color:#FF0000;" >Only A-Z a-z Characters are allowed.</p>
      </div> <!-- ./col-md-6 -->
      <div class="col-md-12 py-2">
    ...
    <label for="IDNAME" class="eng_xxxs fg-darkBrown">Malayalam Footer Content </label>
        <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> Enter the Malayalam content.</small>
         <textarea id="summernotemal" name="summernotemal" class="summernote"></textarea>
         <p id="malnameerror" class="ErrP" style="display:none; color:#FF0000;" >Invalied characters are not allowed.</p>
...
$('#ajaxmodalform').on('submit', function(event){ 
  ...
  if(usertype==3){
    ...
    if($('#action').val() == 'Edit')
        action_url = "{{ route('siteadmin.footermenuupdate') }}";
    ...
    if($('#action').val() == 'Edit')
        action_url = "{{ route('webadmin.footermenuupdate') }}";
...
$('#summernoteeng').on('summernote.change', function(we, contents, $editable) {
        var textareaValue = $('#summernoteeng').summernote('code');
        var retval=summernoteval('summernoteeng');
        if (retval) {
    ...
    $('#summernotemal').on('summernote.change', function(we, contents, $editable) {
        var textareaValue = $('#summernotemal').summernote('code');
        var retval=summernoteval('summernotemal');
        if (retval) {
            $(we.target).siblings(".ErrP").css("display", "none");    
        } else {  
            $(we.target).siblings(".ErrP").css("display", "block");     
