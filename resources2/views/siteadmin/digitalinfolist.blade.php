...
<div class="container-fluid homepage adminpage">
  <div class="row ">
    ...
    <div class="col-12 py-1">
      <p class="py-2"> <strong> <i class="fas fa-hand-point-right"></i> &nbsp; Digital info List </strong></p>
    </div>
    <div class="col-12 py-1">
        ...
        <div class="modal-body adminpage">
          ...
          <div id="form_section">
            <div class="row customformrow">
              ...
              <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entitle" name="entitle" aria-describedby="HELPNAME" placeholder="Title in English" maxlength="100" minlength="3">
            ...
            <div class="row customformrow">
              ...
              <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltitle" name="maltitle" aria-describedby="HELPNAME" placeholder="Title in Malayalam" maxlength="100" minlength="3">
            ...
            <div class="row customformrow">
              ...
              <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="ensubtitle" name="ensubtitle" aria-describedby="HELPNAME" placeholder="Sub Title in English" maxlength="100" minlength="3">
            ...
            <div class="row customformrow">
              ...
              <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malsubtitle" name="malsubtitle" aria-describedby="HELPNAME" placeholder="Sub Title in Malayalam" maxlength="100" minlength="3">
            ...
            <div class="row customformrow">
              ...
              <div class="col-md-12 py-2">
                ...
                <p id="malcontenterror" class="ErrP" style="display:none; color:#FF0000;">Invalied Characters are not allowed.</p>
              </div> <!-- ./col-md-6 -->
            </div> <!-- ./row -->
  ...
  $(document).ready(function() {
   ...
   $('#entooltip').on('change ', function(e) {
    ...
    $("#transactionbutton").click(function(event) {
      ...
      $('#entooltip').val('Digital Info');
      $('#maltooltip').val('ഡിജിറ്റൽ വിവരം');
      $('#entitle').val('');
      $('#maltitle').val('');
      $('#ensubtitle').val('');
      $('#malsubtitle').val('');
    ...
    $('#ajaxmodalform').on('submit', function(event) {
      ...
      if (usertype == 3) {
        if ($('#action').val() == 'Add')
          action_url = "{{ route('siteadmin.digitalinfostore') }}";

        if ($('#action').val() == 'Edit')
          action_url = "{{ route('siteadmin.digitalinfoupdate') }}";
      } else if (usertype == 4) {
        if ($('#action').val() == 'Add')
          action_url = "{{ route('webadmin.digitalinfostore') }}";

        if ($('#action').val() == 'Edit')
          action_url = "{{ route('webadmin.digitalinfoupdate') }}";
      }
      $.ajax({
        url: action_url,
        method: "post",
    ...
    $(document).on('click', '.edit', function() {
      ...
      var usertype = $("#usertypeid").val();
      if (usertype == 3) {
        action_url2 = "/siteadmin/digitalinfoedit/" + id;
      } else if (usertype == 4) {
        action_url2 = "/webadmin/digitalinfoedit/" + id;
      }
      $.ajax({
        url: action_url2,
        dataType: "json",
    ...
    $(document).on('click', '.active', function() {
      ...
      var usertype = $("#usertypeid").val();
      if (usertype == 3) {
        action_url3 = "/siteadmin/digitalinfostatus/" + id;
      } else if (usertype == 4) {
        action_url3 = "/webadmin/digitalinfostatus/" + id;
      }
      $.ajax({
        url: action_url3,
        dataType: "json",
    ...
    $('#ok_button').click(function() {
      ...
      var usertype = $("#usertypeid").val();
      if (usertype == 3) {
        action_url4 = "/siteadmin/digitalinfodestroy/" + element_id;
      } else if (usertype == 4) {
        action_url4 = "/webadmin/digitalinfodestroy/" + element_id;
      }
