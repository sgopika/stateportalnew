...
<div class="container-fluid homepage adminpage">
    <div class="row ">
        ...
        <div class="col-12 py-1">
            <p class="py-2"> <strong> <i class="fas fa-hand-point-right"></i> &nbsp;Add Short Alert List </strong></p>
        </div>
        <div class="col-12 py-1">
...
$('#ajaxmodalform').on('submit', function(event) {
    ...
    if (utype == 4) {
     ...
     action_url = "{{ route('siteadmin.shortalertstore') }}";
      ...
      action_url = "{{ route('depthead.shortalertstore') }}";
     }
    }
    if ($('#action').val() == 'Edit') {
    if (utype == 4) {
    ...
    action_url = "{{ route('depthead.shortalertupdate') }}";
    }
    }
        $.ajax({
            url: action_url,
                    ...
                    swal("Updated Sucessfully")
                        .then((value) => {
                         $('#ajaxmodalform')[0].reset();
                            if (utype == 4) {
                            window.location.href='/webadmin/shortalertlist';
                            } else if (utype == 3) {
                                window.location.href='/siteadmin/shortalertlist';
                            } else if (utype == 5) {
                                window.location.href='/editor/shortalertlist';
                            } else if (utype == 14) {
                               window.location.href='/depthead/shortalertlist';
                            }
                        });
                }
            }
