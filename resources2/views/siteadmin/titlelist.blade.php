...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp; Title List </strong></p>
   </div>
 <div class="col-12 py-1">
...
<div class="modal fade"  id="transactionmodal" tabindex="-1" role="dialog" aria-labelledby="addmodalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" minlength="3" maxlength="20" required placeholder="English title">
...
<div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" minlength="3" maxlength="50" required placeholder="Malayalam title">
...
<div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="subname" name="subname" aria-describedby="HELPNAME" minlength="3" maxlength="20" required placeholder="English subtitle">
...
<div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malsubname" name="malsubname" aria-describedby="HELPNAME" minlength="3" maxlength="50" required placeholder="Malayalam subtitle">
...
$('#ajaxmodalform').on('submit', function(event){ 
  ...
  if(usertype==3){
      ...
      if($('#action').val() == 'Add')
        action_url = "{{ route('siteadmin.titlestore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('siteadmin.titleupdate') }}";

  } else if(usertype==4){

      if($('#action').val() == 'Add')
        action_url = "{{ route('webadmin.titlestore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('webadmin.titleupdate') }}";
    ...
    $.ajax({
         ...
         { 
            ...
            if(data.errors)
            {
               alert("Already an title with same name exists");
  ...
  $(document).on('click', '.edit', function(){
      ...
      var usertype=$("#usertypeid").val(); 
      if(usertype==3){
         action_url2 = "/siteadmin/titleedit/"+id;
      } else if(usertype==4){
         action_url2 = "/webadmin/titleedit/"+id;
      }
      $.ajax({
       url :action_url2,
       dataType:"json",
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
     ...
     var action_url3 = ''; 
      if(usertype==3){
         action_url3 = "/siteadmin/titlestatus/"+id;
      } else if(usertype==4){
         action_url3 = "/webadmin/titlestatus/"+id;
      }
    $.ajax({
      url:action_url3,
      dataType:"json",
