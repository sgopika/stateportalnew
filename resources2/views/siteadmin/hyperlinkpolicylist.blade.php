...
<div class="container-fluid homepage adminpage">
  <div class="row ">
    ...
    <div class="col-12 py-1">
      <p class="py-2"> <strong> <i class="fas fa-hand-point-right"></i> &nbsp;Hyperlink Policy </strong></p>
    </div>
    <div class="col-12 py-1">
        ...
        <div class="modal-body adminpage">
          ...
          <div id="form_section">
            <div class="row customformrow">
              ...
              <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entitle" name="entitle" aria-describedby="HELPNAME" placeholder="English Title" maxlength="20" minlength="3" required>
            ...
            <div class="row customformrow">
              ...
              <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltitle" name="maltitle" aria-describedby="HELPNAME" placeholder="Malayalam Title" maxlength="50" minlength="3" required>
                <p id="maltitleerror" style="display:none; color:#FF0000;">Invalied characters are not allowed.</p>
              </div> <!-- ./col-md-6 -->
            </div> <!-- ./row -->
            <div class="row customformrow">
              <div class="col-md-6 py-2">
              ...
              <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="ensubtitle" name="ensubtitle" aria-describedby="HELPNAME" placeholder="English Subtitle" maxlength="20" minlength="3">
            ...
            <div class="row customformrow">
              ...
              <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malsubtitle" name="malsubtitle" aria-describedby="HELPNAME" placeholder="Malayalam subtitle" maxlength="50" minlength="3" required>
                <p id="malsubtitleerror" style="display:none; color:#FF0000;">Invalied characters are not allowed.</p>
              </div> <!-- ./col-md-6 -->
            </div> <!-- ./row -->
            ...
            <div class="row customformrow">
              ...
              <div class="col-md-12 py-2">
                ...
                <p id="encontenterror" class="ErrP" style="display:none; color:#FF0000;">Invalied characters are not allowed.</p>
              </div> <!-- ./col-md-6 -->
            </div> <!-- ./row -->
            ...
            <div class="row customformrow">
              ...
              <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="icon" name="icon" aria-describedby="HELPNAME" placeholder="Icon class" required maxlength="150" minlength="3" value="fas fa-question-circle">
            ...
            <div class="row customformrow">
              ...
              <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entooltip" name="entooltip" aria-describedby="HELPNAME" placeholder="English Tooltip" maxlength="20" minlength="3" value="Hyperlink Policy">
            ...
            <div class="row customformrow">
              ...
              <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltooltip" name="maltooltip" aria-describedby="HELPNAME" placeholder="Malayalam Tooltip" maxlength="50" minlength="3" required value="ഹൈപ്പർലിങ്ക് പോളിസി">
                <p id="maltooltiperror" style="display:none; color:#FF0000;">Invalied characters are not allowed.</p>
              </div> <!-- ./col-md-6 -->
            </div> <!-- ./row -->
            <div class="row customformrow">
              <div class="col-md-6 py-2">
  ...
  $(document).ready(function() {
    ...
    $('#ajaxmodalform').on('submit', function(event) {
      ...
      if (usertype == 3) {
        ...
        if ($('#action').val() == 'Add')
          action_url = "{{ route('siteadmin.hyperlinkpolicystore') }}";

        if ($('#action').val() == 'Edit')
          action_url = "{{ route('siteadmin.hyperlinkpolicyupdate') }}";

      } else if (usertype == 4) {

        if ($('#action').val() == 'Add')
          action_url = "{{ route('webadmin.hyperlinkpolicystore') }}";

        if ($('#action').val() == 'Edit')
          action_url = "{{ route('webadmin.hyperlinkpolicyupdate') }}";
    ...
    $(document).on('click', '.edit', function() {
      ...
      var usertype = $("#usertypeid").val();
      if (usertype == 3) {
        action_url2 = "/siteadmin/hyperlinkpolicyedit/" + id;
      } else if (usertype == 4) {
        action_url2 = "/webadmin/hyperlinkpolicyedit/" + id;
      }
      $.ajax({
        url: action_url2,
        dataType: "json",
    ...
    $(document).on('click', '.active', function() {
      ...
      var usertype = $("#usertypeid").val();
      if (usertype == 3) {
        action_url3 = "/siteadmin/hyperlinkpolicystatus/" + id;
      } else if (usertype == 4) {
        action_url3 = "/webadmin/hyperlinkpolicystatus/" + id;
      }
      $.ajax({
        url: action_url3,
        dataType: "json",
    ...
    $('#ok_button').click(function() {
      ...
      var usertype = $("#usertypeid").val();
      if (usertype == 3) {
        action_url4 = "/siteadmin/hyperlinkpolicydestroy/" + element_id;
      } else if (usertype == 4) {
        action_url4 = "/webadmin/hyperlinkpolicydestroy/" + element_id;
      }
