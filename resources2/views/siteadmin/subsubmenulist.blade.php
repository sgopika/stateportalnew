...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp; Sub submenu List </strong></p>
   </div>
 <div class="col-12 py-1">
      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
            ...
            <div class="col-md-6 py-2">
              <label for="IDNAME" class="eng_xxxs fg-darkBrown">Sub Menu </label>
...
$("#transactionbutton").click(function(event){
    ...
    $('.modal-title').text('Add New Sub submenu');
    ...
    $("#transactionmodal").modal('show');
          ...
          // $('#urlpath').val('');
           ...
           var action_url = '';
            if(usertype==3)
           {
              action_url = "{{ route('siteadmin.subsubmenucreate') }}";
           } 
          else if(usertype==4)
          {
              action_url = "{{ route('webadmin.subsubmenucreate') }}";
...
$('#ajaxmodalform').on('submit', function(event){ 
  ...
  if(usertype==3){
      ...
      if($('#action').val() == 'Add')
        action_url = "{{ route('siteadmin.subsubmenustore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('siteadmin.subsubmenuupdate') }}";
    ...
    $.ajax({
        ...
        processData: false,
         ...
         { 
            ...
            if(data.errors)
            {
               alert("Already a Sub submenu with same name exists");
  ...
  $(document).on('click', '.edit', function(){
      ...
      var usertype=$("#usertypeid").val(); 
      if(usertype==3){
         action_url2 = "/siteadmin/subsubmenuedit/"+id;
      } else if(usertype==4){
         action_url2 = "/webadmin/subsubmenuedit/"+id;
      }
      $.ajax({
       url :action_url2,
       dataType:"json",
         ...
         // 
           ...
           console.log(data.menutype);
            ...
            $.each(data.menutype, function(index, element) {
                ...
                // console.log(data.resultdata.menulinktypes_id);
       ...
       $('#mainmenuid').empty();
            ...
            $.each(data.mainmenu, function(index, element) {
                ...
                console.log(element.id);
                 element.id == data.resultdata.submenu ? $('#mainmenuid').val(element.id).prop('selected', true) : '';
            });
   ...
   $(document).on('click', '.active', function(){
    ...
    var action_url3 = ''; 
      if(usertype==3){
         action_url3 = "/siteadmin/subsubmenustatus/"+id;
      } else if(usertype==4){
         action_url3 = "/webadmin/subsubmenustatus/"+id;
      }
    $.ajax({
      url:action_url3,
      dataType:"json",
  ...
  $('#ok_button').click(function(){
    ...
    var usertype=$("#usertypeid").val(); 
      if(usertype==3){
         action_url2 = "/siteadmin/subsubmenudestroy/"+element_id;
      } else if(usertype==4){
         action_url2 = "/webadmin/subsubmenudestroy/"+element_id;
      }
    $.ajax({
            url:action_url2,
            dataType:"json",
