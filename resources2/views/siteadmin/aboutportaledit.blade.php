...
<div class="container-fluid homepage adminpage">
    <div class="row ">
        ...
        <div class="col-12 py-1">
            <p class="py-1"> <strong> <i class="fas fa-hand-point-right"></i> &nbsp; Edit Portal </strong></p>
        </div>
        <div class="col-12 py-1">
            ...
            <div class="modal-content">
                {{-- <div class="modal-header modalover">
                    <p class="modal-title eng_xxs fg-darkEmerald" id="addmodalLabel">
                        <i class="fab fa-wpforms"></i>&nbsp;Edit Portal</p>
                </div> <!-- ./modal-header --> --}}
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entitle"
                                        ...
                                        maxlength="500" minlength="3" value="{{$resultdata['entitle']}}" required>
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltitle"
                                        ...
                                        maxlength="1000" minlength="3"  value="{{$resultdata['maltitle']}}" required>
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" class="form-control customform eng_xxxs fg-darkCrimson"
                                        ...
                                        placeholder="English subtitle" maxlength="500" minlength="3" value="{{$resultdata['ensubtitle']}}" required>
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" class="form-control customform eng_xxxs fg-darkCrimson"
                                        ...
                                        placeholder="Malayalam subtitle" maxlength="1000" minlength="3" value="{{$resultdata['malsubtitle']}}" required>
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="icon"
                                        ...
                                        maxlength="150" minlength="3" value="{{$resultdata['iconclass']}}">
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" class="form-control customform eng_xxxs fg-darkCrimson"
                                        ...
                                        placeholder="English tooltip" maxlength="500" minlength="3" value="{{$resultdata['entooltip']}}" required>
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" class="form-control customform eng_xxxs fg-darkCrimson"
                                        ...
                                        placeholder="Malayalam tooltip" maxlength="1000" minlength="3" value="{{$resultdata['maltooltip']}}" required>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.success) {
                    ...
                    swal("Success","Successfully Data Updated");
