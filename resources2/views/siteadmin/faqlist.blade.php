                ...
                <tbody id="faqcheck">
                  ...
                  <tr data-id={{ ($key == 0)?$key+1:$key }}>
                    ...
                    <td>
                      ...
                      <textarea id="eng_qstn" class="form-control customform eng_xxxs fg-darkCrimson @error('faqcheck.'.$key.'.enquestion') is-invalid @enderror" name="faqcheck[{{$key}}][enquestion]" aria-describedby="HELPNAME" placeholder="English Question" maxlength="250" minlength="3" onkeypress="validationfunction()"></textarea>&nbsp;
                      <p id="eng_qstnerror" style="display:none; color:#FF0000;">Only Malayalam Characters
                                        are allowed.</p>
                    ...
                    <td>
                      ...
                      @enderror
                      <!-- Malayalam Answer-->
                      <textarea class="form-control customform eng_xxxs fg-darkCrimson @error('faqcheck.'.$key.'.malanswer') is-invalid @enderror" name="faqcheck[{{$key}}][malanswer]" aria-describedby="HELPNAME" placeholder="Malayalam Answer" maxlength="500" minlength="3"></textarea>
                  ...
                  <tr data-id="1">
                    <th scope="row">1.English / Malayalam</th>
                    <td>
...
<script>
  $(document).ready(function() {
    ...
    $('#eng_qstn').on('change ', function(e) {
      var testval = this.value;
      var charRegExp = new RegExp('^[a-zA-Z \s]+$');
      if (!tested.test(testval)) {
        $('#eng_qstn').val('');

        $('#eng_qstnerror').slideDown("slow");
  ...
  $('body').on('click', '.plus', function() {
    ...
    $('#faqcheck').append('<tr data-id="' + i + '">\
            <th scope="row">' + i + '.English / Malayalam</th>\
            <td>\
