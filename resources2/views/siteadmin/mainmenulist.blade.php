 ...
 <div class="row customformrow">
    ...
    <div class="row customformrow">
      <div class="col-md-6 py-2">
        ...
        <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> Point to(minimum 3 digits required) .</small>
      </div> <!-- ./col-md-6 -->
      <div class="col-md-6 py-2">
    ...
    <div class="row customformrow">
      <div class="col-md-6 py-2">
        <label for="IDNAME" class="eng_xxxs fg-darkBrown">Order Number </label>
        <small id="HELPNAME" class="form-text eng_xxxxs text-muted">Enter digit only.</small>
      </div> <!-- ./col-md-6 -->
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="orderno" name="orderno" aria-describedby="HELPNAME" placeholder="Order Number">
          <p id="ordernoerror" style="display:none; color:#FF0000;" >Only Numbers are allowed.</p>
      </div> <!-- ./col-md-6 -->
    </div> <!-- ./row -->
