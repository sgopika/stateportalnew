...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Article Category </strong></p>
   </div>
 <div class="col-12 py-1">
  ...
  <div class="modal-dialog modal-lg" role="document">
    ...
    <div class="row customformrow">
      <div class="col-md-6 py-2">
        ...
        <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> Enter Article Category.</small>
      </div> <!-- ./col-md-6 -->
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="Article Category" required="" minlength="3" maxlength="50">
...
$("#transactionbutton").click(function(event){
    ...
    $('.modal-title').text('Add New Article category');
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('siteadmin.articlecategorystore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('siteadmin.articlecategoryupdate') }}";
  ...
  $(document).on('click', '.edit', function(){
      ...
      $('#ajaxformresults').html('');
      $.ajax({
       url :"/siteadmin/articlecategoryedit/"+id,
       dataType:"json",
       success:function(data)
        { 
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
    $.ajax({
      url:"/siteadmin/articlecategorystatus/"+id,
      dataType:"json",
  ...
  $('#ok_button').click(function(){
    ...
    $.ajax({
            url:"/siteadmin/articlecategorydestroy/"+element_id,
            dataType:"json",
