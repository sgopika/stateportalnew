...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Contact us</strong></p>
   </div>
  <div class="col-12 py-1">
...
$("#transactionbutton").click(function(event){
    ...
    $("#transactionmodal").modal('show');
          ...
          $('#entooltip').val('Contact Us');
          $('#maltooltip').val('ഞങ്ങളെ സമീപിക്കുക');
          $('#entitle').val('');
          $('#maltitle').val('');
          $('#ensubtitle').val('');
          $('#malsubtitle').val('');
...
$('#ajaxmodalform').on('submit', function(event){ 
  ...
  if(usertype==3){
      ...
      if($('#action').val() == 'Add')
        action_url = "{{ route('siteadmin.contactusstore') }}";
    ...
    if($('#action').val() == 'Edit')
      ...
      if($('#action').val() == 'Add')
        action_url = "{{ route('webadmin.contactusstore') }}";
  ...
  $(document).on('click', '.edit', function(){
      ...
      var usertype=$("#usertypeid").val(); 
      if(usertype==3){
         action_url2 = "/siteadmin/contactusedit/"+id;
      } else if(usertype==4){
         action_url2 = "/webadmin/contactusedit/"+id;
      }
   ...
   $(document).on('click', '.active', function(){
    ...
    var usertype=$("#usertypeid").val();
     var action_url3 = ''; 
      if(usertype==3){
         action_url3 = "/siteadmin/contactusstatus/"+id;
      } else if(usertype==4){
         action_url3 = "/webadmin/contactusstatus/"+id;
      }
    $.ajax({
      url:action_url3,
      dataType:"json",
  ...
  var usertype=$("#usertypeid").val(); 
      if(usertype==3){
         action_url2 = "/siteadmin/contactusdestroy/"+element_id;
      } else if(usertype==4){
         action_url2 = "/webadmin/contactusdestroy/"+element_id;
      }
