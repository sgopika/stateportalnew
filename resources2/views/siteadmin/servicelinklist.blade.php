      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
         ...
         <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entooltip" name="entooltip" aria-describedby="HELPNAME" placeholder="English tooltip" maxlength="500" minlength="3">
                <p id="tooltiperror" style="display:none; color:#FF0000;" >A -Z a-z Characters,Numbers and special characters(like "",&()-$_=)
allowed.</p>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow">
...
$('#ajaxmodalform').on('submit', function(event){ 
  ...
  if(usertype==3){
    ...
    if($('#action').val() == 'Edit')
      ...
      if($('#action').val() == 'Add')
        action_url = "{{ route('webadmin.servicelinkstore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('webadmin.servicelinkupdate') }}";
  ...
  $(document).on('click', '.edit', function(){
      ...
      if(usertype==3){
         ...
         action_url2 = "/webadmin/servicelinkedit/"+id;
      }
      $.ajax({
       url :action_url2,
       dataType:"json",
    ...
    var usertype=$("#usertypeid").val();
     var action_url3 = ''; 
      if(usertype==3){
         ...
         action_url3 = "/webadmin/servicelinkstatus/"+id;
      }
    $.ajax({
      url:action_url3,
      dataType:"json",
  ...
  $('#ok_button').click(function(){
    ...
    var usertype=$("#usertypeid").val(); 
      if(usertype==3){
         ...
         action_url2 = "/webadmin/servicelinkdestroy/"+element_id;
      }
    $.ajax({
            url:action_url2,
            dataType:"json",
