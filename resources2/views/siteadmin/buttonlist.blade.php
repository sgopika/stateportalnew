...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Button List </strong></p>
   </div>
 <div class="col-12 py-1">
...
<div class="modal fade"  id="transactionmodal" tabindex="-1" role="dialog" aria-labelledby="addmodalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="Enter english title">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Enter malayalam title">
 ...
 <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="iconclass" name="iconclass" aria-describedby="HELPNAME" placeholder="" value="">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="colorclass" name="colorclass" aria-describedby="HELPNAME" placeholder="">
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entooltip" name="entooltip" aria-describedby="HELPNAME" placeholder="" value="Button">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltooltip" name="maltooltip" aria-describedby="HELPNAME" placeholder="" value="ബട്ടൺ">
...
$("#transactionbutton").click(function(event){
    ...
    $("#transactionmodal").modal('show');
          ...
          $('#name').val('');
          $('#malname').val('');
          $('#entooltip').val('Button');
          $('#maltooltip').val('ബട്ടൺ');
          ...
          var action_url = '';
          if(usertype==3){   
                action_url = "{{ route('siteadmin.btncreate') }}";
          } else if(usertype==4){
                action_url = "{{ route('webadmin.btncreate') }}";
          } 
...
$('#ajaxmodalform').on('submit', function(event){ 
  var formData = new FormData(this);
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('siteadmin.buttonstore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('siteadmin.buttonupdate') }}";
  ...
  $(document).on('click', '.edit', function(){
      ...
      var usertype=$("#usertypeid").val(); 
      if(usertype==3){
         action_url2 = "/siteadmin/buttonedit/"+id;
      } else if(usertype==4){
         action_url2 = "/webadmin/buttonedit/"+id;
      }
      $.ajax({
       url :action_url2,
       dataType:"json",
   ...
   $(document).on('click', '.active', function(){
    ...
    var usertype=$("#usertypeid").val();
     var action_url3 = ''; 
      if(usertype==3){
         action_url3 = "/siteadmin/buttonstatus/"+id;
      } else if(usertype==4){
         action_url3 = "/webadmin/buttonstatus/"+id;
      }
    $.ajax({
      url:action_url3,
      dataType:"json",
  ...
  var usertype=$("#usertypeid").val(); 
      if(usertype==3){
         action_url2 = "/siteadmin/titledestroy/"+element_id;
      } else if(usertype==4){
         action_url2 = "/webadmin/titledestroy/"+element_id;
      }
