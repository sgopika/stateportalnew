...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Activitytype list </strong></p>
   </div>
 <div class="col-12 py-1">
      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="Name" maxlength="500" minlength="3" required>
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Name in Malayalam" maxlength="1000" minlength="3" required>
...
$("#transactionbutton").click(function(event){
    ...
    $('.modal-title').text('Add New Activity type');
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('siteadmin.activitytypestore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('siteadmin.activitytypeupdate') }}";
  ...
  $(document).on('click', '.edit', function(){
      ...
      $('#ajaxformresults').html('');
      $.ajax({
       url :"/siteadmin/activitytypeedit/"+id,
       dataType:"json",
       success:function(data)
        { 
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
    $.ajax({
      url:"/siteadmin/activitytypestatus/"+id,
      dataType:"json",
  ...
  $('#ok_button').click(function(){
    ...
    $.ajax({
            url:"/siteadmin/activitytypedestroy/"+element_id,
            dataType:"json",
