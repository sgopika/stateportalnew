          ...
          <div id="form_section">
            ...
            <div class="row customformrow">
              <div class="col-md-6 py-2">
                ...
                <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> Upload the logo(.png, .jpg, .jpeg,.svg)</small>
              </div> <!-- ./col-md-6 -->
              <div class="col-md-6 py-2">
            ...
            <div class="row customformrow">
              ...
              <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="alttext" name="alttext" aria-describedby="HELPNAME" placeholder="Alternative Text for logo" maxlength="250" minlength="3" required>
            ...
            <div class="row customformrow">
              ...
              <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entooltip" name="entooltip" aria-describedby="HELPNAME" placeholder="English tooltip" required>
            ...
            <div class="row customformrow">
              ...
              <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltooltip" name="maltooltip" aria-describedby="HELPNAME" placeholder="Tooltip Malayalam" required>
            ...
            <div class="row customformrow">
              ...
              <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="logourl" name="logourl" aria-describedby="HELPNAME" placeholder="URL" required>
                <p id="logourlerror" style="display:none; color:#FF0000;">Only A -Z a-z Characters are allowed.</p>
              </div> <!-- ./col-md-6 -->
            </div> <!-- ./row -->
            <div class="row customformrow">
              <div class="col-md-6 py-2">
                <label for="IDNAME" class="eng_xxxs fg-darkBrown">Logo Type </label>

              </div> <!-- ./col-md-6 -->
              <div class="col-md-6 py-2">
                <select class="form-control customform eng_xxxs fg-darkCrimson" id="logotype" name="logotype" required="required">
                  <option>Select</option>
                  <option value="1">Header logo</option>
                  <option value="2">Footer logo</option>
                  <option value="3">Stategov Widget logo</option>
                  <option value="4">Indiagov Widget logo</option>
                  <option value="5">Certifications</option>
    ...
    $('#ajaxmodalform').on('submit', function(event) {
      ...
      $.ajax({
        ...
        success: function(data) {
          var html = '';
          if (data.errors) {
            alert("Already a logo with same name exists");
    ...
    $(document).on('click', '.edit', function() {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          var option = $('option[value="'+data.resultdata.logotype+'"]');
