...
<div class="container-fluid homepage adminpage">
    <div class="row ">
        ...
        <div class="col-12 py-1">
            <p class="py-2"> <strong> <i class="fas fa-hand-point-right"></i> &nbsp; About Portal List </strong></p>
        </div>
        <div class="col-12 py-1">
                        ...
                        <div class="row customformrow">
                            ...
                            <div class="col-md-6 py-2">
                                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson"
                                    ...
                                    placeholder="Malayalam tooltip" maxlength="1000" minlength="3" required>
...
$(document).ready(function() {
    ...
    $("#transactionbutton").click(function(event) {
        ...
        let url = "{{ route('siteadmin.aboutportalcreate') }}";
    ...
    //     if (utype == 4) {
    //         action_url1 = "/webadmin/aboutportaledit/" + id;

    //     } else if (utype == 3) {

    //         action_url1 = "/siteadmin/aboutportaledit/" + id;
    //     } else if (utype == 5) {

    //         action_url1 = "/editor/aboutportaledit/" + id;
    //     }
    //     $('#ajaxformresults').html('');
    //     $.ajax({
    //         url: action_url1,
    ...
    //             if (data.error) {
    //                 swal("The About portal is Locked, So cannot be edited!");
    //             } else {
    ...
    $(document).on('click', '.edit', function() {
        var id = $(this).attr('id');
        var deptintroedit='';
        //   let url = "{{ route('siteadmin.aboutportaledit',"+id+") }}";
        url="/siteadmin/aboutportaledit/"+id; 
        document.location.href=url;
    });
    ...
    $(document).on('click', '.active', function() {
        ...
        var utype = $("#usertypeid").val();
        if (utype == 4) {
            action_url2 = "/webadmin/aboutportalstatus/" + id;

        } else if (utype == 3) {

            action_url2 = "/siteadmin/aboutportalstatus/" + id;
        } else if (utype == 5) {

            action_url2 = "/editor/aboutportalstatus/" + id;
        }
        $.ajax({
            url: action_url2,
            dataType: "json",
    ...
    $('#ok_button').click(function() {
        ...
        if (utype == 4) {
            ...
            action_url3 = "/siteadmin/aboutportaldestroy/" + element_id;
        } else if (utype == 5) {
