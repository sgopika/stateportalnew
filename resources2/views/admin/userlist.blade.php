...
<div class="modal fade"  id="transactionmodal" tabindex="-1" role="dialog" aria-labelledby="addmodalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" required minlength="3" maxlength="50" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="Placeholder value">
          <p id="nameerror"class="hasErr"  style="display:none; color:#FF0000;" >Only A -Z a-z Characters are allowed.</p>
      </div> <!-- ./col-md-6 -->
    </div> <!-- ./row -->
 <div class="row customformrow">
      <div class="col-md-6 py-2">
      ...
      <div class="col-md-6 py-2">
          <input required minlength="3" maxlength="50" type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Placeholder value">
          <p id="malnameerror"class="hasErr"  style="display:none; color:#FF0000;" >Only Malayalam Characters are allowed.</p>
      </div> <!-- ./col-md-6 -->
    </div> <!-- ./row -->
     <div class="row customformrow">
      <div class="col-md-6 py-2">
      ...
      <div class="col-md-6 py-2">
          <input required minlength="10" maxlength="10" type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="mobile" name="mobile" aria-describedby="HELPNAME" placeholder="Placeholder value">
          <p id="mobileerror"class="hasErr"  style="display:none; color:#FF0000;" >Only numbers allowed.</p>
      </div> <!-- ./col-md-6 -->
    </div> <!-- ./row -->
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <select required class="form-control customform eng_xxxs fg-darkCrimson" id="staffcategoryid" name="staffcategoryid">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
           <select required class="form-control customform eng_xxxs fg-darkCrimson" id="deptid" name="deptid">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
           <select required class="form-control customform eng_xxxs fg-darkCrimson" id="desgnid" name="desgnid">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <select required class="form-control customform eng_xxxs fg-darkCrimson" id="officeid" name="officeid">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <select required class="form-control customform eng_xxxs fg-darkCrimson" id="usertypeid" name="usertypeid">
 ...
 <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input required minlength="10" maxlength="40" type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="email" name="email" aria-describedby="HELPNAME" placeholder="Placeholder value">
          <p id="emailerror"class="hasErr"  style="display:none; color:#FF0000;" >Invalid email id.</p>
      </div> <!-- ./col-md-6 -->
    </div> <!-- ./row -->
 ...
 <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input required minlength="8"  type="password" class="form-control customform eng_xxxs fg-darkCrimson" id="password" name="password" aria-describedby="HELPNAME" placeholder="Placeholder value">
           <p id="passworderror" class="hasErr" style="display:none; color:#FF0000;">Allowed Characters are A -Z a-z 0-9 hiphen(-) at(@) hash(#) underscore(_) dot(.)</p>
      </div> <!-- ./col-md-6 -->
    </div> <!-- ./row -->
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input required minlength="3" maxlength="50" type="password" class="form-control customform eng_xxxs fg-darkCrimson" id="confirmpassword" name="confirmpassword" aria-describedby="HELPNAME" placeholder="Placeholder value">
...
$('#malname').val('');
// $('#malnameerror').removeClass("hasErr");
  ...
  $('#mobileerror').hide();
    ...
    var tested = new RegExp('^[0-9]+$');
      ...
      if(mobile.length!=10 || !tested.test(mobile)){
        $("#mobile").val('');
        // $('#mobileerror').removeClass("hasErr");
        $('#mobileerror').slideDown("slow");
        
      } else {
        $('#mobileerror').hide();
        $('#mobileerror').attr("class","hasErr");
        $('.hasErr').hide();
      }
});
...
$('#email').on('change ', function(e) {
  ...
  if(testval != '')
  {
    ...
    {
      $('#email').val('');
      // $('#emailerror').removeClass("hasErr");
      $('#emailerror').slideDown("slow");
     
    }
    else
    { 
      $('#emailerror').attr("class","hasErr");
       $('.hasErr').hide();
       $('#emailerror').hide();
...
$('#password').on('change ', function(e) {
  ...
  if (!tested.test(testval))
  {
    $('#password').val('');
    $("#password").focus();
    // $('#passworderror').removeClass("hasErr");
    $('#passworderror').slideDown("slow");

  }
  else
  {
    $('#passworderror').attr("class","hasErr");
...
$('#ajaxmodalform').on('submit', function(event){ 
              ...
              swal({
                ...
                .then((value) => {
                    if (value) {
                      ...
                      window.location.replace("{{route('admin.userlist')}}");
                    }
                });;
  ...
  $(document).on('click', '.delete', function(){
      ...
      swal(
            {
              title: "Deleting Users List",
              text: "Are you sure to delete Users List?",
              type: "warning",
              buttons: true,
              dangerMode: true
            })
