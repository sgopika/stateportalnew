...
<div class="col-md-6 py-2">
          <input type="text" minlength="1" maxlength="3" class="form-control customform eng_xxxs fg-darkCrimson" id="order" name="order" aria-describedby="HELPNAME" placeholder="Order number">
