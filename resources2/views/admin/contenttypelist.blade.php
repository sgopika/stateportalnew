...
<div class="row ">
 ...
 <div class="col-12 py-1">
  ...
  @endif
    ...
    <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;  Content Type List </strong></p>
   </div>
  <div class="col-12 py-1">
      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" minlength="3" maxlength="20"  class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Name in Malayalam" maxlength="50" minlength="3" onchange="">
...
$("#transactionbutton").click(function(event){
    ...
    $('#nameerror').hide();
    $('#malnameerror').hide();
    $('.modal-title').text('Add New Content type');
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('admin.contenttypestore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('admin.contenttypeupdate') }}";
        $('#loader').show();
    $.ajax({
         url: action_url,
         method:"post",
               ...
               swal({
                ...
                .then((value) => {
                    if (value) {
                      ...
                      window.location.replace("{{route('admin.contenttypelist')}}");
                    }
                });;
  ...
  $(document).on('click', '.edit', function(){
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
    $.ajax({
      url:"/admin/contenttypestatus/"+id,
      dataType:"json",
  ...
  $(document).on('click', '.delete', function(){
    ...
    .then((isconfirm) => {
			...
			if (isconfirm) {
			  $.ajax({
            url:"/admin/contenttypedestroy/"+element_id,
            dataType:"json",
