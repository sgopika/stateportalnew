...
<div class="row ">
 ...
 <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;  SiteControl Label List </strong></p>
   </div>
  <div class="col-12 py-1">
      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input required type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="Name" maxlength="500" minlength="3">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input required type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Name in Malayalam" maxlength="1000" minlength="3">
...
$("#transactionbutton").click(function(event){
    event.preventDefault();
     $('#nameerror').hide();
     $('#malnameerror').hide();
    $('.modal-title').text('Add New Site Control Label');
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('admin.sitecontrollabelstore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('admin.sitecontrollabelupdate') }}";
              ...
              swal({
                ...
                .then((value) => {
                    if (value) {
                      ...
                      window.location.replace("{{route('admin.sitecontrollabellist')}}");
                    }
                });;
  ...
  $(document).on('click', '.edit', function(){
     ...
     $('#malnameerror').hide();
      $('#ajaxformresults').html('');
      $.ajax({
       url :"/admin/sitecontrollabeledit/"+id,
       dataType:"json",
       success:function(data)
        { 
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
    $.ajax({
      url:"/admin/sitecontrollabelstatus/"+id,
      dataType:"json",
  ...
  $(document).on('click', '.delete', function(){
      ...
      swal(
            {
              title: "Deleting SiteControl Label List Category",
              text: "Are you sure to delete SiteControl Label List Category?",
              type: "warning",
              buttons: true,
              dangerMode: true
            })
          .then((isconfirm) => {
            ...
            if (isconfirm) {
              $.ajax({
                  url:"/admin/sitecontrollabeldestroy/"+element_id,
                  dataType:"json",
                  ...
                  success:function(data)
                  {
                    ...
                    $('#loader').hide();
                      ...
                      swal({
                                                        title:'SiteControl Label List Deleted',
                                                        text:data.success,
                                                        type:'info',                                               
                                                        buttonsStyling:false,
                                                        reverseButtons:true
