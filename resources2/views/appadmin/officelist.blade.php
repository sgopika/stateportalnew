      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input required type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="alttext" name="alttext" aria-describedby="HELPNAME" placeholder="Alt text for image" maxlength="50" minlength="3">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input required type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="Name" maxlength="50" minlength="3">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input required type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Name in Malayalam" maxlength="50" minlength="3">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <textarea required class="form-control customform eng_xxxs fg-darkCrimson" id="enaddress" name="enaddress" minlength="3" maxlength="250"></textarea>
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <textarea required class="form-control customform eng_xxxs fg-darkCrimson" id="maladdress" name="maladdress"  minlength="3" maxlength="250"></textarea>
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <textarea required class="form-control customform eng_xxxs fg-darkCrimson" id="phonenumbers" name="phonenumbers"  minlength="3" maxlength="50"></textarea>
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input required type="email" id="email" name="email" maxlength="50" minlength="10" class="form-control" >
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input required type="text" name="map" id="map" value="" class="form-control btn-point" maxlength="250"  minlength="5" required>
...
/*$('#ajaxmodalform').on('submit', function(event){ 
  ...
  $(document).on('click', '.delete', function(){
      ...
      swal(
            {
              title: "Deleting Office List",
              text: "Are you sure to delete Office List?",
              type: "warning",
              buttons: true,
              dangerMode: true
            })
