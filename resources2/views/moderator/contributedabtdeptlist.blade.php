                        ...
                        <tr>
                            ...
                            @if($val==1)<td>
                                <div class="btn-group" role="group" aria-label="Actionbuttons">
                                    ...
                                    &nbsp;
                                    <button type="button" class="btn btn-sm bg-lightBrown fg-darkCrimson eng_xxxxs reject" name="reject" id="{{ $res->id }}" data-toggle="tooltip" data-placement="top" title="Reject">
                                        <i class="fas fa-reply"></i>&nbsp;Reject</button>
                    ...
                    <div id="form_section">
                        <div class="row customformrow">
                            <div class="col-md-6 py-2">
                                ...
                                <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> Enter details here</small>
                            </div> <!-- ./col-md-6 -->
                            <div class="col-md-6 py-2">
                                <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="moderator_remarks" name="moderator_remarks" aria-describedby="HELPNAME" placeholder="Remarks.." required minlength="3" maxlength="2000"></textarea>
