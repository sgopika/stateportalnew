...
<div class="modal fade"  id="transactionmodal" tabindex="-1" role="dialog" aria-labelledby="addmodalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-12 py-2">
          <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="moderator_remarks" name="moderator_remarks" aria-describedby="HELPNAME" placeholder="Remarks.." minlength="3" maxlength="1000" required></textarea>
      </div> <!-- ./col-md-6 -->
...
$(document).on('click', '.verify', function(){
      ...
      $.ajax({
       url :"/moderator/contributeddeptintroverify/"+id,
       dataType:"json",
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    $.ajax({
         url: "{{ route('moderator.contributeddeptintroupdate') }}",
         method:"post",
         data:$(this).serialize(),
         dataType:"json",
         success:function(data)
