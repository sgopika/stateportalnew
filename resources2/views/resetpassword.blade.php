...
<div class="col-12 py-1">
  ...
  @endif
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" required id="username" name="username" maxlength="40" minlength="8" class="form-control customform eng_xxxs fg-darkCrimson" aria-describedby="HELPNAME" placeholder="Enter the User name" required>
    ...
    <div class="row customformrow">
      <div class="col-md-6 py-2 justify-content-center d-flex">
        ...
        <button id="reset" class="btn btn-sm btn-flat eng_xxxs bg-lightOrange fg-darkCrimson"> <i class="fas fa-broom"></i>&nbsp;Reset </button> &nbsp;&nbsp;
        </div>
        <div class="col-md-6 py-2 justify-content-center d-flex">
