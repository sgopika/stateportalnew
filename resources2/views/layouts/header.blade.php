...
<link rel="shortcut icon" type="image" href="{{ asset('assets/webassets/assets/images/favicon.png') }}" />

<!-- ========================= CSS here ========================= -->
<!-- bootstrap 5 -->
<link rel="stylesheet" href="{{ asset('assets/webassets/assets/bootstrap/css/bootstrap.min.css') }}" />
