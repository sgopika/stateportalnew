  ...
  <div class="col-12 py-2  ">
    <nav aria-label="breadcrumb" class="breadcrumbinner py-1 eng_xxxs">
      <ol class="breadcrumb justify-content-end px-3 pt-2">
        ...
        <li class="breadcrumb-item"><a class="no_link" href="{{ route('storymoderatorhome') }}"><i class="fas fa-home"></i>&nbsp;Home</a></li>
         <li class="breadcrumb-item"><a class="no_link" href="{{ route('storymoderator.storyitems', $val) }}"> Items</a></li>
...
$(document).on('click', '.verify', function(){
      ...
      $.ajax({
       url :"/storymoderator/moderatedstoryverify/"+id,
       dataType:"json",
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    $.ajax({
         url: "{{ route('storymoderator.moderatedstoryupdate') }}",
         method:"post",
         data:$(this).serialize(),
         dataType:"json",
         success:function(data)
