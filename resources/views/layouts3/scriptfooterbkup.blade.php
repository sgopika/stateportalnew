...
var acturlsubdetail='';
          ...
          { 
           //alert(data.deptintro);exit;
            ...
            if(data.mainmenu[i].menulinktypes_id==6){
              ...
              $("#mainmenus").append('<li class="nav-item dropdown pl-4 pl-md-0 ml-0 ml-md-4 " id="'+data.mainmenu[i].id+'"><a href="{{url('')}}/'+data.mainmenu[i].file+'" class="nav-link  py-2 px-2" role="button" aria-haspopup="true" aria-expanded="false" id="'+data.mainmenu[i].id+'" title="'+data.mainmenu[i].tooltip+'">'+data.mainmenu[i].title+'</a></li>');
              ...
              $.ajax({
                ...
                {
                  $("#mainmenus").append('<li class="nav-item dropdown pl-4 pl-md-0 ml-0 ml-md-4 " id="'+data.mainmenu[i].id+'"><a href="mainarticles/'+datas.encid+'" class="nav-link  py-2 px-2 " role="button" aria-haspopup="true" aria-expanded="false" id="'+data.mainmenu[i].id+'" title="'+data.mainmenu[i].tooltip+'">'+data.mainmenu[i].title+'</a></li>');
                }
              });
            } else if(data.mainmenu[i].menulinktypes_id==1){
              $("#mainmenus").append('<li class="nav-item dropdown pl-4 pl-md-0 ml-0 ml-md-4 " id="'+data.mainmenu[i].id+'"><a href="#'+data.mainmenu[i].file+'" class="nav-link  py-2 px-2 " role="button" aria-haspopup="true" aria-expanded="false" id="'+data.mainmenu[i].id+'" title="'+data.mainmenu[i].tooltip+'">'+data.mainmenu[i].title+'</a></li>');
            } else if(data.mainmenu[i].menulinktypes_id==3){
              $("#mainmenus").append('<li class="nav-item dropdown pl-4 pl-md-0 ml-0 ml-md-4 " id="'+data.mainmenu[i].id+'"><a href="{{asset('Mainmenu')}}/'+data.mainmenu[i].file+'" target="_blank" class="nav-link  py-2 px-2 " role="button" aria-haspopup="true" aria-expanded="false" id="'+data.mainmenu[i].id+'" title="'+data.mainmenu[i].tooltip+'">'+data.mainmenu[i].title+'</a></li>');
            }
            else {
              $("#mainmenus").append('<li class="nav-item dropdown pl-4 pl-md-0 ml-0 ml-md-4"><a class="nav-link" href="#" title="'+data.mainmenu[i].tooltip+'">'+data.mainmenu[i].title+'</a></li>');
            }
  ...
  // $(document).on("mouseover", ".mainsublist", function(event){ 
  //    var id='';
  //    var mainmenuencid='';
  //    var submenuencid='';
  //   id = $(this).attr('id');
  ...
  //   $.ajax({
  //       url :"/setvaluesencrypt/"+id,
  //       dataType:"json",
  //       success:function(datas7)
  //       {//alert("3");
  //       var acturlsubdetail='';
  //           // acturlsubdetail1 = "{{url('subdetail') }}" + '/' + datas6.encid + '/' + datas7.encid;
  //           //  alert(acturlsubdetail);
  //           //  var frstid=datas6.encid;
  //           //  var secid=datas7.encid;
  //           //acturlsubdetail1="test";
  //           mainmenuencid=datas7.encid;
  ...
  //   $(".listmenus"+id).empty('');
  //   $(".submenus"+id).append('<div class="dropdown-menu kg-ii-font" aria-labelledby="about-dropdown"><div class="row align-items-start listmenus'+id+'">');
  //   $.ajax({
  //      url :"/submenuslist/"+id,
  //      dataType:"json",
  //      success:function(data)
  ...
  //         $.each( data.resultdata1, function(i,value1) {
  ...
  //             if(count%4==0)
  //             {
  //             myHtml +='<div class="col-sm-6 col-md-3"><ul class="list-unstyled">';
  //             }
  //                 count++;

  //                 var acturl = '';

  //                 if(data.resultdata1[i].title=='Departments'){
  //                     acturl = "{{url('deptdetails') }}";
                              
  //                     myHtml +='<li><a class="dropdown-item " href="'+acturl+'">'+data.resultdata1[i].title+'</a></li>';
  //                 } else if(data.resultdata1[i].menulinktypes_id==4 ){


  //                       var subtitle = data.resultdata1[i].title;
                          
  //                         $.ajax({
  //                           url :"/setvaluesencrypt/"+data.resultdata1[i].id,
  //                           dataType:"json",
  //                           success:function(datas6)
  //                           {
  //                             //alert("2");
  //                             submenuencid= datas6.encid;  
  //                             console.log(submenuencid);

  //                             acturlsubdetail1 = "{{url('subdetail') }}" + '/' + submenuencid + '/' + mainmenuencid;
                              
  //                             myHtml +='<li><a class="dropdown-item" href="'+acturlsubdetail1+'">'+subtitle+'</a></li>';
  ...
  //                         // alert(acturlsubdetail+"--"+data.resultdata1[i].title);
  //                         //acturlsubdetail = "{{url('subdetail') }}" + '/' + datas6.encid + '/' + datas7.encid; alert(acturlsubdetail);
  //                         //myHtml +='<li><a class="dropdown-item" href="{{url('subdetail') }}'+'/'+frstid+'/'+secid+'">'+data.resultdata1[i].title+'</a></li>';
                           
                           
  //                           // myHtml +='<li><a class="dropdown-item" href="'+acturlsubdetail+'">'+data.resultdata1[i].title+'</a></li>';  
                       
  //                 } else if(data.resultdata1[i].menulinktypes_id==2 ){
  //                     acturl = data.resultdata1[i].file ;
  //                     myHtml +='<li><a class="dropdown-item " target="_blank" data-toggle="tooltip" data-placement="top" title="'+data.toolmsg+'" href="'+acturl+'">'+data.resultdata1[i].title+'</a></li>';

  //                 } else if(data.resultdata1[i].menulinktypes_id==5 ){
  //                     acturl =data.resultdata1[i].file ;
  //                     myHtml +='<li><a class="dropdown-item " href="{{url('')}}/'+acturl+'">'+data.resultdata1[i].title+'</a></li>';

  //                 } else if(data.resultdata1[i].menulinktypes_id==1 ){
  //                     acturl =data.resultdata1[i].file ;
  //                     myHtml +='<li><a class="dropdown-item " href="#'+acturl+'">'+data.resultdata1[i].title+'</a></li>';

  //                 } else if(data.resultdata1[i].menulinktypes_id==3 ){
  //                     acturl ="{{url('Submenu')}}/"+data.resultdata1[i].file ;
  //                     myHtml +='<li><a class="dropdown-item " href="'+acturl+'">'+data.resultdata1[i].title+'</a></li>';
  ...
  //         $(".listmenus"+id).append(myHtml);        

  //          $(".submenus"+id).append('</div></div>'); 
  //          $("#mainmenus").append('</li>');
  //       }
  //     })
  // });
  ...
  $(document).on("mouseover", ".mainsublist", function(event){ 
    ...
    $.ajax({
        ...
        success:function(datas7)
        {
            /*acturlsubdetail = "{{url('subdetail') }}" + '/' + datas6.encid + '/' + datas7.encid;*/
            mainencid = datas7.encid;
       ...
       success:function(data)
        { //alert(data);
          ...
          $.each( data.resultdata1, function(i,value1) {
            ...
            /*if(data.resultdata1[i].menulinktypes_id==4 ){
              ...
              myHtml +='<div class="col-sm-6 col-md-3"><ul class="list-unstyled">';
                  ...
                  if(data.resultdata1[i].title=='Departments'){
                      ...
                      myHtml +='<li><a class="dropdown-item " style="width: 110% !important;" href="'+acturl+'">'+data.resultdata1[i].title+'</a></li>';
                  } else if(data.resultdata1[i].menulinktypes_id==4 ){
                    
                         acturlsubdetail = "{{url('subdetail') }}" + '/' + data.resultdata1[i].encsubid + '/' + mainencid;     
                       myHtml +='<li><a class="dropdown-item" style="width: 110% !important;" href="'+acturlsubdetail+'">'+data.resultdata1[i].title+'</a></li>';
                  } else if(data.resultdata1[i].menulinktypes_id==2 ){
                      acturl = data.resultdata1[i].file ;
                      myHtml +='<li><a class="dropdown-item " style="width: 110% !important;" target="_blank" data-toggle="tooltip" data-placement="top" title="'+data.toolmsg+'" href="'+acturl+'">'+data.resultdata1[i].title+'</a></li>';

                  } else if(data.resultdata1[i].menulinktypes_id==5 ){
                      acturl =data.resultdata1[i].file ;
                      myHtml +='<li><a class="dropdown-item " style="width: 110% !important;" href="{{url('')}}/'+acturl+'">'+data.resultdata1[i].title+'</a></li>';
   ...
   /*$(document).on("click", ".mainsublist", function(event){
     var id='';
    id = $(this).attr('id');
    $(".listmenus"+id).empty('');
    $(".submenus"+id).append('<div class="dropdown-menu kg-ii-font" aria-labelledby="about-dropdown"><div class="row align-items-start listmenus'+id+'">');
