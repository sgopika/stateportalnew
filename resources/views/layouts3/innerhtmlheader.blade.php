...
<head>
    ...
    <link href="{{ asset('assets/sumernotewithmerge/script/summernote/summernote-lite.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('assets/sumernotewithmerge/script/summernote/plugin/table/summernote-ext-table.css') }}" rel="stylesheet" type="text/css">
