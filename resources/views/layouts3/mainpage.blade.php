		...
		<div id="bannersite" class="carousel slide" data-ride="carousel">
		  ...
		  <div class="carousel-inner">
		    <div class="carousel-item active">
		      <img onerror="this.onerror=null;this.src='assets/img/onerror.gif';" src="assets/uploads/banner1.jpeg" class="d-block w-100" alt="Banner Image">
		    </div>
		    <div class="carousel-item">
		      <img onerror="this.onerror=null;this.src='assets/img/onerror.gif';" src="assets/uploads/banner2.jpeg" class="d-block w-100" alt="Banner Image">
		    </div>
		    <div class="carousel-item">
		      <img onerror="this.onerror=null;this.src='assets/img/onerror.gif';" src="assets/uploads/banner3.jpeg" class="d-block w-100" alt="Banner Image">
		    </div>
		  </div>
		...
		<div class="card-body"> 
			<div class="row">
				<div class="col-md-3 text-center">
					<img onerror="this.onerror=null;this.src='assets/img/onerror.gif';" src="assets/uploads/user3.jpg" class="authorimage" alt="owner">
					<p class=""> Name of author </p>
					<p class=""> Designation of author </p>
				</div> <!-- ./col-3 -->
				<div class="col-md-3 text-center">
					<img onerror="this.onerror=null;this.src='assets/img/onerror.gif';" src="assets/uploads/user2.jpg" class="authorimage" alt="owner">
					<p class=""> Name of author </p>
					<p class=""> Designation of author </p>
				</div> <!-- ./col-3 -->
				<div class="col-md-6 ">
...
<div class="row py-5">
	<div class="col-md-3 py-2">
		<div class="card">
		  <img onerror="this.onerror=null;this.src='assets/img/onerror.gif';" src="assets/uploads/act1.jpg" class="card-img-top previewcard" alt="gallery-preview">
	...
	<div class="col-md-3 py-2">
		<div class="card">
		  <img onerror="this.onerror=null;this.src='assets/img/onerror.gif';" src="assets/uploads/act2.jpg" class="card-img-top previewcard" alt="gallery-preview">
		  <div class="card-body previewcardbody text-center">
		    <p class=""> Title </p>
		    </div> <!-- ./card-body -->
		</div> <!-- ./card -->
	...
	<div class="col-md-3 py-2">
		<div class="card">
		  <img onerror="this.onerror=null;this.src='assets/img/onerror.gif';" src="assets/uploads/act3.jpg" class="card-img-top previewcard" alt="gallery-preview">
		  <div class="card-body previewcardbody text-center">
		    <p class=""> Title </p>
		    </div> <!-- ./card-body -->
		</div> <!-- ./card -->
	...
	<div class="col-md-3 py-2">
		<div class="card">
		  <img onerror="this.onerror=null;this.src='assets/img/onerror.gif';" src="assets/uploads/act4.jpg" class="card-img-top previewcard" alt="gallery-preview">
		  <div class="card-body previewcardbody text-center">
		    <p class=""> Title </p>
		    </div> <!-- ./card-body -->
		</div> <!-- ./card -->
			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-4 py-2 text-center align-items-middle">
						<img onerror="this.onerror=null;this.src='assets/img/onerror.gif';" src="assets/uploads/user5.jpg" class="authorimage" alt="author">
					</div> <!-- ./col4 -->
		...
		<div class="card articlecard py-3 my-3" id="secondarticle">
			<div class="card-body">
				<div class="row">
					...
					<div class="col-md-4 py-2 text-center align-items-middle">
						<img onerror="this.onerror=null;this.src='assets/img/onerror.gif';" src="assets/uploads/user6.jpg" class="authorimage" alt="author">
					</div> <!-- ./col4 -->
				</div> <!-- ./inner-card-row -->
			</div> <!-- ./card-body -->
		</div> <!-- ./card -->
		...
		<div class="card-body"> 
			<div class="row equal">
				<div class="col-md-4 py-3 text-center">
					...
					<img onerror="this.onerror=null;this.src='assets/img/onerror.gif';" src="assets/uploads/magazine.jpg" class="magazineposter" alt="owner">
					</div> <!-- ./contactdiv -->
				</div> <!-- ./col-3 -->
