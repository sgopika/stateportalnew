...
<div class="container-fluid homepage adminpage">
    <div class="row ">
        ...
        <div class="col-12 py-1">
            <p class="py-2"> <strong> <i class="fas fa-hand-point-right"></i> &nbsp; Edit What's New </strong></p>
        </div>
        <div class="col-12 py-1">
                    ...
                    <div class="modal-body adminpage">
                        ...
                        <div id="form_section">
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="ensubtitle" name="ensubtitle" aria-describedby="HELPNAME" placeholder="English subtitle" maxlength="500" minlength="3" value="{{$resultdata->ensubtitle}}">
                            ...
                            <div class="row customformrow">
                                <div class="col-md-12 py-2">
                                    ...
                                    <textarea class="summernote" id="encontent" name="encontent" aria-describedby="HELPNAME" placeholder="Name" maxlength="30000" minlength="3">{{$resultdata->encontent}}</textarea>
                            ...
                            <div class="row customformrow">
                                <div class="col-md-12 py-2">
                                    ...
                                    <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> Enter the malayalam
                                        content.</small><textarea class="summernote" id="malcontent" name="malcontent" aria-describedby="HELPNAME" placeholder="Name in Malayalam" maxlength="30000" minlength="3">{{$resultdata->malcontent}}</textarea>
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="icon" name="icon" aria-describedby="HELPNAME" placeholder="Icon class" maxlength="150" minlength="3" value="{{$resultdata->iconclass}}">
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entooltip" name="entooltip" aria-describedby="HELPNAME" placeholder="English tooltip" maxlength="500" minlength="3" required value="{{$resultdata->entooltip}}">
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltooltip" name="maltooltip" aria-describedby="HELPNAME" placeholder="Malayalam tooltip" required maxlength="1000" minlength="3" value="{{$resultdata->maltooltip}}">
