...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp; Submenu List </strong></p>
   </div>
 <div class="col-12 py-1">
...
<div class="modal fade"  id="transactionmodal" tabindex="-1" role="dialog" aria-labelledby="addmodalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
            ...
            <div class="col-md-6 py-2">
              <label for="IDNAME" class="eng_xxxs fg-darkBrown">Parent Menu </label>
               <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> Select the parent menu.</small>
            </div> <!-- ./col-md-6 -->
            <div class="col-md-6 py-2">
                <select class="form-control customform eng_xxxs fg-darkCrimson" id="mainmenuid" name="mainmenuid" required></select>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow">
            <div class="col-md-6 py-2">
              <label for="IDNAME" class="eng_xxxs fg-darkBrown">Menu Type </label>
               <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> Select the menu type.</small>
            </div> <!-- ./col-md-6 -->
            <div class="col-md-6 py-2">
                <select class="form-control customform eng_xxxs fg-darkCrimson" id="menutypeid" name="menutypeid" required></select>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow" id="showdiv">
            <div class="col-md-6 py-2">
              <label for="IDNAME" class="eng_xxxs fg-darkBrown">Path </label>
               <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> Enter the url/path.</small>
            </div> <!-- ./col-md-6 -->
            <div class="col-md-6 py-2">
               
                <input type="text"  id="urlpath" name="urlpath" class="form-control customform eng_xxxs fg-darkCrimson" placeholder="Url path">
     ...
     <div class="row customformrow" id="showdiv3">
      ...
      <div class="col-md-6 py-2">
          <select class="form-control customform eng_xxxs fg-darkCrimson" id="departmentid" name="departmentid">
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="English title" required minlength="3" maxlength="500">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Malayalam title" required minlength="3" maxlength="1000">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entooltip" name="entooltip" aria-describedby="HELPNAME" placeholder="English tooltip" required minlength="3" maxlength="500">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltooltip" name="maltooltip" aria-describedby="HELPNAME" placeholder="Malayalam tooltip" required maxlength="1000" minlength="3">
 ...
 <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="iconclass" name="iconclass" aria-describedby="HELPNAME" minlength="3" maxlength="1000" required>
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="pointto" name="pointto" aria-describedby="HELPNAME" placeholder="Point to" minlength="3" maxlength="500" required>
      </div> <!-- ./col-md-6 -->
    </div> <!-- ./row -->
...
$('#iconclass').on('change ', function(e) {
  ...
  else if(menutype=='App Department'){
      $('#showdiv').hide();
      $('#showdiv1').hide();
      $('#showdiv2').hide();
      $('#showdiv3').show();
    ...
    $("#transactionmodal").modal('show');
          ...
          // $('#urlpath').val('');
           ...
           var action_url = '';
            if(usertype==2)
           {
              action_url = "{{ route('siteadmin.submenucreate') }}";
           } 
          else if(usertype==4)
          {
              action_url = "{{ route('webadmin.submenucreate') }}";
       ...
       success:function(data)
        {
            ...
            $.each(data.menutype, function(index, element) {
             ...
             $('#mainmenuid').empty();
            $('#mainmenuid').append($('<option></option>').val('0').html('Select'));
            $.each(data.mainmenu, function(index, element) {
                $('#mainmenuid').append(
                    $('<option></option>').val(element.id).html(element.entitle)
                );
            });
            ...
            $('#departmentid').empty();
            $('#departmentid').append($('<option></option>').val('0').html('Select'));
            $.each(data.deptcategories, function(index, element) {
                $('#departmentid').append(
                    $('<option></option>').val(element.id).html(element.entitle)
                );
            });
...
$('#ajaxmodalform').on('submit', function(event){ 
  ...
  if(usertype==2){
      ...
      if($('#action').val() == 'Add')
        action_url = "{{ route('siteadmin.submenustore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('siteadmin.submenuupdate') }}";

  } else if(usertype==4){

      if($('#action').val() == 'Add')
        action_url = "{{ route('webadmin.submenustore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('webadmin.submenuupdate') }}";
    ...
    $.ajax({
        ...
        processData: false,
         ...
         { 
            ...
            if(data.errors)
            {
               alert("Already a submenu with same name exists");
  ...
  $(document).on('click', '.edit', function(){
      ...
      var usertype=$("#usertypeid").val(); 
      if(usertype==2){
         action_url2 = "/siteadmin/submenuedit/"+id;
      } else if(usertype==4){
         action_url2 = "/webadmin/submenuedit/"+id;
      }
      $.ajax({
       url :action_url2,
       dataType:"json",
       success:function(data)
        { 
         ...
         if(data.resultdata.menulinktypes_id==13)
          {
          ...
          $('#showdiv3').show();
            ...
            $.each(data.deptcategories, function(index, element) {
                $('#departmentid').append(
                  ...
                  element.id == data.resultdata.file ? $('#departmentid').val(element.id).prop('selected', true) : '';   
            });
         ...
         else if(data.resultdata.menulinktypes_id==5)
        {
          ...
          $('#showdiv1').show();
           $('#showdiv').hide();
           $('#showdiv3').hide();
            $("#fileview").attr('href',"{{asset('Submenu')}}/"+data.resultdata.file);
        }
         else
         {
       ...
       $('#mainmenuid').empty();
            ...
            $.each(data.mainmenu, function(index, element) {
                $('#mainmenuid').append(
                 ...
                 element.id == data.resultdata.parentmenu ? $('#mainmenuid').val(element.id).prop('selected', true) : '';
            });
   ...
   $(document).on('click', '.active', function(){
    ...
    var action_url3 = ''; 
      if(usertype==2){
         action_url3 = "/siteadmin/submenustatus/"+id;
      } else if(usertype==4){
         action_url3 = "/webadmin/submenustatus/"+id;
      }
    $.ajax({
      url:action_url3,
      dataType:"json",
  ...
  $('#ok_button').click(function(){
    ...
    var usertype=$("#usertypeid").val(); 
      if(usertype==2){
         action_url2 = "/siteadmin/submenudestroy/"+element_id;
      } else if(usertype==4){
         action_url2 = "/webadmin/submenudestroy/"+element_id;
      }
    $.ajax({
            url:action_url2,
            dataType:"json",
