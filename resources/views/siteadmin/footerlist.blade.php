          ...
          <div class="row customformrow">
            <div class="col-md-6 py-2">
              <label for="IDNAME" class="eng_xxxs fg-darkBrown">File </label>
               <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> (png','jpg','jpeg)</small>
            </div> <!-- ./col-md-6 -->
            <div class="col-md-6 py-2">
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <!-- <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="Placeholder value"> -->
           <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="Title" maxlength="1000" minlength="3"></textarea>
...
<div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
         <!--  <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Placeholder value"> -->
           <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Malayalam title" maxlength="1000" minlength="3"></textarea>
...
<div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
        <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="subname" name="subname" aria-describedby="HELPNAME" placeholder="Sub title" maxlength="1000" minlength="3"></textarea>
