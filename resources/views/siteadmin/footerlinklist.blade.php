...
<div class="row ">
  <div class="col-12 py-2  ">
   ...
   <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Footerlink </strong></p>
   </div>
 <div class="col-12 py-1">
...
<div class="modal fade"  id="transactionmodal" tabindex="-1" role="dialog" aria-labelledby="addmodalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="Title in English " maxlength="250" minlength="3">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Title in Malayalam" maxlength="250" minlength="3">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entooltip" name="entooltip" aria-describedby="HELPNAME" placeholder="Tooltip in English" maxlength="250" minlength="3">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltooltip" name="maltooltip" aria-describedby="HELPNAME" placeholder="Tooltip in Malayalam"  maxlength="250" minlength="3">
 ...
 <div class="row customformrow">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="urlpath" name="urlpath" aria-describedby="HELPNAME" placeholder="url">
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    if($('#action').val() == 'Edit')
     ...
     $.ajax({
         ...
         { 
            ...
            if(data.errors)
            {
               alert("Already a footer link with same name exists");
  ...
  $('#ok_button').click(function(){
    ...
    $.ajax({
            url:"/siteadmin/footerlinkdestroy/"+element_id,
            dataType:"json",
