...
<div class="modal fade"  id="transactionmodal" tabindex="-1" role="dialog" aria-labelledby="addmodalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" maxlength="500" minlength="3" placeholder="Title in English">
          <p id="nameerror" style="display:none; color:#FF0000;" >A -Z a-z Characters,Numbers and special characters(like "",&()-$_=) allowed.</p>
      </div> <!-- ./col-md-6 -->
    </div> <!-- ./row -->
     <div class="row customformrow">
      <div class="col-md-6 py-2">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" maxlength="500" minlength="3"  placeholder="Title in Malayalam">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entooltip" name="entooltip" aria-describedby="HELPNAME"  maxlength="500" minlength="3" placeholder="Tooltip in English">
          <p id="entooltiperror" style="display:none; color:#FF0000;" >A -Z a-z Characters,Numbers and special characters(like "",&()-$_=) allowed.</p>
      </div> <!-- ./col-md-6 -->
    </div> <!-- ./row -->
     <div class="row customformrow">
      <div class="col-md-6 py-2">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltooltip" name="maltooltip" aria-describedby="HELPNAME" maxlength="500" minlength="3"  placeholder="Tooltip in Malayalam ">
 ...
 <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="iconclass" name="iconclass" aria-describedby="HELPNAME" maxlength="500" minlength="3"  placeholder="Icon Class">
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="pointto" name="pointto" aria-describedby="HELPNAME" maxlength="500" minlength="3"  placeholder="pointto">
      </div> <!-- ./col-md-6 -->
    </div> <!-- ./row -->
    <div class="row customformrow">
      <div class="col-md-6 py-2">
        <label for="IDNAME" class="eng_xxxs fg-darkBrown">Order No</label>
        <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> Order No.</small>
      </div> <!-- ./col-md-6 -->
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="orderno" name="orderno" aria-describedby="HELPNAME" minlength="1" maxlength="2" placeholder="Order No">
      </div> <!-- ./col-md-6 -->
    </div> <!-- ./row -->
...
$('#ajaxmodalform').on('submit', function(event){ 
  ...
  if(usertype==2){
    ...
    if($('#action').val() == 'Edit')
        action_url = "{{ route('siteadmin.mainmenuupdate') }}";
    ...
    if($('#action').val() == 'Edit')
        action_url = "{{ route('webadmin.mainmenuupdate') }}";
    ...
    $.ajax({
        ...
        processData: false,
         ...
         { 
            ...
            if(data.errors)
            {
               alert("Already a Mainmenu with same name exists");
      ...
      $.ajax({
       ...
       success:function(data)
        { 
          ...
          $('#orderno').val(data.resultdata.orderno);
     ...
     $('#articleid').empty();
            ...
            $.each(data.article, function(index, element) {
                $('#articleid').append(
                 ...
                 element.id == data.resultdata.menulinktypes_id ? $('#articleid').val(element.id).prop('selected', true) : '';
            });
