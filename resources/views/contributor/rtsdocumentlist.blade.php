...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Right to Service</strong></p>
   </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer modalover">
        ...
        <textarea id="hid_encontent" hidden="hidden" class="hid_encontent" cols="50" rows="3" style="padding:5px;" 
  name="hid_encontent" >   </textarea>
   <textarea id="hid_malcontent" hidden="hidden" class="hid_malcontent" cols="50" rows="3" style="padding:5px;" 
  name="hid_malcontent" >   </textarea>
...
$("#filedate").inputmask("dd/mm/yyyy", {"placeholder": "dd/mm/yyyy", "yearrange":{minyear: 1957, maxyear: max_year }});
   $('#encontent').on('summernote.init', function () {
        $('textarea.hid_encontent').html($('#encontent').summernote("code"))
...
$('#malcontent').on('summernote.init', function () {
        $('textarea.hid_malcontent').html($('#malcontent').summernote("code"))
    }).on("summernote.blur", function () {
         $('textarea.hid_malcontent').html($('#malcontent').summernote("code"))
...
$("#transactionbutton").click(function(event){
    ...
    $('.modal-title').text('Add New Right to Service');
  ...
  var action_url = '';
 action_url="{{ route('contributor.rtsdocumentcreate') }}";
       ...
       success:function(data)
        {
           ...
           $('#departments_id').empty();
            ...
            $('#enkeyword').val('');
            $('#malkeyword').val('');
            $('#encontent').summernote('code','');
            $('#malcontent').summernote('code','');
...
$('#ajaxmodalform').on('submit', function(event){ 
   var formData = new FormData(this);
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('contributor.rtsdocumentstore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('contributor.rtsdocumentupdate') }}";
  ...
  $(document).on('click', '.edit', function(){
      ...
      var action_url2 = '';
         ...
         action_url2 = "/contributor/rtsdocumentedit/"+id;
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
      ...
      var action_url3 = '';
         ...
         action_url3 = "/contributor/rtsdocumentstatus/"+id;
  ...
  $('#ok_button').click(function(){
    var usertype=$("#usertypeid").val(); 
      var action_url4 = '';
         ...
         action_url4 = "/contributor/rtsdocumentdestroy/"+element_id;
