...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Citizen Charter</strong></p>
   </div>
               ...
               @php
                ...
                <tr>
                    ...
                    <td><span class="eng_xxxxs"> {{ date('d-m-Y', strtotime($res->documentdate)) }} </span> </td> 
                     ...
                     <td><span class="eng_xxxxs"> <a target="_blank" href="{{ asset('Citizencharter').'/'.$res->filepath }}">View File</a></span> </td>
      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
           ...
           <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="date" placeholder="dd/mm/yyyy" id="filedate" name="filedate"  />
...
$("#transactionbutton").click(function(event){
    ...
    $('.modal-title').text('Add New Citizen Charter');
  ...
  var action_url = '';
 action_url="{{ route('contributor.citizenchartercreate') }}";
...
$('#ajaxmodalform').on('submit', function(event){ 
   var formData = new FormData(this);
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('contributor.citizencharterstore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('contributor.citizencharterupdate') }}";
    ...
    $.ajax({
         ...
         { 
            ...
            if(data.errors)
            {
               alert("Already a Citizen Charter with same exists");
  ...
  $(document).on('click', '.edit', function(){
      ...
      var action_url2 = '';
         ...
         action_url2 = "/contributor/citizencharteredit/"+id;
        ...
        { 
          if(data.error){
            alert("The Article is Locked, So cannot be edited!");
             ...
             var urlpath="{{asset('Citizencharter')}}/"+data.resultdata.filepath;
              $('#filepdf').show();
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
      ...
      var action_url3 = '';
         ...
         action_url3 = "/contributor/citizencharterstatus/"+id;
  ...
  $('#ok_button').click(function(){
    var usertype=$("#usertypeid").val(); 
      var action_url4 = '';
         ...
         action_url4 = "/contributor/citizencharterdestroy/"+element_id;
