...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Advertisement</strong></p>
   </div>
...
$("#transactionbutton").click(function(event){
    ...
    $('.modal-title').text('Add New Advertisement');
  ...
  var action_url = '';
 action_url="{{ route('contributor.advertisementcreate') }}";
...
$('#ajaxmodalform').on('submit', function(event){ 
   var formData = new FormData(this);
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('contributor.advertisementstore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('contributor.advertisementupdate') }}";
  ...
  $(document).on('click', '.edit', function(){
      ...
      var action_url2 = '';
         ...
         action_url2 = "/contributor/advertisementedit/"+id;
        ...
        { 
          if(data.error){
            alert("The Article is Locked, So cannot be edited!");
             ...
             var urlpath="{{asset('Advertisement')}}/"+data.resultdata.filepath;
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
      ...
      var action_url3 = '';
         ...
         action_url3 = "/contributor/advertisementstatus/"+id;
  ...
  $('#ok_button').click(function(){
    var usertype=$("#usertypeid").val(); 
      var action_url4 = '';
         ...
         action_url4 = "/contributor/advertisementdestroy/"+element_id;
