...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Five Year Plan</strong></p>
   </div>
               ...
               @php
                ...
                <tr>
                    <td><span class="eng_xxxxs"> {{ $i }} </span> </td>
                     ...
                     <td><span class="eng_xxxxs"> <a target="_blank" href="{{ asset('Fiveyearplan').'/'.$res->filepath }}">View File</a></span> </td>
...
$("#transactionbutton").click(function(event){
    ...
    $('.modal-title').text('Add New Five Year Plan');
  ...
  var action_url = '';
 action_url="{{ route('contributor.fiveyearplancreate') }}";
...
$('#ajaxmodalform').on('submit', function(event){ 
   var formData = new FormData(this);
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('contributor.fiveyearplanstore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('contributor.fiveyearplanupdate') }}";
    ...
    $.ajax({
         ...
         { 
            ...
            if(data.errors)
            {
               alert("Already a Five Year Plan exists");
  ...
  $(document).on('click', '.edit', function(){
      ...
      var action_url2 = '';
         ...
         action_url2 = "/contributor/fiveyearplanedit/"+id;
        ...
        { 
          if(data.error){
            alert("The Article is Locked, So cannot be edited!");
             ...
             var urlpath="{{asset('Fiveyearplan')}}/"+data.resultdata.filepath;
              $('#filepdf').show();
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
      ...
      var action_url3 = '';
         ...
         action_url3 = "/contributor/fiveyearplanstatus/"+id;
  ...
  $('#ok_button').click(function(){
    var usertype=$("#usertypeid").val(); 
      var action_url4 = '';
         ...
         action_url4 = "/contributor/fiveyearplandestroy/"+element_id;
