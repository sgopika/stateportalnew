...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Press Release</strong></p>
   </div>
               ...
               @php
                ...
                <tr>
                    ...
                    <td><span class="eng_xxxxs"> {{ date('d-m-Y', strtotime($res->documentdate)) }} </span> </td> 
                     ...
                     <td><span class="eng_xxxxs"> <a target="_blank" href="{{ asset('Docguidelines').'/'.$res->filepath }}">View File</a></span> </td>
      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
           ...
           <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input  type="date" data-inputmask-alias="date" data-inputmask-inputformat="dd/mm/yyyy" maxDate="30/07/2021" im-insert="false" placeholder="dd/mm/yyyy" id="filedate" name="filedate" min="10" maxlength="10"  />
      ...
      <div class="col-md-6 py-2">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
              ...
              <span id="summernote-en-error"></span>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow">
            <div class="col-md-6 py-2">
            ...
            <div class="col-md-6 py-2">
                ...
                <span id="summernote-mal-error"></span>
              </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow">
            <div class="col-md-6 py-2">
...
//   });
  ...
  callbacks: {
    onChange: function(contents, $editable) {
        ...
        var textareaValue1 = $('#enabstract').summernote('code').replace(/(<([^>]+)>)/ig, "");
        // var isValid = charRegExp.test(textareaValue1);
        if (charRegExp.test(textareaValue1)) {  
         
          alert("Alphabets, Numbers and Space.");
          $("#enabstract").summernote('undo');
...
$('#malabstract').summernote({
  height: 200,
  callbacks: {
    onChange: function(contents, $editable) {
        var charRegExp  = /[a-zA-Z@#$%^*()?!":{}|]/;
        var textareaValue2 = $('#malabstract').summernote('code').replace(/(<([^>]+)>)/ig, "");
        // var isValid = charRegExp.test(textareaValue1);
        if (charRegExp.test(textareaValue2)) {   
          alert("Invalid characters");
          $("#malabstract").summernote('undo');
...
$("#transactionbutton").click(function(event){
    ...
    $('.modal-title').text('Add New Press Release');
  ...
  var action_url = '';
 action_url="{{ route('contributor.pressreleasecreate') }}";
       ...
       success:function(data)
        {
           ...
           $('#departments_id').empty();
            ...
            $('#encontent').val('');
            $('#malcontent').val('');
             $('#enabstract').summernote("reset");
            $("#malabstract").summernote("reset");
...
$('#ajaxmodalform').on('submit', function(event){ 
   var formData = new FormData(this);
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('contributor.pressreleasestore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('contributor.pressreleaseupdate') }}";
  ...
  $(document).on('click', '.edit', function(){
      ...
      var action_url2 = '';
         ...
         action_url2 = "/contributor/pressreleaseedit/"+id;
        ...
        { 
          if(data.error){
            alert("The Article is Locked, So cannot be edited!");
             ...
             var urlpath="{{asset('Pressrelease')}}/"+data.resultdata.filepath;
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
      ...
      var action_url3 = '';
         ...
         action_url3 = "/contributor/pressreleasestatus/"+id;
  ...
  $('#ok_button').click(function(){
    var usertype=$("#usertypeid").val(); 
      var action_url4 = '';
         ...
         action_url4 = "/contributor/pressreleasedestroy/"+element_id;
