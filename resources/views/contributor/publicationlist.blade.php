...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Publication</strong></p>
   </div>
               ...
               @php
                ...
                <tr>
                    ...
                    <td><span class="eng_xxxxs"> {{ date('d-m-Y', strtotime($res->documentdate)) }} </span> </td> 
                     ...
                     <td><span class="eng_xxxxs"> <a target="_blank" href="{{ asset('Publication').'/'.$res->filepath }}">View File</a></span> </td>
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          ...
          <div class="row customformrow">
           ...
           <div class="row customformrow">
            <div class="col-md-6 py-2">
              ...
              <label for="IDNAME" class="eng_xxxs fg-darkBrown">Upload Poster </label>
              
            </div> <!-- ./col-md-6 -->
            <div class="col-md-6 py-2">
               <img src="" class="img-thumbnail displaythumbnail customform eng_xxxs fg-darkCrimson" alt="Image" id="uploadedimage">
               
                <input type="hidden"  id="hiddenposter" name="hiddenposter" >
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="alttext" name="alttext" aria-describedby="HELPNAME" placeholder="Name" maxlength="50" minlength="3">
           ...
           <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                ...
                <p id="sizeerror" style="display:none; color:#FF0000;" >Only A -Z a-z Characters are allowed.</p>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
        </div> <!-- ./form_section -->
...
$("#transactionbutton").click(function(event){
    ...
    $('.modal-title').text('Add New Publication');
  ...
  var action_url = '';
 action_url="{{ route('contributor.publicationcreate') }}";
...
$('#ajaxmodalform').on('submit', function(event){ 
   var formData = new FormData(this);
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('contributor.publicationstore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('contributor.publicationupdate') }}";
    ...
    $.ajax({
         ...
         { 
            ...
            if(data.errors)
            {
               alert("Already a publication with same exists");
  ...
  $(document).on('click', '.edit', function(){
      ...
      var action_url2 = '';
         ...
         action_url2 = "/contributor/publicationedit/"+id;
        ...
        { 
          if(data.error){
            alert("The Article is Locked, So cannot be edited!");
             ...
             var urlpath="{{asset('Publication')}}/"+data.resultdata.filepath;

        $("#filepdf").html("<a target='_blank' href="+urlpath+">View File</a>");      
         $("#uploadedimage").attr('src',"{{asset('Publication')}}/"+data.resultdata.poster); 
           $('#hiddenposter').val(data.resultdata.poster);
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
      ...
      var action_url3 = '';
         ...
         action_url3 = "/contributor/publicationstatus/"+id;
  ...
  $('#ok_button').click(function(){
    var usertype=$("#usertypeid").val(); 
      var action_url4 = '';
         ...
         action_url4 = "/contributor/publicationdestroy/"+element_id;
