...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;State  Budget</strong></p>
   </div>
               ...
               @php
                ...
                <tr>
                    <td><span class="eng_xxxxs"> {{ $i }} </span> </td>
                     ...
                     <td><span class="eng_xxxxs"> <a target="_blank" href="{{ asset('Statebudget').'/'.$res->filepath }}">View File</a></span> </td>
...
$("#transactionbutton").click(function(event){
    ...
    $('.modal-title').text('Add New State budget');
  ...
  var action_url = '';
 action_url="{{ route('contributor.statebudgetcreate') }}";
...
$('#ajaxmodalform').on('submit', function(event){ 
   var formData = new FormData(this);
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('contributor.statebudgetstore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('contributor.statebudgetupdate') }}";
    ...
    $.ajax({
         ...
         { 
            ...
            if(data.errors)
            {
               alert("Already a state budget with same exists");
  ...
  $(document).on('click', '.edit', function(){
      ...
      var action_url2 = '';
         ...
         action_url2 = "/contributor/statebudgetedit/"+id;
        ...
        { 
          if(data.error){
            alert("The Article is Locked, So cannot be edited!");
             ...
             var urlpath="{{asset('Statebudget')}}/"+data.resultdata.filepath;
              $('#filepdf').show();
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
      ...
      var action_url3 = '';
         ...
         action_url3 = "/contributor/statebudgetstatus/"+id;
  ...
  $('#ok_button').click(function(){
    var usertype=$("#usertypeid").val(); 
      var action_url4 = '';
         ...
         action_url4 = "/contributor/statebudgetdestroy/"+element_id;
