...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Cabinet Decision</strong></p>
   </div>
               ...
               @php
                ...
                <tr>
                    ...
                    <td><span class="eng_xxxxs"> {{ $res->documentnumber }} </span> </td>
                     ...
                     <td><span class="eng_xxxxs"> <a target="_blank" href="{{ asset('Cabinetdecision').'/'.$res->filepath }}">View File</a></span> </td>
        ...
        <div id="form_section">
           ...
           <div class="row customformrow">
            <div class="col-md-6 py-2">
              <label for="IDNAME" class="eng_xxxs fg-darkBrown">File Number </label>
              
            </div> <!-- ./col-md-6 -->
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="numberen" name="numberen" aria-describedby="HELPNAME" placeholder="Name" maxlength="50" minlength="3">
                <p id="numberenerror" style="display:none; color:#FF0000;" >Only A -Z a-z ,numbers / () .  are allowed.</p>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow">
            <div class="col-md-6 py-2">
              <label for="IDNAME" class="eng_xxxs fg-darkBrown">File Number in Original</label>
              
            </div> <!-- ./col-md-6 -->
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="numbermal" name="numbermal" aria-describedby="HELPNAME" placeholder="Name" maxlength="50" minlength="3">
                <p id="numbermalerror" style="display:none; color:#FF0000;" >Only Malayalam unicode ,numbers / () .  are allowed.</p>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
           <div class="row customformrow">
            <div class="col-md-6 py-2">
              <label for="IDNAME" class="eng_xxxs fg-darkBrown">Cabinet Date</label>
              
            </div> <!-- ./col-md-6 -->
            <div class="col-md-6 py-2">
                <input type="date" placeholder="dd/mm/yyyy" id="filedate" name="filedate" min="10" maxlength="10" />
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entitle" name="entitle" aria-describedby="HELPNAME" placeholder="Name" maxlength="50" minlength="3" value="{{ Carbon\Carbon::now()->format('d/m/Y')  }}">
  ...
  var dtToday = new Date();  
    ...
    var maxDate = year + '-' + month + '-' + day;
     $('#filedate').attr('max', maxDate);
      /*current date set */
$("#filedate").inputmask("dd/mm/yyyy", {"placeholder": "dd/mm/yyyy", "yearrange":{minyear: 1957, maxyear: max_year },"max":maxDate});
...
$("#transactionbutton").click(function(event){
  ...
  var action_url = '';
 action_url="{{ route('contributor.cabinetdecisioncreate') }}";
       ...
       success:function(data)
        {
           ...
           $('#filepdf').hide();
            ...
            $('.modal-title').text('Add New Cabinet decision');
            $('#actionbutton').val('Save Details');
            $('#action').val('Add');
            $('#ajaxformresults').html('');
            $("#transactionmodal").modal('show');
...
$('#ajaxmodalform').on('submit', function(event){ 
   var formData = new FormData(this);
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('contributor.cabinetdecisionstore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('contributor.cabinetdecisionupdate') }}";
    ...
    $.ajax({
         ...
         { 
            ...
            if(data.errors)
            {
               alert("Already a Cabinet decision with same exists");
  ...
  $(document).on('click', '.edit', function(){
      ...
      var action_url2 = '';
         ...
         action_url2 = "/contributor/cabinetdecisionedit/"+id;
        ...
        { 
          if(data.error){
            alert("The Article is Locked, So cannot be edited!");
             ...
             var urlpath="{{asset('Cabinetdecision')}}/"+data.resultdata.filepath;
              $('#filepdf').show();
        $("#filepdf").html("<a target='_blank' href="+urlpath+">View File</a>");      
         
           $('#numberen').val(data.resultdata.documentnumber);
            $('#numbermal').val(data.resultdata.originaldocnumber);
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
      ...
      var action_url3 = '';
         ...
         action_url3 = "/contributor/cabinetdecisionstatus/"+id;
  ...
  $('#ok_button').click(function(){
    var usertype=$("#usertypeid").val(); 
      var action_url4 = '';
         ...
         action_url4 = "/contributor/cabinetdecisiondestroy/"+element_id;
