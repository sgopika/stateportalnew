...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Quotations</strong></p>
   </div>
               ...
               @php
                ...
                <tr>
                    ...
                    <td><span class="eng_xxxxs"> {{ date('d-m-Y', strtotime($res->documentdate)) }} </span> </td> 
                     ...
                     <td><span class="eng_xxxxs"> <a target="_blank" href="{{ asset('Quotations').'/'.$res->filepath }}">View File</a></span> </td>
...
<div class="modal fade"  id="transactionmodal" tabindex="-1" role="dialog" aria-labelledby="addmodalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
      ...
      <div class="modal-body adminpage">
        <div id="form_section">
           <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input  type="date" class="form-control customform eng_xxxs fg-darkCrimson" data-inputmask-alias="date" data-inputmask-inputformat="dd/mm/yyyy" maxDate="30/07/2021" im-insert="false" placeholder="dd/mm/yyyy" id="filedate" name="filedate" min="10" maxlength="10"  />
    ...
    <div class="row customformrow">
      <div class="col-md-6 py-2">
        <label for="IDNAME" class="eng_xxxs fg-darkBrown">Select Type</label>
        <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> Select type</small>
      </div> <!-- ./col-md-6 -->
      <div class="col-md-6 py-2">
           <select class="form-control customform eng_xxxs fg-darkCrimson" id="quotationtype" name="quotationtype">
    ...
    <div class="row customformrow">
      <div class="col-md-6 py-2">
        ...
        <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> Icon Class</small>
      </div> <!-- ./col-md-6 -->
      <div class="col-md-6 py-2">
           <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="iconclass" name="iconclass" aria-describedby="HELPNAME" placeholder="Name" maxlength="50" minlength="3">
      </div> <!-- ./col-md-6 -->
    </div> <!-- ./row -->
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="enkeyword" name="enkeyword" aria-describedby="HELPNAME" placeholder="Keywords" maxlength="5000" minlength="3"></textarea>
        ...
        <div class="row customformrow">
                            <div class="col-md-12 py-2">
                                ...
                                <textarea class="summernote" id="encontent" name="encontent" aria-describedby="HELPNAME" placeholder="Name" maxlength="300000" minlength="3"></textarea>
...
$("#transactionbutton").click(function(event){
  ...
  var action_url = '';
 action_url="{{ route('contributor.quotationcreate') }}";
...
$('#ajaxmodalform').on('submit', function(event){ 
   var formData = new FormData(this);
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('contributor.quotationstore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('contributor.quotationupdate') }}";
    ...
    $.ajax({
         ...
         { 
            ...
            if(data.errors)
            {
               alert("Already a Quotation with same exists");
  ...
  $(document).on('click', '.edit', function(){
      ...
      var action_url2 = '';
         ...
         action_url2 = "/contributor/quotationedit/"+id;
        ...
        { 
          if(data.error){
            alert("The Article is Locked, So cannot be edited!");
             ...
             var urlpath="{{asset('Quotations')}}/"+data.resultdata.filepath;
            ...
            $('#quotationtype').val(data.quotationtypevalue);
           ...
           console.log(data.resultdata.quotationtype);
            $('#quotationtype').empty();
            $('#quotationtype').append($('<option></option>').val('').html('Select'));
            if(data.resultdata.quotationtype==1)
            {
              $('#quotationtype').append(
            $('<option value="1" selected></option>').val(data.resultdata.quotationtype).html("Buy")
                );
                $('#quotationtype').append(
            $('<option value="2"></option>').html("Sell")
                );
                
            }
            else if(data.resultdata.quotationtype==2)
            {
            $('#quotationtype').append(
            $('<option value="1"></option>').val(data.resultdata.quotationtype).html("Buy")
                );
                $('#quotationtype').append(
            $('<option value="2" selected></option>').html("Sell")
                );
            }   
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
      ...
      var action_url3 = '';
         ...
         action_url3 = "/contributor/quotationstatus/"+id;
  ...
  $('#ok_button').click(function(){
    var usertype=$("#usertypeid").val(); 
      var action_url4 = '';
         ...
         action_url4 = "/contributor/quotationdestroy/"+element_id;
