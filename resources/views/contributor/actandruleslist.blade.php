...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Acts and Rules</strong></p>
   </div>
               ...
               @php
                ...
                <tr>
                    ...
                    <td><span class="eng_xxxxs"> {{ date('d-m-Y', strtotime($res->documentdate)) }} </span> </td> 
                     ...
                     <td><span class="eng_xxxxs"> <a target="_blank" href="{{ asset('Actandrules').'/'.$res->filepath }}">View File</a></span> </td>
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="enkeyword" name="enkeyword" aria-describedby="HELPNAME" placeholder="Keywords" maxlength="100" minlength="3"></textarea>
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                 <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="malkeyword" name="malkeyword" aria-describedby="HELPNAME" placeholder="Malayalam Keywords" maxlength="100" minlength="3"></textarea>
...
$("#transactionbutton").click(function(event){
    ...
    $('.modal-title').text('Add New Act and rules');
  ...
  var action_url = '';
 action_url="{{ route('contributor.actandrulescreate') }}";
...
$('#ajaxmodalform').on('submit', function(event){ 
   var formData = new FormData(this);
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('contributor.actandrulesstore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('contributor.actandrulesupdate') }}";
    ...
    $.ajax({
         ...
         { 
            ...
            if(data.errors)
            {
               alert("Already a Act and rules with same exists");
  ...
  $(document).on('click', '.edit', function(){
      ...
      var action_url2 = '';
         ...
         action_url2 = "/contributor/actandrulesedit/"+id;
        ...
        { 
          if(data.error){
            alert("The Article is Locked, So cannot be edited!");
             ...
             var urlpath="{{asset('Actandrules')}}/"+data.resultdata.filepath;
             $('#filepdf').show();
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
      ...
      var action_url3 = '';
         ...
         action_url3 = "/contributor/actandrulesstatus/"+id;
  ...
  $('#ok_button').click(function(){
    var usertype=$("#usertypeid").val(); 
      var action_url4 = '';
         ...
         action_url4 = "/contributor/actandrulesdestroy/"+element_id;
