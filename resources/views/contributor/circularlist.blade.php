...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Circulars</strong></p>
   </div>
               ...
               @php
                ...
                <tr>
                    ...
                    <td><span class="eng_xxxxs"> {{ $res->documentnumber }} </span> </td>
                     ...
                     <td><span class="eng_xxxxs"> <a target="_blank" href="{{ asset('Circulars').'/'.$res->filepath }}">View File</a></span> </td>
      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
           ...
           <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="numberen" name="numberen" aria-describedby="HELPNAME" placeholder="Name" maxlength="20" minlength="3">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="numbermal" name="numbermal" aria-describedby="HELPNAME" placeholder="Name" maxlength="20" minlength="3">
...
$("#transactionbutton").click(function(event){
  ...
  var action_url = '';
 action_url="{{ route('contributor.circularcreate') }}";
       ...
       success:function(data)
        {
           ...
           $('#filepdf').hide();
            ...
            $('.modal-title').text('Add New Circular');
            $('#actionbutton').val('Save Details');
            $('#action').val('Add');
            $('#ajaxformresults').html('');
            $("#transactionmodal").modal('show');
...
$('#ajaxmodalform').on('submit', function(event){ 
   var formData = new FormData(this);
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('contributor.circularstore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('contributor.circularupdate') }}";
    ...
    $.ajax({
         ...
         { 
            ...
            if(data.errors)
            {
               alert("Already a Circular with same exists");
  ...
  $(document).on('click', '.edit', function(){
      ...
      var action_url2 = '';
         ...
         action_url2 = "/contributor/circularedit/"+id;
        ...
        { 
          if(data.error){
            alert("The Article is Locked, So cannot be edited!");
             ...
             var urlpath="{{asset('Circulars')}}/"+data.resultdata.filepath;
             $('#filepdf').show();
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
      ...
      var action_url3 = '';
         ...
         action_url3 = "/contributor/circularstatus/"+id;
  ...
  $('#ok_button').click(function(){
    var usertype=$("#usertypeid").val(); 
      var action_url4 = '';
         ...
         action_url4 = "/contributor/circulardestroy/"+element_id;
