...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Economic Review</strong></p>
   </div>
               ...
               @php
                ...
                <tr>
                    <td><span class="eng_xxxxs"> {{ $i }} </span> </td>
                     ...
                     <td><span class="eng_xxxxs"> <a target="_blank" href="{{ asset('Economicreview').'/'.$res->filepath }}">View File</a></span> </td>
...
$("#transactionbutton").click(function(event){
    ...
    $('.modal-title').text('Add New Economic Review');
  ...
  var action_url = '';
 action_url="{{ route('contributor.economicreviewcreate') }}";
...
$('#ajaxmodalform').on('submit', function(event){ 
   var formData = new FormData(this);
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('contributor.economicreviewstore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('contributor.economicreviewupdate') }}";
    ...
    $.ajax({
         ...
         { 
            ...
            if(data.errors)
            {
               alert("Already a  Economic Review exists");
  ...
  $(document).on('click', '.edit', function(){
      ...
      var action_url2 = '';
         ...
         action_url2 = "/contributor/economicreviewedit/"+id;
        ...
        { 
          if(data.error){
            alert("The Article is Locked, So cannot be edited!");
             ...
             var urlpath="{{asset('Economicreview')}}/"+data.resultdata.filepath;
              $('#filepdf').show();
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
      ...
      var action_url3 = '';
         ...
         action_url3 = "/contributor/economicreviewstatus/"+id;
  ...
  $('#ok_button').click(function(){
    var usertype=$("#usertypeid").val(); 
      var action_url4 = '';
         ...
         action_url4 = "/contributor/economicreviewdestroy/"+element_id;
