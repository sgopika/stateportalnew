  ...
  @csrf
    <div class="card-body articlebg">
      ...
      <div class="row listborders  py-2">
        ...
        <div class="col-md-3">
           <input type="text"  id="fromdate" name="fromdate" min="10" maxlength="10" value="{{ Carbon\Carbon::now()->format('d/m/Y') }}" class="form-control form-control-sm" >
        ...
        <div class="col-md-3">
           <input type="text" class="form-control form-control-sm"  id="todate" name="todate" min="10" maxlength="10"  value="{{ Carbon\Carbon::now()->format('d/m/Y') }}" />
