...
<div class="modal fade"  id="transactionmodal" tabindex="-1" role="dialog" aria-labelledby="addmodalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
	  ...
	  @if(Auth::user()->usertypes_id==4)
       <form action="{{ route('webadmin.newslettervolumestore') }}" id="ajaxmodalform" method="post" class="form-horizontal" enctype="multipart/form-data">
      @elseif(Auth::user()->usertypes_id==5)
       <form action="{{ route('editor.newslettervolumestore') }}" id="ajaxmodalform" method="post" class="form-horizontal" enctype="multipart/form-data">
        @elseif(Auth::user()->usertypes_id==6)
       <form action="{{ route('photoeditor.newslettervolumestore') }}" id="ajaxmodalform" method="post" class="form-horizontal" enctype="multipart/form-data">
      @endif
        @csrf
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                 <select class="form-control customform eng_xxxs fg-darkCrimson" id="newsletters_id" name="newsletters_id" required></select>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow">
            <div class="col-md-6 py-2">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                 <input type="text" name="releasedate" id="releasedate" value="{{ Carbon\Carbon::now()->format('d/m/Y')  }}" class="form-control customform eng_xxxs fg-darkCrimson dob" required>
      ...
      <div class="modal-header modalover">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
		    ...
		    @if(Auth::user()->usertypes_id==4)
      <form action="{{ route('webadmin.newslettervolumeupdate') }}" id="ajaxmodalform1" method="post" class="form-horizontal" enctype="multipart/form-data">
      @elseif(Auth::user()->usertypes_id==5)
      <form action="{{ route('editor.newslettervolumeupdate') }}" id="ajaxmodalform1" method="post" class="form-horizontal" enctype="multipart/form-data">
        @elseif(Auth::user()->usertypes_id==6)
      <form action="{{ route('photoeditor.newslettervolumeupdate') }}" id="ajaxmodalform1" method="post" class="form-horizontal" enctype="multipart/form-data">
      @endif
        @csrf
      <div class="modal-body adminpage">
        ...
        <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                 <select class="form-control customform eng_xxxs fg-darkCrimson" id="newsletters_id1" name="newsletters_id1" required></select>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow">
            <div class="col-md-6 py-2">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                 <input type="text" name="releasedate1" id="releasedate1"  class="form-control customform eng_xxxs fg-darkCrimson dob" required>
      ...
      $.ajax({
       ...
       success:function(data)
        { 
          ...
          element.id == data.resultdata.newsletters_id ? $('#newsletters_id1').val(element.id).prop('selected', true) : '';    
          });
