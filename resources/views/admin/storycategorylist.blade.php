...
<div class="row ">
 ...
 <div class="col-12 py-1">
  ...
  @endif
    ...
    <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;  Story Category List </strong></p>
   </div>
  <div class="col-12 py-1">
      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Name in Malayalam" maxlength="50" minlength="3" onchange="">
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('admin.storycategorystore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('admin.storycategoryupdate') }}";
    ...
    $.ajax({
         ...
         { 
            ...
            if(data.errors)
            {
               alert("Already a content type with same name exists");
  ...
  $(document).on('click', '.edit', function(){
      ...
      $('#ajaxformresults').html('');
      $.ajax({
       url :"/admin/storycategoryedit/"+id,
       dataType:"json",
       success:function(data)
        { 
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
    $.ajax({
      url:"/admin/storycategorystatus/"+id,
      dataType:"json",
  ...
  $('#ok_button').click(function(){
    ...
    $.ajax({
            url:"/admin/storycategorydestroy/"+element_id,
            dataType:"json",
