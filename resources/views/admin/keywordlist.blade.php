...
<div class="row ">
 ...
 <div class="col-12 py-1">
  ...
  @endif
    ...
    <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;  Key Word List </strong></p>
   </div>
  <div class="col-12 py-1">
  ...
  <div class="modal-dialog modal-lg" role="document">
    ...
    <div class="row customformrow">
      <div class="col-md-6 py-2">
        ...
        <small id="HELPNAME" class="form-text eng_xxxxs text-muted">Key Word in English.</small>
      </div> <!-- ./col-md-6 -->
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entitle" name="entitle" aria-describedby="HELPNAME" placeholder="Placeholder value" maxlength="50" minlength="3">
    ...
    <div class="row customformrow">
      <div class="col-md-6 py-2">
        ...
        <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> Key Word in Malayalam.</small>
      </div> <!-- ./col-md-6 -->
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltitle" name="maltitle" aria-describedby="HELPNAME" placeholder="Placeholder value" maxlength="150" minlength="3">
...
$("#transactionbutton").click(function(event){
    ...
    $('.modal-title').text('Add New Keywords');
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('admin.keywordstore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('admin.keywordupdate') }}";
    ...
    $.ajax({
         ...
         { 
            ...
            if(data.errors)
            {
               alert("Already a Department Category with same name exists");
  ...
  $('#ok_button').click(function(){
    ...
    $.ajax({
            url:"/admin/keyworddestroy/"+element_id,
            dataType:"json",
