...
<div class="container-fluid homepage adminpage">
    <div class="row ">
        ...
        <div class="col-12 py-1 px-2 ">
            <p class="py-2"> <strong> <i class="fas fa-hand-point-right"></i> &nbsp; District Programmes List</strong></p>
        </div> <!-- ./col12 -->
        ...
        <div class="col-12 py-1">
            <a href="{{route('districtusr.newdistrictpgmlist')}}">
                        ...
                        <div class="modal-body adminpage">
                            ...
                            <div id="form_section">
                                ...
                                <div class="row customformrow">
                                    ...
                                    <div class="col-md-6 py-2">
                                        <img src="" class="img-thumbnail displaythumbnail customform eng_xxxs fg-darkCrimson" alt="Image" id="uploadedfile">
                                        <input type="file" id="fileedit" name="fileedit">
...
<script>
    ...
    $(document).ready(function() {
        ...
        /*$(document).ready(function(event) {
            ...
            var action_url = '';
             if (usertype == 10) {
                action_url = "{{ route('districtusr.districtpgmcreate') }}";
            }
            ...
            $.ajax({
                ...
                success: function(data) {
                     if (usertype == 10) {
                        window.location.href = '/districtusr/newdistrictpgmlist';
                    }
                    ...
                    $('.modal-title').text('Add New District Programme');
                    $('#actionbutton').val('Save Details');
                    $('#action').val('Add');
                    $('#ajaxformresults').html('');
                    $("#transactionmodal").modal('show');
        ...
        $('.ajaxmodalform').on('submit', function(event) {
            ...
            if (usertype == 10) {
                if ($('#action').val() == 'Add')
                    action_url = "/districtusr/districtpgmstore";

                if ($('#action').val() == 'Edit')
                    action_url = "/districtusr/districtpgmupdate";
        ...
        $(document).on('click', '.edit', function() {
            ...
            var action_url2 = '';
            if (usertype == 10) {
                action_url2 = "/districtusr/districtpgmedit/" + id;
            } 
        ...
        $(document).on('click', '.active', function() {
            ...
            var action_url3 = '';
            if (usertype == 10) {
                action_url3 = "/districtusr/districtpgmstatus/" + id;
            } 
            $.ajax({
                url: action_url3,
                dataType: "json",
        ...
        $(document).on('click', '.delete', function() {
            ...
            var action_url4 = '';
            if (usertype == 10) {
                action_url4 = "/districtusr/districtpgmdestroy/" + element_id;
            } 
            swal({
                    title: "Deleting District Programme List",
                    text: "Are you sure to delete District Programme List?",
                    type: "warning",
                    buttons: true,
                    dangerMode: true
                })
                    ...
                    if (isconfirm) {
                        $.ajax({
                            ...
                            success: function(data) {
                                $('#loader').hide();
                                swal({
                                        title: 'District Programme List Deleted',
                                        text: data.success,
                                        type: 'info',
                                        buttonsStyling: false,
                                        reverseButtons: true
