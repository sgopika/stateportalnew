                ...
                <table class="table table-stripped table-sm table-hover box-shadow--6dp" id="resposivetable">
                    ...
                    <tbody class="eng_xxxs">
                        ...
                        <tr>
                            ...
                            <td><span class="eng_xxxxs"> {{ $res->mobile }}<br>
                                    <span class="py-1">{{ $res->email }}</span>
                                </span> </td>
                    ...
                    <div class="modal-body adminpage">
                        ...
                        <div id="form_section">
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" required class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="Name" maxlength="50" minlength="3" required>
                                    <p id="nameerror" style="display:none; color:#FF0000;">Only A -Z a-z Characters are
                                        allowed.</p>
                                </div> <!-- ./col-md-6 -->
                            </div> <!-- ./row -->
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" required class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Name" maxlength="100" minlength="3" required>
                                    <p id="malnameerror" style="color:#FF0000;"></p>
                                </div> <!-- ./col-md-6 -->
                            </div> <!-- ./row -->
                            <div class="row customformrow">
                                <div class="col-md-6 py-2">
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="email" id="email" name="email" maxlength="50" minlength="10" class="form-control customform eng_xxxs fg-darkCrimson">
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" required id="mobile" name="mobile" minlength="10" class="form-control customform eng_xxxs fg-darkCrimson" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="12" required>
                                    <p id="mobilenumbererror" style="display:none; color:#FF0000;" class="mal_xxxs">
                                        Invalid Mobile </p>
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" required name="joindate" id="joindate" value="{{ Carbon\Carbon::now()->format('d/m/Y')  }}" class="form-control customform eng_xxxs fg-darkCrimson dob" required>
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" required class="form-control customform eng_xxxs fg-darkCrimson" id="alttext" name="alttext" aria-describedby="HELPNAME" placeholder="Name" maxlength="50" minlength="3" required>
                                    <p id="alttexterror" style="display:none; color:#FF0000;">Only A -Z a-z Characters
                                        are allowed.</p>
                                </div> <!-- ./col-md-6 -->
                            </div> <!-- ./row -->
                        </div> <!-- ./form_section -->
                    ...
                    <div class="modal-body adminpage">
                        ...
                        <div id="form_section">
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" required class="form-control customform eng_xxxs fg-darkCrimson" id="name1" name="name1" aria-describedby="HELPNAME" placeholder="Name" maxlength="20" minlength="3" required="">
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" required class="form-control customform eng_xxxs fg-darkCrimson" id="malname1" name="malname1" aria-describedby="HELPNAME" placeholder="Name" maxlength="20" minlength="3" required="">
                                    <p id="malnameerror1" style="color:#FF0000;"></p>
                                </div> <!-- ./col-md-6 -->
                            </div> <!-- ./row -->
                            <div class="row customformrow">
                                <div class="col-md-6 py-2">
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" required id="mobile1" name="mobile1" minlength="10" class="form-control customform eng_xxxs fg-darkCrimson" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" required>
                                    <p id="mobilenumbererror1" style="display:none; color:#FF0000;" class="mal_xxxs">
                                        Invalid Mobile </p>
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" required name="joindate1" id="joindate1" value="" class="form-control customform eng_xxxs fg-darkCrimson dob" required>
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" required class="form-control customform eng_xxxs fg-darkCrimson" id="alttext1" name="alttext1" aria-describedby="HELPNAME" placeholder="Name" maxlength="20" minlength="3">
                                    <p id="alttexterror1" style="display:none; color:#FF0000;">Only A -Z a-z Characters
                                        are allowed.</p>
                                </div> <!-- ./col-md-6 -->
                            </div> <!-- ./row -->
                        </div> <!-- ./form_section -->
...
<script>
    $(document).ready(function() {
        ...
        $("#transactionbutton").click(function(event) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#designations_id').append($('<option></option>').val('0').html(
                        'Select'));
                    ...
                    $('#staffcategories_id').append($('<option></option>').val('0').html(
                        'Select'));
        ...
        $(document).on('click', '.edit', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#departments_id1').append($('<option></option>').val('0').html(
                        'Select'));
                    $.each(data.department, function(index, element) {
                        ...
                        element.id == data.resultdata.departments_id ? $(
                            '#departments_id1').val(element.id).prop('selected',
                            true) : '';
                    });

                    $('#designations_id1').empty();
                    $('#designations_id1').append($('<option></option>').val('0').html(
                        'Select'));
                    $.each(data.designation, function(index, element) {
                        ...
                        element.id == data.resultdata.designations_id ? $(
                            '#designations_id1').val(element.id).prop('selected',
                            true) : '';
                    });
                    ...
                    $.each(data.office, function(index, element) {
                        ...
                        element.id == data.resultdata.offices_id ? $('#offices_id1')
                            .val(element.id).prop('selected', true) : '';
                    });

                    $('#staffcategories_id1').empty();
                    $('#staffcategories_id1').append($('<option></option>').val('0').html(
                        'Select'));
                    $.each(data.staffcategory, function(index, element) {
                        ...
                        element.id == data.resultdata.staffcategories_id ? $(
                            '#staffcategories_id1').val(element.id).prop('selected',
                            true) : '';
                    });

                    $('#hierarchies_id1').empty();
                    $('#hierarchies_id1').append($('<option></option>').val('0').html(
                        'Select'));
                    $.each(data.hierarchy, function(index, element) {
                        ...
                        element.id == data.resultdata.hierarchies_id ? $(
                            '#hierarchies_id1').val(element.id).prop('selected',
                            true) : '';
                    });
                    ...
                    $("#uploadedposter").attr('src', "{{asset('Staff')}}/" + data.resultdata
                        .poster);
        ...
        $(document).on('click', '.delete', function() {
            ...
            swal({
                    title: "Deleting Staff List",
                    text: "Are you sure to delete Staff List?",
                    type: "warning",
                    buttons: true,
                    dangerMode: true
                })
                .then((isconfirm) => {
                    ...
                    if (isconfirm) {
                        $.ajax({
                            url: "/appadmin/staffdestroy/" + element_id,
                            dataType: "json",
        ...
        $(function() {
            $("#malname").keypress(function(e) {
                ...
                if (!isValid) {
                    $("#malnameerror").html("Only Malayalam Characters and spaces are allowed.");
                }
        ...
        $(function() {
            $("#malname1").keypress(function(e) {
                ...
                var isValid = regex.test(String.fromCharCode(keyCode));
                if (!isValid) {
                    $("#malnameerror1").html("Only Malayalam Characters and spaces are allowed.");
                }
