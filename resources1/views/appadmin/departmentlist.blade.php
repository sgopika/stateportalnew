...
<div class="row ">
 ...
 <div class="col-12 py-1 px-2 ">
    <p class="eng_xxs px-3 fg-darkBrown"> Department List </p>
  </div> <!-- ./col12 -->
      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                 <select class="form-control customform eng_xxxs fg-darkCrimson" id="deptcategories_id" name="deptcategories_id" required>
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input required type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="Name" maxlength="50" minlength="3" required>
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input required type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Name in Malayalam" maxlength="100" minlength="3">
...
$("#transactionbutton").click(function(event){
    ...
    $.ajax({
       url: "{{ route('appadmin.departmentcreate') }}",
       dataType:"json",
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('appadmin.departmentstore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('appadmin.departmentupdate') }}";
              ...
              swal({
                ...
                .then((value) => {
                    if (value) {
                      ...
                      window.location.replace("{{route('appadmin.departmentlist')}}");
                    }
                });
  ...
  $(document).on('click', '.edit', function(){
      ...
      $('#ajaxformresults').html('');
      $.ajax({
       url :"/appadmin/departmentedit/"+id,
       dataType:"json",
       success:function(data)
        { 
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
    $.ajax({
      url:"/appadmin/departmentstatus/"+id,
      dataType:"json",
  ...
  $(document).on('click', '.delete', function(){
      ...
      swal(
            {
              title: "Deleting  Department List",
              text: "Are you sure to delete  Department List?",
              type: "warning",
              buttons: true,
              dangerMode: true
            })
          .then((isconfirm) => {
            ...
            if (isconfirm) {
              $.ajax({
                  url:"/appadmin/departmentdestroy/"+element_id,
                  dataType:"json",
