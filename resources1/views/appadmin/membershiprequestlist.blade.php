      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input required type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="Name" maxlength="100" minlength="3">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                 <input required type="email" id="email" name="email" maxlength="100" minlength="10" class="form-control customform eng_xxxs fg-darkCrimson" >
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                 <input type="text" id="mobile" name="mobile"  minlength="10" class="form-control customform eng_xxxs fg-darkCrimson" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "12" required>
...
$('#ajaxmodalform').on('submit', function(event){ 
              ...
              swal({
                ...
                .then((value) => {
                    if (value) {
                      ...
                      window.location.replace("{{route('appadmin.membershiprequestlist')}}");
                    }
                });
  ...
  $(document).on('click', '.delete', function(){
      ...
      swal(
            {
              title: "Deleting Membership Request List",
              text: "Are you sure to delete Membership Request List?",
              type: "warning",
              buttons: true,
              dangerMode: true
            })
              ...
              $.ajax({
                  ...
                  success:function(data)
                  {
                    ...
                    $('#loader').hide();
                      ...
                      swal({
                                                        title:'Membership Request List Deleted',
                                                        text:data.success,
                                                        type:'info',                                               
                                                        buttonsStyling:false,
                                                        reverseButtons:true
