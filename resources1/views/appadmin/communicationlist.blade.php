...
<div class="container-fluid homepage adminpage">
    ...
    <div class="row ">
        <div class="col-12 py-2  ">
            <nav aria-label="breadcrumb" class="breadcrumbinner py-1 eng_xxxs">
                <ol class="breadcrumb justify-content-end px-3 pt-2">
                    ...
                    <li class="breadcrumb-item"><a class="no_link" href="{{ route('appclienthome') }}"><i
                                class="fas fa-home"></i>&nbsp;Home</a></li>
                    @endif
                </ol>
        ...
        <div class="col-12 py-1 px-2 ">
            <p class="eng_xxs px-3 fg-darkBrown"> Communication List 
            </p>
        </div> <!-- ./col12 -->
        ...
        <div class="col-12 py-1">
            ...
            @if(Auth::user()->usertypes_id==2)
            <a href="{{ route('appadmin.communicationcreate') }}"><button type="button"
            ...
            @elseif(Auth::user()->usertypes_id==9)
            <a href="{{ route('appmanager.communicationcreate') }}"><button type="button"
                    class="btn btn-sm  text-white bg-magenta fg-lighTaupe eng_xxxs" id="transactionbutton"
                    name="transactionbutton"> <i class="fas fa-plus-square "></i>&nbsp;Add New</button></a>
            @elseif(Auth::user()->usertypes_id==10)
            <a href="{{ route('appclient.communicationcreate') }}"><button type="button"
                    class="btn btn-sm  text-white bg-magenta fg-lighTaupe eng_xxxs" id="transactionbutton"
                    name="transactionbutton"> <i class="fas fa-plus-square "></i>&nbsp;Add New</button></a>
            @endif
...
$(document).ready(function() {
    ...
    $(document).on('click', '.delete', function() {
        ...
        swal({
            text: "Do you want to delete the communication list?",
            buttons: ["No", "Yes"]
