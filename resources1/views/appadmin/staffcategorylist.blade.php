...
<div class="row ">
 ...
 <div class="col-12 py-1 px-2 ">
    <p class="eng_xxs px-3 fg-darkBrown"> Staff Category List </p>
  </div> <!-- ./col12 -->  
      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input reuired type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="Name" maxlength="20" minlength="3">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input reuired type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Name in Malayalam" maxlength="50" minlength="3">
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('appadmin.staffcategorystore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('appadmin.staffcategoryupdate') }}";
              ...
              swal({
                ...
                .then((value) => {
                    if (value) {
                      ...
                      window.location.replace("{{route('appadmin.staffcategorylist')}}");
                    }
                });
  ...
  $(document).on('click', '.edit', function(){
    ...
    $('#malnameerror').hide();
      ...
      $('#ajaxformresults').html('');
      $.ajax({
       url :"/appadmin/staffcategoryedit/"+id,
       dataType:"json",
       success:function(data)
        { 
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
    $.ajax({
      url:"/appadmin/staffcategorystatus/"+id,
      dataType:"json",
  ...
  $(document).on('click', '.delete', function(){
      ...
      swal(
            {
              title: "Deleting Staff Category List",
              text: "Are you sure to delete Staff Category List?",
              type: "warning",
              buttons: true,
              dangerMode: true
            })
          .then((isconfirm) => {
            ...
            if (isconfirm) {
              $.ajax({
                  url:"/appadmin/staffcategorydestroy/"+element_id,
                  dataType:"json",
                  ...
                  success:function(data)
                  {
                    ...
                    $('#loader').hide();
                      ...
                      swal({
                                                        title:'Staff Category List Deleted',
                                                        text:data.success,
                                                        type:'info',                                               
                                                        buttonsStyling:false,
                                                        reverseButtons:true
