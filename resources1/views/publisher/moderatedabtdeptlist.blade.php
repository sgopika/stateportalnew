...
<div class="modal fade"  id="transactionmodal" tabindex="-1" role="dialog" aria-labelledby="addmodalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-12 py-2">
          <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="approve_remarks" name="approve_remarks" aria-describedby="HELPNAME" placeholder="Remarks.." maxlength="1000" minlength="3" required></textarea>
      </div> <!-- ./col-md-6 -->
...
$(document).on('click', '.approve', function(){
      ...
      $.ajax({
       url :"/publisher/moderatedabtdeptapprove/"+id,
       dataType:"json",
...
$(document).on('click', '.reject', function(){
  ...
  $('#ajaxmodalform').on('submit', function(event){ 
    ...
    $.ajax({
         url: "{{ route('publisher.moderatedabtdeptupdate') }}",
         method:"post",
         data:$(this).serialize(),
         dataType:"json",
         success:function(data)
