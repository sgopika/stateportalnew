          ...
          <tbody class="eng_xxxs">
            ...
            <tr>
              ...
              <td>
                ...
                Publisher : <span class="eng_xxxxs"> {{ $res->approve_remarks }} </span>
                <hr class="py-1">
                @endif
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <form action="{{ route('webadmin.downloadstore') }}" id="ajaxmodalform" method="post" class="form-horizontal" enctype="multipart/form-data">
        @elseif(Auth::user()->usertypes_id==3)
        <form action="{{ route('siteadmin.downloadstore') }}" id="ajaxmodalform" method="post" class="form-horizontal" enctype="multipart/form-data">
          @elseif(Auth::user()->usertypes_id==5)
            ...
            <form action="{{ route('photoeditor.downloadstore') }}" id="ajaxmodalform" method="post" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="modal-body adminpage">
                ...
                <div id="form_section">
                  ...
                  <p class="ErrP" id="downloadtypes_iderror" style="display:none; color:#FF0000;"></p>
                    </div> <!-- ./col-md-6 -->
                  </div> <!-- ./row -->
                  <div class="row customformrow">
                    <div class="col-md-6 py-2">
                    ...
                    <p class="ErrP" id="archivepolicies_iderror" style="display:none; color:#FF0000;"></p>
                    </div> <!-- ./col-md-6 -->
                  </div> <!-- ./row -->
                  <div class="row customformrow">
                    <div class="col-md-6 py-2">
                    ...
                    <p class="ErrP" id="contenttypes_iderror" style="display:none; color:#FF0000;"></p>
                    </div> <!-- ./col-md-6 -->
                  </div> <!-- ./row -->
                  <div class="row customformrow" id="filetypediv">
                    ...
                    <p class="ErrP" id="filetypes_iderror" style="display:none; color:#FF0000;"></p>
                    </div> <!-- ./col-md-6 -->
                  </div> <!-- ./row -->
                  ...
                  <div class="row customformrow">
                    ...
                    <div class="col-md-6 py-2">
                      <input type="text" required class="form-control customform eng_xxxs fg-darkCrimson" id="alttext" name="alttext" aria-describedby="HELPNAME" placeholder="Alternative Text" maxlength="500" minlength="3">
                  ...
                  <div class="row customformrow">
                    ...
                    <div class="col-md-6 py-2">
                      <input type="text" required class="form-control customform eng_xxxs fg-darkCrimson" id="entitle" name="entitle" aria-describedby="HELPNAME" placeholder="Title" maxlength="500" minlength="3">
                  ...
                  <div class="row customformrow">
                    ...
                    <div class="col-md-6 py-2">
                      <input type="text" required class="form-control customform eng_xxxs fg-darkCrimson" id="maltitle" name="maltitle" aria-describedby="HELPNAME" placeholder="Name in Malayalam" maxlength="50" minlength="3">
                      <p class="ErrP" id="maltitleerror" style="display:none; color:#FF0000;">Only A -Z a-z Characters are allowed.</p>
                    </div> <!-- ./col-md-6 -->
                  </div> <!-- ./row -->
                  <div class="row customformrow">
                    <div class="col-md-6 py-2">
                    ...
                    <div class="col-md-6 py-2">
                      <input type="text" required class="form-control customform eng_xxxs fg-darkCrimson" id="size" name="size" aria-describedby="HELPNAME" placeholder="Size" maxlength="50" minlength="2">
                  ...
                  <div class="row customformrow">
                    ...
                    <div class="col-md-6 py-2">
                      <input type="text" required class="form-control customform eng_xxxs fg-darkCrimson" id="duration" name="duration" aria-describedby="HELPNAME" placeholder="Duration" maxlength="50" minlength="2">
                  ...
                  <div class="row customformrow">
                    ...
                    <div class="col-md-6 py-2">
                      <input type="text" required class="form-control customform eng_xxxs fg-darkCrimson" id="icon" name="icon" aria-describedby="HELPNAME" maxlength="150" minlength="3">
...
<!-- Modal -->
<div class="modal fade" id="transactionmodal1" tabindex="-1" role="dialog" aria-labelledby="addmodalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header modalover">
        <p class="modal-title eng_xxs fg-darkEmerald" id="addmodalLabel"><i class="fab fa-wpforms"></i>&nbsp;Modal title</p>
      ...
      <form action="{{ route('webadmin.downloadupdate') }}" id="ajaxmodalform1" method="post" class="form-horizontal" enctype="multipart/form-data">
        @elseif(Auth::user()->usertypes_id==3)
        <form action="{{ route('siteadmin.downloadupdate') }}" id="ajaxmodalform1" method="post" class="form-horizontal" enctype="multipart/form-data">
          @elseif(Auth::user()->usertypes_id==5)
              ...
              <div class="modal-body adminpage">
                ...
                <div id="form_section">
                  ...
                  <div class="row customformrow">
                    ...
                    <div class="col-md-6 py-2">
                      <input type="text" required class="form-control customform eng_xxxs fg-darkCrimson" id="entitle1" name="entitle1" aria-describedby="HELPNAME" placeholder="Name" maxlength="20" minlength="3">
                  ...
                  <div class="row customformrow">
                    ...
                    <div class="col-md-6 py-2">
                      <input type="text" required class="form-control customform eng_xxxs fg-darkCrimson" id="maltitle1" name="maltitle1" aria-describedby="HELPNAME" placeholder="Name in Malayalam" maxlength="500" minlength="3">
                  ...
                  <div class="row customformrow">
                    ...
                    <div class="col-md-6 py-2">
                      <input type="text" required class="form-control customform eng_xxxs fg-darkCrimson" id="size1" name="size1" aria-describedby="HELPNAME" placeholder="Name" maxlength="50" minlength="2">
                  ...
                  <div class="row customformrow">
                    ...
                    <div class="col-md-6 py-2">
                      <input type="text" required class="form-control customform eng_xxxs fg-darkCrimson" id="duration1" name="duration1" aria-describedby="HELPNAME" placeholder="Name" maxlength="50" minlength="2">
                  ...
                  <div class="row customformrow">
                    ...
                    <div class="col-md-6 py-2">
                      <input type="text" required class="form-control customform eng_xxxs fg-darkCrimson" id="icon1" name="icon1" aria-describedby="HELPNAME" placeholder="Name" maxlength="150" minlength="3">
  ...
  $(document).ready(function() {
    ...
    $('#icon').val('fas fa-question-circle');
      ...
      if (usertype == 4) {
        ...
        action_url = "{{ route('siteadmin.downloadcreate') }}";
      } else if (usertype == 5) {
    ...
    $(document).on('change', '#contenttypes_id', function() {
      ...
      if (id != '') {
        ...
        if (usertype == 4) {
          ...
          action_url1 = "/siteadmin/downloadfiletypelist/" + id;
        } else if (usertype == 5) {
    ...
    $(document).on('change', '#contenttypes_id1', function() {
      ...
      if (id != '') {
        ...
        if (usertype == 4) {
          ...
          action_url2 = "/siteadmin/downloadfiletypelist/" + id;
        } else if (usertype == 5) {
    ...
    $(document).on('click', '.edit', function() {
      ...
      if (usertype == 4) {
        ...
        action_url3 = "/siteadmin/downloadedit/" + id;
      } else if (usertype == 5) {
    ...
    $(document).on('click', '.active', function() {
      ...
      if (usertype == 4) {
        ...
        action_url4 = "/siteadmin/downloadstatus/" + id;
      } else if (usertype == 5) {
    ...
    $(document).on('click', '.delete', function() {
      ...
      swal({
          title: "Deleting Download List",
          text: "Are you sure to delete Download List?",
          type: "warning",
          buttons: true,
          dangerMode: true
        })
        .then((isconfirm) => {
          ...
          if (isconfirm) {
            $.ajax({
              url: "/webadmin/downloaddestroy/" + element_id,
              dataType: "json",
    ...
    $('#ok_button').click(function() {
      ...
      if (usertype == 4) {
        ...
        action_url5 = "/siteadmin/downloaddestroy/" + element_id;
      } else if (usertype == 5) {
