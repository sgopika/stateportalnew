...
<div class="row ">
  ...
  <div class="col-12 py-1 px-2 ">
    <p class="eng_xxs px-3 fg-darkBrown"> Gallery List </p>
  </div> <!-- ./col12 -->
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header modalover">
       ...
       @if(Auth::user()->usertypes_id==4)
      <form action="{{ route('webadmin.gallerystore') }}" id="ajaxmodalform" method="post" class="form-horizontal" enctype="multipart/form-data">
        @elseif(Auth::user()->usertypes_id==3)
      <form action="{{ route('siteadmin.gallerystore') }}" id="ajaxmodalform" method="post" class="form-horizontal" enctype="multipart/form-data">
      @elseif(Auth::user()->usertypes_id==5)
      <form action="{{ route('editor.gallerystore') }}" id="ajaxmodalform" method="post" class="form-horizontal" enctype="multipart/form-data">
        @elseif(Auth::user()->usertypes_id==6)
      <form action="{{ route('photoeditor.gallerystore') }}" id="ajaxmodalform" method="post" class="form-horizontal" enctype="multipart/form-data">
      @endif
      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
          <div class="row customformrow">
            <div class="col-md-6 py-2">
              <label for="IDNAME" class="eng_xxxs fg-darkBrown">Poster </label>
               <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> Upload file (Type:png,jpg,jpeg) (Max size:1 MB)</small>
            </div> <!-- ./col-md-6 -->
            <div class="col-md-6 py-2">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="alttext" name="alttext" aria-describedby="HELPNAME" placeholder="Alternative text for Image" maxlength="20" minlength="3" required>
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entitle" name="entitle" aria-describedby="HELPNAME" placeholder="English Title" maxlength="50" minlength="3" required>
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltitle" name="maltitle" aria-describedby="HELPNAME" placeholder="Title in Malayalam" maxlength="50" minlength="3" required>
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entooltip" name="entooltip" aria-describedby="HELPNAME" placeholder="English Tooltip" maxlength="50" minlength="3" required>
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltooltip" name="maltooltip" aria-describedby="HELPNAME" placeholder="Malayalam tooltip" maxlength="50" minlength="3" required>
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                 <input type="text" name="gallerydate" id="gallerydate" value="{{ Carbon\Carbon::now()->format('d/m/Y')  }}" class="form-control customform eng_xxxs fg-darkCrimson dob" required>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header modalover">
       ...
       @if(Auth::user()->usertypes_id==4)
      <form action="{{ route('webadmin.galleryupdate') }}" id="ajaxmodalform1" method="post" class="form-horizontal" enctype="multipart/form-data">
        @elseif(Auth::user()->usertypes_id==3)
      <form action="{{ route('siteadmin.galleryupdate') }}" id="ajaxmodalform1" method="post" class="form-horizontal" enctype="multipart/form-data">
      @elseif(Auth::user()->usertypes_id==5)
      <form action="{{ route('editor.galleryupdate') }}" id="ajaxmodalform1" method="post" class="form-horizontal" enctype="multipart/form-data">
        @elseif(Auth::user()->usertypes_id==6)
      <form action="{{ route('photoeditor.galleryupdate') }}" id="ajaxmodalform1" method="post" class="form-horizontal" enctype="multipart/form-data">
      @endif
      @csrf
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                 <input type="text" name="gallerydate1" id="gallerydate1" value="" class="form-control customform eng_xxxs fg-darkCrimson dob" required>
...
$("#transactionbutton").click(function(event){
	...
	var actionurl = '';
	if(usertype==4){
		 action_url = "{{ route('webadmin.gallerycreate') }}";
	} else if(usertype==5){
		 action_url = "{{ route('editor.gallerycreate') }}";
	} else if(usertype==3){
     action_url = "{{ route('siteadmin.gallerycreate') }}";
  } else if(usertype==6){
     action_url = "{{ route('photoeditor.gallerycreate') }}";
  }
...
/*$('#ajaxmodalform').on('submit', function(event){ 
  ...
  $(document).on('click', '.edit', function(){
      ...
      $('#ajaxformresults').html('');
	   var usertype=$("#usertypeid").val();
		var actionurl = '';
		if(usertype==4){
			 action_url3 = "/webadmin/galleryedit/"+id;
		} else if(usertype==3){
       action_url3 = "/siteadmin/galleryedit/"+id;
    } else if(usertype==5){
			 action_url3 = "/editor/galleryedit/"+id;
		} else if(usertype==6){
       action_url3 = "/photoeditor/galleryedit/"+id;
    }
      $.ajax({
       url :action_url3,
       dataType:"json",
       success:function(data)
        { 
           if(data.error){
            alert("The Gallery is Locked, So cannot be edited!");
          } else {       
            $("#uploadedimage").attr('src',"{{asset('Gallery')}}/"+data.resultdata.poster);  
   ...
   $(document).on('click', '.active', function(){
	...
	var usertype=$("#usertypeid").val();
		var actionurl4 = '';
		if(usertype==4){
			 action_url4 = "/webadmin/gallerystatus/"+id;
		} else if(usertype==3){
       action_url4 = "/siteadmin/gallerystatus/"+id;
    } else if(usertype==5){
			 action_url4 = "/editor/gallerystatus/"+id;
		} else if(usertype==6){
       action_url4 = "/photoeditor/gallerystatus/"+id;
    } 
    $.ajax({
      url:action_url4,
      dataType:"json",
  ...
  $(document).on('click', '.delete', function(){
    ...
    var usertype=$("#usertypeid").val();
		var actionurl5 = '';
		if(usertype==4){
			 action_url5 = "/webadmin/gallerydestroy/"+element_id;
		} else if(usertype==3){
       action_url5 = "/siteadmin/gallerydestroy/"+element_id;
    } else if(usertype==5){
			 action_url5 = "/editor/gallerydestroy/"+element_id;
		} else if(usertype==6){
       action_url5 = "/photoeditor/gallerydestroy/"+element_id;
    }
      swal(
            {
              title: "Deleting Gallery List",
              text: "Are you sure to delete Gallery List?",
              type: "warning",
              buttons: true,
              dangerMode: true
            })
