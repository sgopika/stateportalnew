                ...
                <table class="table table-stripped table-sm table-hover box-shadow--6dp" id="resposivetable">
                    ...
                    <tbody class="eng_xxxs">
                        ...
                        <tr>
                            ...
                            <td> <a type="button" class="active" name="statusbtn"
                                    id="{{ $res->id }}">@if($res->status==1) <i class="fas fa-check-circle"></i> @else
                                    <i class="fas fa-window-close fg-darkTaupe"></i> @endif</a></td>
                            <td>
                ...
                <div class="modal-body adminpage">
                    ...
                    <div id="form_section">
                        <div class="row customformrow">
                            ...
                            <div class="col-md-6 py-2">
                                <select class="form-control customform eng_xxxs fg-darkCrimson" id="appdepartments_id"
                        ...
                        <div class="row customformrow">
                            ...
                            <div class="col-md-6 py-2">
                                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson"
                                    ...
                                    placeholder="Placeholder value" maxlength="250" minlength="3">
                                <p id="ensectionnameerror" style="display:none; color:#FF0000;">Only A -Z a-z 0-9
                        ...
                        <div class="row customformrow">
                            ...
                            <div class="col-md-6 py-2">
                                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson"
                                    id="malsectionname" name="malsectionname" aria-describedby="HELPNAME"
                                    placeholder="Placeholder value" maxlength="250" minlength="3">
                                <p id="malsectionnameerror" style="display:none; color:#FF0000;">Only Malayalam
                                    Characters and spaces are allowed.</p>
                            </div> <!-- ./col-md-6 -->
                        </div> <!-- ./row -->
                        <div class="row customformrow">
                            ...
                            <div class="col-md-6 py-2">
                                <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="ensectiondetails"
                                    name="ensectiondetails" aria-describedby="HELPNAME" placeholder="Placeholder value"
                                    maxlength="1000" minlength="3"></textarea>
                                <p id="ensectiondetailserror" class="ErrP" style="display:none; color:#FF0000;">Only A -Z a-z 0-9
                                    Characters and spaces are allowed.</p>
                            </div> <!-- ./col-md-6 -->
                        </div> <!-- ./row -->
                        <div class="row customformrow">
                            ...
                            <div class="col-md-6 py-2">
                                <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="malsectiondetails"
                                    name="malsectiondetails" aria-describedby="HELPNAME" placeholder="Placeholder value"
                                    maxlength="1000" minlength="3"></textarea>
                                <p id="malsectiondetailserror" class="ErrP" style="display:none; color:#FF0000;">Only Malayalam
                                    Characters and spaces are allowed.</p>
                            </div> <!-- ./col-md-6 -->
                        </div> <!-- ./row -->
...
$(document).ready(function() {
    ...
    $('#malsectiondetails').on('change ', function(e) {
        var testval = this.value;

        var pattern = new XRegExp("^[\\p{InMalayalam} _.,]+$");
        if (XRegExp.test(testval, pattern)) {
            $('#malsectiondetailserror').hide();
        } else {
            // $('#malsectiondetails').val('');
            $('#malsectiondetailserror').slideDown("slow");
        }
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data.appdepartment, function(index, element) {
                    ...
                    element.id == data.resultdata.appdepartments_id ? $(
                        '#appdepartments_id').val(element.id).prop('selected',
                        true) : '';
                });
