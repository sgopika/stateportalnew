          ...
          { 
            ...
            $.each( data.mainmenu, function(i) {
              ...
              if(data.mainmenu[i].menulinktypes_id==6){
                  html+= '<li class="nav-item dropdown  active submenus'+data.mainmenu[i].id+'" id="'+data.mainmenu[i].id+'"><a class="nav-link dropdown-toggle  mainsublist" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" id="'+data.mainmenu[i].id+'" title="'+data.mainmenu[i].tooltip+'">'+data.mainmenu[i].title+'</a>';
