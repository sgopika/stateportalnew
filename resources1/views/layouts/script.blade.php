           ...
           //   $("#footer-title3").append(data.sitecontrollabels[27].title);  
            ...
            $.each(data.banner, function (i) {
                ...
                var banner3 = "{{asset('Banner')}}/"+data.banner[2].file;
                 $("#banner1").css({"background-image": "url(" + banner1 + ")"});  
                 $("#banner2").css({"background-image": "url(" + banner2 + ")"});  
                 $("#banner3").css({"background-image": "url(" + banner3 + ")"});  
            ...
            $.each(data.articlerecent, function (i) {
              $.ajax({
                  ...
                  success:function(datas4)
                  {
                    ...
                    var cont = txt.substring(0,500);
                    var img = "{{asset('Article')}}/"+data.articlerecent[i].poster
                    $("#articlelist").append('<div class="col-lg-4 col-md-4 col-12 "><div class="single-blog  h-100"><div class="blog-img"><a href="'+action_url1+'"> <img src="'+img+'"  alt=""> </a></div><div class="blog-content"> <h6><span>'+data.articlerecent[i].title+'</span></h6> <p class="shortintro">'+cont+'</p><br>  <div class="col-lg-6 col-md-6 col-12"> <div class="wish-button"><a href="'+action_url1+'"><button class="btn "><i class="lni lni-menu"></i>'+data.sitecontrollabels[3].title+'</button></a></div></div></div></div></div>');
            ...
            if(data.widget!=null){
              $.each(data.widget, function (i) {
                if(data.widget[i].menulinktypes_id==2){
                    $("#widgetrow").append('<li class="servicerow"><div class="media-icon"><i class="'+data.widget[i].icon+'"></i></div><div class="media-body"><h5><a href="'+data.widget[i].fileval+'" target="_blank" data-toggle="tooltip" data-placement="top"  title="'+data.widget[i].tooltip+'" >'+data.widget[i].title+'</a></h5><span>'+data.widget[i].subtitle+'</span></div></li>');
                }
