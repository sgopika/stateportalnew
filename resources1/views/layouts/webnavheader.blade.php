                    ...
                    <div class="collapse navbar-collapse text-right kg-iii-font" id="kg-main-nav">
                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-center" id="mainmenus">
                            ...
                            <!-- <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" id="menu1" role="button">Normal Dropdown</a>
                                <div class="dropdown-menu dropdown-menu-end  " aria-labelledby="menu1">
                                    <div class="row submenu">
                                    <ul class="col-md-6">
                                        <li>
                                        <a href="#">kerala at a glance</a>
                                        </li>
                                        <li>
                                        <a href="#">Accesibility</a>
                                        </li>
                                        <li>
                                        <a href="#">Major Destinations</a>
                                        </li>
                                    </ul>
                                    <ul class="col-md-6">
                                        <li>
