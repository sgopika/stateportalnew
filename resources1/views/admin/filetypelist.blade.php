...
<div class="row ">
  ...
  @endif
    ...
    <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;  File Type List </strong></p>
   </div>
            ...
            <tbody class="eng_xxxs">
               @php
                ...
                <tr>
                    ...
                    <td><span class="eng_xxxxs"> {{ $res->contenttitle }}</span> </td>
      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" minlength="3" maxlength="20" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="Name" maxlength="20" minlength="3">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" minlength="3" maxlength="50" class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Name in Malayalam" maxlength="50" minlength="3">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
               <select class="form-control customform eng_xxxs fg-darkCrimson" id="contenttypeid" name="contenttypeid">
...
$("#transactionbutton").click(function(event){
    ...
    $('.modal-title').text('Add New File type');
    ...
    $("#transactionmodal").modal('show');
     ...
     $.ajax({
       url: "{{ route('admin.filetypecreate') }}",
       dataType:"json",
       success:function(data)
        {
             $('#contenttypeid').empty();
            $('#contenttypeid').append($('<option></option>').val('0').html('Select'));
            ...
            $('.modal-title').text('Add New Filetype');
            $('#actionbutton').val('Save Details');
            $('#action').val('Add');
            $('#ajaxformresults').html('');
            $("#transactionmodal").modal('show');
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('admin.filetypestore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('admin.filetypeupdate') }}";
              ...
              swal({
                ...
                .then((value) => {
                    if (value) {
                      ...
                      window.location.replace("{{route('admin.filetypelist')}}");
                    }
                });;
           ...
           $('#contenttypeid').empty();
            ...
            $.each(data.contenttype, function(index, element) {
                $('#contenttypeid').append(
                 ...
                 element.id == data.resultdata.contenttypes_id ? $('#contenttypeid').val(element.id).prop('selected', true) : '';
            });
  ...
  $(document).on('click', '.delete', function(){
      ...
      swal(
            {
              title: "Deleting File Type List Category",
              text: "Are you sure to delete File Type List Category?",
              type: "warning",
              buttons: true,
              dangerMode: true
            })
          .then((isconfirm) => {
            ...
            if (isconfirm) {
              $.ajax({
                  url:"/admin/filetypedestroy/"+element_id,
                  dataType:"json",
