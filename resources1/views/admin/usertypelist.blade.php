...
<div class="row ">
 ...
 <div class="col-12 py-1">
  ...
  @endif
    ...
    <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;  Usertype List </strong></p>
   </div>
  <div class="col-12 py-1">
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('admin.usertypestore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('admin.usertypeupdate') }}";
              ...
              swal({
                ...
                .then((value) => {
                    if (value) {
                      ...
                      window.location.replace("{{route('admin.usertypelist')}}");
                    }
                });;
              }
  ...
  $(document).on('click', '.delete', function(){
      ...
      swal(
            {
              title: "Deleting Usertype List Category",
              text: "Are you sure to delete Usertype List Category?",
              type: "warning",
              buttons: true,
              dangerMode: true
            })
          .then((isconfirm) => {
            ...
            if (isconfirm) {
              $.ajax({
                  url:"/admin/usertypedestroy/"+element_id,
                  dataType:"json",
