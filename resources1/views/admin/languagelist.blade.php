...
<div class="row ">
 ...
 <div class="col-12 py-1">
  ...
  @endif
    ...
    <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;  Language List </strong></p>
   </div>
  <div class="col-12 py-1">
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    var action_url = '';
    if($('#action').val() == 'Add')
        action_url = "{{ route('admin.languagestore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('admin.languageupdate') }}";
  ...
  $(document).on('click', '.delete', function(){
      ...
      swal(
            {
              title: "Deleting Language List",
              text: "Are you sure to delete Language List?",
              type: "warning",
              buttons: true,
              dangerMode: true
            })
          .then((isconfirm) => {
            ...
            if (isconfirm) {
              $.ajax({
                  url:"/admin/languagedestroy/"+element_id,
                  dataType:"json",
