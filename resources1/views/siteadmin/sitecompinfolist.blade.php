...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp; Site Compatibility Info List </strong></p>
   </div>
  <div class="col-12 py-1">
      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
         ...
         <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entooltip" name="entooltip" aria-describedby="HELPNAME" placeholder="English tootip" maxlength="500" minlength="3">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltooltip" name="maltooltip" aria-describedby="HELPNAME" placeholder="Malayalam tooltip" maxlength="500" minlength="3">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entitle" name="entitle" aria-describedby="HELPNAME" placeholder="English title" maxlength="500" minlength="3">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltitle" name="maltitle" aria-describedby="HELPNAME" placeholder="Malayalam title" maxlength="500" minlength="3">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malsubtitle" name="malsubtitle" aria-describedby="HELPNAME" placeholder="Malayalam subtitle" maxlength="500" minlength="3">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-12 py-2">
                ...
                <textarea class="summernote" id="malcontent" name="malcontent" aria-describedby="HELPNAME" placeholder="Name in Malayalam" maxlength="2000" minlength="3"></textarea>
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="icon" name="icon" aria-describedby="HELPNAME" maxlength="150" minlength="3">
...
$('#ajaxmodalform').on('submit', function(event){ 
   ...
   var usertype=$("#usertypeid").val(); 
    ...
    if(usertype==3){
          ...
          if($('#action').val() == 'Add')
          action_url = "{{ route('siteadmin.sitecompinfostore') }}";

      if($('#action').val() == 'Edit')
          action_url = "{{ route('siteadmin.sitecompinfoupdate') }}";

      } else if(usertype==4){

          if($('#action').val() == 'Add')
          action_url = "{{ route('webadmin.sitecompinfostore') }}";

      if($('#action').val() == 'Edit')
          action_url = "{{ route('webadmin.sitecompinfoupdate') }}";
  ...
  $(document).on('click', '.edit', function(){
      ...
      $('#ajaxformresults').html('');
       var action_url2 = '';
        var usertype=$("#usertypeid").val(); 
        if(usertype==3){
           action_url2 = "/siteadmin/sitecompinfoedit/"+id;
        } else if(usertype==4){
           action_url2 = "/webadmin/sitecompinfoedit/"+id;
        }
      $.ajax({
       url :action_url2,
       dataType:"json",
   ...
   $(document).on('click', '.active', function(){
    ...
    var action_url3 = '';
        var usertype=$("#usertypeid").val(); 
        if(usertype==3){
           action_url3 = "/siteadmin/sitecompinfostatus/"+id;
        } else if(usertype==4){
           action_url3 = "/webadmin/sitecompinfostatus/"+id;
        } 
    $.ajax({
      url:action_url3,
      dataType:"json",
  ...
  $('#ok_button').click(function(){
    var action_url4 = '';
        var usertype=$("#usertypeid").val(); 
        if(usertype==3){
           action_url4 = "/siteadmin/sitecompinfodestroy/"+element_id;
        } else if(usertype==4){
           action_url4 = "/webadmin/sitecompinfodestroy/"+element_id;
        } 
