...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp; Terms And Condition List </strong></p>
   </div>
  <div class="col-12 py-1">
      ...
      <div class="modal-body adminpage">
        ...
        <div id="form_section">
         ...
         <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entooltip" name="entooltip" aria-describedby="HELPNAME" placeholder="English tooltip" maxlength="20" minlength="3" required>
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltitle" name="maltitle" aria-describedby="HELPNAME" placeholder="Malayalam title" required maxlength="50" minlength="3">
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="ensubtitle" name="ensubtitle" aria-describedby="HELPNAME" placeholder="English subtitle" maxlength="20" minlength="3" required>
...
$('#entooltip').on('change ', function(e) {
  ...
  var tested = new RegExp('^[a-zA-Z 0-9\s]+$');
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    var action_url = '';
      ...
      if(usertype==3){
         if($('#action').val() == 'Add')
        action_url = "{{ route('siteadmin.termsandconditionstore') }}";

        if($('#action').val() == 'Edit')
            action_url = "{{ route('siteadmin.termsandconditionupdate') }}";
      } 
      else if(usertype==4){
         if($('#action').val() == 'Add')
        action_url = "{{ route('webadmin.termsandconditionstore') }}";

        if($('#action').val() == 'Edit')
            action_url = "{{ route('webadmin.termsandconditionupdate') }}";
      }
         ...
         { 
            ...
            if(data.success)
            {
               ...
               swal("Updated Sucessfully")
                        .then((value) => {
                         $('#ajaxmodalform')[0].reset();
                         window.location.href='/siteadmin/termsandconditionlist';
                        });
            }
         }
    });
  ...
  $(document).on('click', '.edit', function(){
      ...
      var usertype=$("#usertypeid").val(); 
      if(usertype==3){
         action_url2 ="/siteadmin/termsandconditionedit/"+id;
      } else if(usertype==4){
         action_url2 = "/webadmin/termsandconditionedit/"+id;
      }
      $.ajax({
       url :action_url2,
       dataType:"json",
   ...
   $(document).on('click', '.active', function(){
    ...
    var action_url3 = '';
      var usertype=$("#usertypeid").val(); 
      if(usertype==3){
         action_url3 ="/siteadmin/termsandconditionstatus/"+id;
      } else if(usertype==4){
         action_url3 = "/webadmin/termsandconditionstatus/"+id;
      } 
    $.ajax({
      url:action_url3,
      dataType:"json",
  ...
  $('#ok_button').click(function(){
    var action_url4 = '';
      var usertype=$("#usertypeid").val(); 
      if(usertype==3){
         action_url4 ="/siteadmin/termsandconditiondestroy/"+element_id;
      } else if(usertype==4){
         action_url4 ="/webadmin/termsandconditiondestroy/"+element_id;
      } 
