...
<div class="modal fade"  id="transactionmodal" tabindex="-1" role="dialog" aria-labelledby="addmodalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="English title" required required maxlength="250" minlength="3">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Malayalam title" required maxlength="250" minlength="3">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entooltip" name="entooltip" aria-describedby="HELPNAME" placeholder="English tooltip" required maxlength="250" minlength="3">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltooltip" name="maltooltip" aria-describedby="HELPNAME" placeholder="Malayalam tooltip" required maxlength="250" minlength="3">
 ...
 <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="iconclass" name="iconclass" aria-describedby="HELPNAME" minlength="3" maxlength="250">
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="urlpath" name="urlpath" aria-describedby="HELPNAME" placeholder="URL" minlength="3" maxlength="1000">
      </div> <!-- ./col-md-6 -->
    </div> <!-- ./row -->
...
$('#ajaxmodalform').on('submit', function(event){ 
  ...
  if(usertype==3){
    ...
    if($('#action').val() == 'Edit')
        action_url = "{{ route('siteadmin.socialmediaupdate') }}";
    ...
    if($('#action').val() == 'Edit')
        action_url = "{{ route('webadmin.socialmediaupdate') }}";
    ...
    $.ajax({
         ...
         { 
            ...
            if(data.errors)
            {
               swal("Already a social media with same name exists");
            ...
            if(data.success)
            {
               ...
               swal("Updated Sucessfully")
                        .then((value) => {
                         $('#ajaxmodalform')[0].reset();
                         window.location.href='/siteadmin/socialmedialist';
                        });
            }
         }
    });
