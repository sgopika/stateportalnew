        ...
        <div class="modal-body adminpage">
          ...
          <div id="form_section">
            ...
            <div class="row customformrow">
              ...
              <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="alttext" name="alttext" aria-describedby="HELPNAME" placeholder="Alternative text for image" maxlength="100" minlength="3">
                <p id="alttexterror" style="display:none; color:#FF0000;">Invalied characters are not allowed.</p>
              </div> <!-- ./col-md-6 -->
            </div> <!-- ./row -->
            ...
            <div class="row customformrow">
              ...
              <div class="col-md-6 py-2">
                ...
                <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="Title in English" maxlength="1000" minlength="3" rows="4"></textarea>
                <p id="nameerror" style="display:none; color:#FF0000;">Invalied characters are not allowed.</p>
              </div> <!-- ./col-md-6 -->
            </div> <!-- ./row -->
            <div class="row customformrow">
              <div class="col-md-6 py-2">
              ...
              <div class="col-md-6 py-2">
                ...
                <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Title in Malayalam" maxlength="1000" minlength="3" rows="4"></textarea>
                <p id="malnameerror" style="display:none; color:#FF0000;">Invalied characters are not allowed.</p>
              </div> <!-- ./col-md-6 -->
            </div> <!-- ./row -->
            <div class="row customformrow">
              <div class="col-md-6 py-2">
              ...
              <div class="col-md-6 py-2">
                <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="subname" name="subname" aria-describedby="HELPNAME" placeholder="Sub title in English" maxlength="1000" minlength="3" rows="4"></textarea>
                <p id="subnameerror" style="display:none; color:#FF0000;">Invalied characters are not allowed.</p>
            ...
            <div class="row customformrow">
              ...
              <div class="col-md-6 py-2">
                ...
                <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="malsubname" name="malsubname" aria-describedby="HELPNAME" placeholder="Sub title in Malayalam" maxlength="1000" minlength="3" rows="4"></textarea>
                <p id="malsubnameerror" style="display:none; color:#FF0000;">Invalied characters are not allowed.</p>
              </div> <!-- ./col-md-6 -->
            </div> <!-- ./row -->
            <div class="row customformrow">
              <div class="col-md-6 py-2">
              ...
              <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="iconclass" name="iconclass" aria-describedby="HELPNAME" placeholder="Class for icon" value="">
                <p id="iconerror" style="display:none; color:#FF0000;">Invalied characters are not allowed.</p>
              </div> <!-- ./col-md-6 -->
            </div> <!-- ./row -->
