...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Edit Address with Map </strong></p>
   </div>
  <div class="col-12 py-1">
            ...
            <div class="modal-body adminpage">
                <div id="form_section">
                    <div class="row customformrow">
                        ...
                        <div class="col-md-6 py-2">
                            <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entitle" name="entitle" aria-describedby="HELPNAME" placeholder="Name" maxlength="20" minlength="3" value="{{$resultdata['entitle']}}">
                    ...
                    <div class="row customformrow">
                        ...
                        <div class="col-md-6 py-2">
                            <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltitle" name="maltitle" aria-describedby="HELPNAME" placeholder="Name in Malayalam" maxlength="50" minlength="3" value="{{$resultdata['maltitle']}}">
                    ...
                    <div class="row customformrow">
                        ...
                        <div class="col-md-6 py-2">
                            <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="ensubtitle" name="ensubtitle" aria-describedby="HELPNAME" placeholder="Name" maxlength="20" minlength="3" value="{{$resultdata['ensubtitle']}}">
                    ...
                    <div class="row customformrow">
                        ...
                        <div class="col-md-6 py-2">
                            <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malsubtitle" name="malsubtitle" aria-describedby="HELPNAME" placeholder="Name in Malayalam" maxlength="50" minlength="3" value="{{$resultdata['malsubtitle']}}">
                    ...
                    <div class="row customformrow">
                        ...
                        <div class="col-md-12 py-2">
                            ...
                            <textarea class="summernote" id="encontent" name="encontent" aria-describedby="HELPNAME" placeholder="Name" maxlength="1000" minlength="3">{{$resultdata['encontent']}}</textarea>
                    ...
                    <div class="row customformrow">
                        ...
                        <div class="col-md-12 py-2">
                            ...
                            <textarea class="summernote" id="malcontent" name="malcontent" aria-describedby="HELPNAME" placeholder="Name in Malayalam" maxlength="1000" minlength="3">{{$resultdata['malcontent']}}</textarea>
                    ...
                    <div class="row customformrow">
                        ...
                        <div class="col-md-6 py-2">
                            <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="icon" name="icon" aria-describedby="HELPNAME" placeholder="Name" maxlength="150" minlength="3" value="{{$resultdata['iconclass']}}">
                    ...
                    <div class="row customformrow">
                        ...
                        <div class="col-md-6 py-2">
                            <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entooltip" name="entooltip" aria-describedby="HELPNAME" placeholder="Name" maxlength="20" minlength="3" value="{{$resultdata['entooltip']}}">
                    ...
                    <div class="row customformrow">
                        ...
                        <div class="col-md-6 py-2">
                            <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltooltip" name="maltooltip" aria-describedby="HELPNAME" placeholder="Name in Malayalam" maxlength="50" minlength="3" value="{{$resultdata['maltooltip']}}">
                    ...
                    <div class="row customformrow">
                        ...
                        <div class="col-md-6 py-2">
                            <input type="checkbox" id="displaystatus" value="1" name="displaystatus" {{isset($resultdata['displaystatus']) && $resultdata['displaystatus'] == 1 ?'checked':''}}>
                        </div> <!-- ./col-md-6 -->
                    </div> <!-- ./row -->
                    ...
                    <div class="row customformrow">
                        ...
                        <div class="col-md-6 py-2">
                            <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="maplink" name="maplink" aria-describedby="HELPNAME" placeholder="Map Link" maxlength="2000" minlength="6">{{$resultdata['maplinks']}}</textarea>
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    if(usertype==3){
        ...
        if($('#action').val() == 'Edit')
            action_url = "{{ route('siteadmin.addresswithmapupdate') }}";
        ...
        if($('#action').val() == 'Edit')
            action_url = "{{ route('webadmin.addresswithmapupdate') }}";
    } 
