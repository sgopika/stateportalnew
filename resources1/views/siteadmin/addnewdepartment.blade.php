                        ...
                        <div class="row customformrow">
                            ...
                            <div class="col-md-9 py-2">
                                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson"
                                    ...
                                    placeholder="English subtitle" maxlength="1000" minlength="3" required>
                        ...
                        <div class="row customformrow">
                            ...
                            <div class="col-md-9 py-2">
                                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="icon"
                                    name="icon" aria-describedby="HELPNAME" placeholder="Icon class" maxlength="150"
                                    minlength="2" value="fas fa-question-circle" required>
                        ...
                        <div class="row customformrow">
                            ...
                            <div class="col-md-9 py-2">
                                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson"
                                    ...
                                    placeholder="English tooltip" maxlength="500" minlength="3" value="Department Details" required>
                        ...
                        <div class="row customformrow">
                            ...
                            <div class="col-md-9 py-2">
                                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson"
                                    ...
                                    placeholder="Malayalam tooltip" maxlength="1000" minlength="3" value="വകുപ്പിന്റെ വിശദാംശങ്ങൾ">
