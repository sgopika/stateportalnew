...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Edit Archive </strong></p>
   </div>
  <div class="col-12 py-1">
                ...
                <form  id="ajaxmodalform" method="post" class="form-horizontal" >
                    ...
                    <div id="form_section">
                        ...
                        <div class="row customformrow">
                            ...
                            <div class="col-md-6 py-2">
                                <input type="checkbox" id="displaystatus"  name="displaystatus" {{isset($resultdata['homepagestatus']) && $resultdata['homepagestatus'] == 1 ?'checked':''}}>
                            </div> <!-- ./col-md-6 -->
                        </div> <!-- ./row -->
