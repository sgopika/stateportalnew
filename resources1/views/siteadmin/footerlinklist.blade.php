...
<div class="row ">
  <div class="col-12 py-2  ">
   ...
   <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp;Footer Link </strong></p>
   </div>
 <div class="col-12 py-1">
...
<div class="modal fade"  id="transactionmodal" tabindex="-1" role="dialog" aria-labelledby="addmodalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" role="document">
    ...
    <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="name" name="name" aria-describedby="HELPNAME" placeholder="English Title" minlength="3" maxlength="100" required>
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malname" name="malname" aria-describedby="HELPNAME" placeholder="Malayalam Title" minlength="3" maxlength="100" required>
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entooltip" name="entooltip" aria-describedby="HELPNAME" placeholder="English tooltip" minlength="3" maxlength="100" required>
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltooltip" name="maltooltip" aria-describedby="HELPNAME" placeholder="Malayalam tooltip" minlength="3" maxlength="100" required>
 ...
 <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="iconclass" name="iconclass" aria-describedby="HELPNAME" minlength="3" maxlength="50" placeholder="Iconclass" required> 
     ...
     <div class="row customformrow">
      ...
      <div class="col-md-6 py-2">
          <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="urlpath" name="urlpath" aria-describedby="HELPNAME" placeholder="URL" required>
...
$("#transactionbutton").click(function(event){
    ...
    $('.modal-title').text('Add New Footer link');
...
$('#ajaxmodalform').on('submit', function(event){ 
  ...
  if(usertype==3){
      ...
      if($('#action').val() == 'Add')
        action_url = "{{ route('siteadmin.footerlinkstore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('siteadmin.footerlinkupdate') }}";

  } else if(usertype==4){

      if($('#action').val() == 'Add')
        action_url = "{{ route('webadmin.footerlinkstore') }}";

    if($('#action').val() == 'Edit')
        action_url = "{{ route('webadmin.footerlinkupdate') }}";
  ...
  $(document).on('click', '.edit', function(){
      ...
      var usertype=$("#usertypeid").val(); 
      if(usertype==3){
         action_url2 = "/siteadmin/footerlinkedit/"+id;
      } else if(usertype==4){
         action_url2 = "/webadmin/footerlinkedit/"+id;
      }
      $.ajax({
       url :action_url2,
       dataType:"json",
   ...
   $(document).on('click', '.active', function(){
    ...
    var usertype=$("#usertypeid").val();
     var action_url3 = ''; 
      if(usertype==3){
         action_url3 = "/siteadmin/footerlinkstatus/"+id;
      } else if(usertype==4){
         action_url3 = "/webadmin/footerlinkstatus/"+id;
      } 
    $.ajax({
      url:action_url3,
      dataType:"json",
