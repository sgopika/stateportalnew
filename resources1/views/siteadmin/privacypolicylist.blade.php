...
<div class="row ">
  ...
  <div class="col-12 py-1">
     <p class="py-2"> <strong > <i class="fas fa-hand-point-right"></i> &nbsp; Privacy Policy List </strong></p>
   </div>
  <div class="col-12 py-1">
        ...
        <div id="form_section">
         ...
         <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                ...
                <p id="entooltiperror" style="display:none; color:#FF0000;" >A -Z a-z Characters,Numbers and special characters(like "",&()-$_=)
allowed</p>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltooltip" name="maltooltip" aria-describedby="HELPNAME" placeholder="Malayalam tooltip" maxlength="500" minlength="3" required>
                 <p id="maltooltiperror" style="display:none; color:#FF0000;" >Only Malayalam Characters Numbers and special characters(like "",&()-$_=) are
allowed.</p>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entitle" name="entitle" aria-describedby="HELPNAME" placeholder="English title" maxlength="500" minlength="3" required>
                <p id="entitleerror" style="display:none; color:#FF0000;" >A -Z a-z Characters,Numbers and special characters(like "",&()-$_=)
allowed.</p>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltitle" name="maltitle" aria-describedby="HELPNAME" placeholder="Malayalam title" maxlength="500" minlength="3" required>
...
allowed.</p>
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="ensubtitle" name="ensubtitle" aria-describedby="HELPNAME" placeholder="English subtitle" maxlength="500" minlength="3" required>
                <p id="ensubtitleerror" style="display:none; color:#FF0000;" >A -Z a-z Characters,Numbers and special characters(like "",&()-$_=)
allowed.</p>
            </div> <!-- ./col-md-6 -->
          </div> <!-- ./row -->
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malsubtitle" name="malsubtitle" aria-describedby="HELPNAME" placeholder="Malayalam subtitle" maxlength="500" minlength="3" required>
...
allowed..</p>
          ...
          <div class="row customformrow">
            ...
            <div class="col-md-6 py-2">
                <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="icon" name="icon" aria-describedby="HELPNAME" placeholder="Icon class" maxlength="150" minlength="3" required>
          ...
          <div class="row customformrow">
            <div class="col-md-6 py-2">
              <label for="IDNAME" class="eng_xxxs fg-darkBrown">English Description </label>
              <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> Enter the English description.</small>
            </div> <!-- ./col-md-6 -->
            </div>
            <div class="row customformrow">
            <div class="col-md-12 py-2">
                ...
                <textarea class="summernote" id="encontent" name="encontent" aria-describedby="HELPNAME" placeholder="English description" maxlength="5000" minlength="3"></textarea>
          ...
          <div class="row customformrow">
            <div class="col-md-6 py-2">
              <label for="IDNAME" class="eng_xxxs fg-darkBrown">Malayalam Description </label>
              <small id="HELPNAME" class="form-text eng_xxxxs text-muted"> Malayalam description</small>
            </div> <!-- ./col-md-6 -->
            </div>
            <div class="row customformrow">
            <div class="col-md-12 py-2">
                <!-- <textarea class="form-control customform eng_xxxs fg-darkCrimson" id="enbrief" name="enbrief" aria-describedby="HELPNAME" placeholder="Name" maxlength="1000" minlength="3"></textarea> -->
                <textarea class="summernote" id="malcontent" name="malcontent" aria-describedby="HELPNAME" placeholder="Malayalam description" maxlength="10000" minlength="3"></textarea>
      ...
      <div class="modal-footer modalover">
        ...
        <button type="button" data-dismiss="modal" class="btn btn-sm btn-flat eng_xxxs bg-lightBrown fg-darkCrimson"> <i class="fa fa-times"></i> &nbsp;Cancel</button>
      </div> <!-- ./modal-footer  -->
    </form>
    </div> <!-- ./modal-content -->
  </div> <!-- ./modal-dialog -->
...
$('#ajaxmodalform').on('submit', function(event){ 
    ...
    var usertype=$("#usertypeid").val();
      if(usertype==3){
        if($('#action').val() == 'Add')
            action_url = "{{ route('siteadmin.privacypolicystore') }}";

        if($('#action').val() == 'Edit')
            action_url = "{{ route('siteadmin.privacypolicyupdate') }}";
      } else if(usertype==4){
        if($('#action').val() == 'Add')
            action_url = "{{ route('webadmin.privacypolicystore') }}";

        if($('#action').val() == 'Edit')
            action_url = "{{ route('webadmin.privacypolicyupdate') }}";
      }
         ...
         { 
            ...
            if(data.success)
            {
               ...
               swal("Updated Sucessfully")
                        .then((value) => {
                         $('#ajaxmodalform')[0].reset();
                         window.location.href='/siteadmin/privacypolicylist';
                        });
            }
         }
    });
  ...
  $(document).on('click', '.edit', function(){
      ...
      var usertype=$("#usertypeid").val();
       var action_url2 = ''; 
        if(usertype==3){
           action_url2 = "/siteadmin/privacypolicyedit/"+id;
        } else if(usertype==4){
           action_url2 = "/webadmin/privacypolicyedit/"+id;
        }
      $.ajax({
       url :action_url2,
       dataType:"json",
   ...
   $(document).on('click', '.active', function(){
    ...
    var id = $(this).attr('id'); 
     var usertype=$("#usertypeid").val();
       var action_url3 = ''; 
        if(usertype==3){
           action_url3 = "/siteadmin/privacypolicystatus/"+id;
        } else if(usertype==4){
           action_url3 = "/webadmin/privacypolicystatus/"+id;
        }
    $.ajax({
      url:action_url3,
      dataType:"json",
  ...
  $('#ok_button').click(function(){
    var usertype=$("#usertypeid").val();
       var action_url4 = ''; 
        if(usertype==3){
           action_url4 = "/siteadmin/privacypolicydestroy/"+element_id;
        } else if(usertype==4){
           action_url4 = "/webadmin/privacypolicydestroy/"+element_id;
        }
