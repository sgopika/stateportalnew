...
<div class="container-fluid homepage adminpage">
    <div class="row ">
        ...
        <div class="col-12 py-1">
            <p class="py-2"> <strong> <i class="fas fa-hand-point-right"></i> &nbsp; Edit Media Alert List </strong></p>
        </div>
        <div class="col-12 py-1">
                    ...
                    <div class="modal-body adminpage">
                        ...
                        <div id="form_section">
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <select class="form-control customform eng_xxxs fg-darkCrimson" id="contenttypes_id" name="contenttypes_id" required>
                                        ...
                                        <option value="{{$content->id}}" {{ ( $content->id == $contenttypes_id) ? 'selected' : '' }}>{{$content->entitle}}</option>
                                        @endforeach
                                    </select>
                                </div> <!-- ./col-md-6 -->
                            </div> <!-- ./row -->
                            <div class="row customformrow" id="filetypediv">
                                ...
                                <div class="col-md-6 py-2">
                                    <select class="form-control customform eng_xxxs fg-darkCrimson" id="filetypes_id" name="filetypes_id" required>
                                        ...
                                        <option value="{{$file->id}}" {{( $file->id == $filetypes_id) ? 'selected' : '' }}>{{$file->entitle}}</option>
                                        @endforeach
                                    </select>
                                </div> <!-- ./col-md-6 -->
                            </div> <!-- ./row -->
                            <div class="row customformrow" id="uploaddiv">
                                ...
                                <div class="col-md-6 py-2">
                                    <img src="/Mediaalert/{{$resultdata->file}}" class="img-thumbnail displaythumbnail customform eng_xxxs fg-darkCrimson" alt="Image" id="image_upload" name="image_uploaded">
                                    <span id="upfile"></span>
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="size" name="size" aria-describedby="HELPNAME" placeholder="File size" maxlength="500" minlength="3" required value="{{$resultdata->size}}">
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="duration" name="duration" aria-describedby="HELPNAME" placeholder="File duration" required maxlength="500" minlength="3" value="{{$resultdata->size}}">
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="alttext" name="alttext" aria-describedby="HELPNAME" placeholder="Alternative text" required maxlength="500" minlength="3" value="{{$resultdata->size}}">
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="entitle" name="entitle" aria-describedby="HELPNAME" placeholder="English Title" required maxlength="500" minlength="3" value="{{$resultdata->entitle}}">
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="maltitle" name="maltitle" aria-describedby="HELPNAME" placeholder="Malayalam Title" required maxlength="1000" minlength="3" value="{{$resultdata->maltitle}}">
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="ensubtitle" name="ensubtitle" aria-describedby="HELPNAME" placeholder="English Subtitle" required maxlength="1000" minlength="3" value="{{$resultdata->ensubtitle}}">
                            ...
                            <div class="row customformrow">
                                ...
                                <div class="col-md-6 py-2">
                                    <input type="text" class="form-control customform eng_xxxs fg-darkCrimson" id="malsubtitle" name="malsubtitle" aria-describedby="HELPNAME" placeholder="Malayalam subtitle" maxlength="1000" minlength="3" value="{{$resultdata->malsubtitle}}">
                            ...
                            <div class="row customformrow">
                                <div class="col-md-12 py-2">
                                    ...
                                    <textarea class="summernote" id="enbrief" name="enbrief" aria-describedby="HELPNAME" placeholder="Name" maxlength="5000" minlength="3">{{$resultdata->enbrief}}</textarea>
                            ...
                            <div class="row customformrow">
                                <div class="col-md-12 py-2">
                                    ...
                                    <textarea class="summernote" id="malbrief" name="malbrief" aria-describedby="HELPNAME" placeholder="Name" maxlength="30000" minlength="3">{{$resultdata->malbrief}}</textarea>
                            ...
                            <div class="row customformrow">
                                <div class="col-md-12 py-2">
                                    ...
                                    <textarea class="summernote" id="encontent" name="encontent" aria-describedby="HELPNAME" placeholder="Name" maxlength="5000" minlength="3">{{$resultdata->encontent}}</textarea>
                            ...
                            <div class="row customformrow">
                                <div class="col-md-12 py-2">
                                    ...
                                    <textarea class="summernote" id="malcontent" name="malcontent" aria-describedby="HELPNAME" placeholder="Name in Malayalam" maxlength="30000" minlength="3">{{$resultdata->malcontent}}</textarea>
...
<script>
  ...
  if (file) {
    image_upload.src = URL.createObjectURL(file)
  }
}
</script>
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.delete', function() {
            ...
            swal({
                    title: "Deleting Media Alert List",
                    text: "Are you sure to delete Media Alert List?",
                    type: "warning",
                    buttons: true,
                    dangerMode: true
                })
                    ...
                    if (isconfirm) {
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                swal({
                                        title: 'Media Alert List Deleted',
                                        text: data.success,
                                        type: 'info',
