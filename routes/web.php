...
Route::get('/', 'PortalController@mainlogin')->name('mainlogin');
Route::get('/setbilingualval', 'PortalController@setbilingualval')->name('setbilingualval');
Route::get('/setbilingualvalmal', 'PortalController@setbilingualvalmal')->name('setbilingualvalmal');
Route::get('/setvalueshomepage', 'PortalController@setvalueshomepage')->name('setvalueshomepage');
Route::get('/articledetailview/{id}', 'PortalController@articledetailview')->name('articledetailview');
Route::post('/getfielddepartment', 'PortalController@getfielddepartment')->name('getfielddepartment');
Route::post('/gosearch', 'PortalController@gosearch')->name('gosearch');
Route::get('/documentdetailview/{id}', 'PortalController@documentdetailview')->name('documentdetailview');
Route::post('/documentsearch', 'PortalController@documentsearch')->name('documentsearch');
Route::post('/documentsearchtwo', 'PortalController@documentsearchtwo')->name('documentsearchtwo');
Route::get('/testmenu', 'PortalController@testmenu')->name('testmenu');
Route::get('/modalpop/{id}', 'PortalController@modalpop')->name('modalpop');
Route::get('/setvaluesencrypt/{id}', 'PortalController@setvaluesencrypt')->name('setvaluesencrypt');
Route::post('/search', 'PortalController@search')->name('search');
Route::get('/documentshow/{id}', 'PortalController@documentshow')->name('documentshow');
Route::get('/sitemap.xml', 'SitemapController@index');
Route::get('/articledetailid/{id}', 'PortalController@articledetailid')->name('articledetailid');
Route::get('/articledetail', 'PortalController@articledetail')->name('articledetail');
Route::get('/whatsnewdetail', 'PortalController@whatsnewdetail')->name('whatsnewdetail');
Route::get('/whatsnewid/{id}', 'PortalController@whatsnewid')->name('whatsnewid');
Route::get('/dstpgmid/{id}', 'PortalController@dstpgmid')->name('dstpgmid');
Route::post('/dstpgmdstid', 'PortalController@dstpgmdstid')->name('dstpgmdstid');
Route::get('/documenttypedetail/{id}', 'PortalController@documenttypedetail')->name('documenttypedetail');
Route::post('/doctypewisedetail', 'PortalController@doctypewisedetail')->name('doctypewisedetail');
Route::get('/searchdocs', 'PortalController@searchdocs')->name('searchdocs');
Route::post('/getfielddepartmentnew', 'PortalController@getfielddepartmentnew')->name('getfielddepartmentnew');
Route::post('/advancesearch', 'PortalController@advancesearch')->name('advancesearch');
Auth::routes();
...
Route::group(['middleware' => ['auth', 'App\Http\Middleware\Admin']], function () {
	...
	Route::post('/admin/getfielddepartment', 'DocumentController@getfielddepartment')->name('admin.getfielddepartment')->middleware('auth');
	...
	/*Story Category*/
	Route::get('/admin/storycategorylist', 'AdminController@storycategorylist')->name('admin.storycategorylist')->middleware('auth');
	Route::post('/admin/storycategorystore', 'AdminController@storycategorystore')->name('admin.storycategorystore')->middleware('auth');
	Route::get('/admin/storycategoryedit/{id}', 'AdminController@storycategoryedit')->middleware('auth');
	Route::post('/admin/storycategoryupdate', 'AdminController@storycategoryupdate')->name('admin.storycategoryupdate')->middleware('auth');
	Route::get('/admin/storycategorydestroy/{id}', 'AdminController@storycategorydestroy')->middleware('auth');
	Route::get('/admin/storycategorystatus/{id}', 'AdminController@storycategorystatus')->middleware('auth');
	...
	/*Field Department */
	Route::get('/admin/fielddepartmentlist', 'AdminController@fielddepartmentlist')->name('admin.fielddepartmentlist')->middleware('auth');
	Route::get('admin/fielddepartmentcreate', 'AdminController@fielddepartmentcreate')->name('admin.fielddepartmentcreate')->middleware('auth');
	Route::post('/admin/fielddepartmentstore', 'AdminController@fielddepartmentstore')->name('admin.fielddepartmentstore')->middleware('auth');
	Route::get('/admin/fielddepartmentedit/{id}', 'AdminController@fielddepartmentedit')->middleware('auth');
	Route::post('/admin/fielddepartmentupdate', 'AdminController@fielddepartmentupdate')->name('admin.fielddepartmentupdate')->middleware('auth');
	Route::get('/admin/fielddepartmentdestroy/{id}', 'AdminController@fielddepartmentdestroy')->middleware('auth');
	Route::get('/admin/fielddepartmentstatus/{id}', 'AdminController@fielddepartmentstatus')->middleware('auth');

	/*documenttypes*/
	Route::get('/admin/documenttypelist', 'AdminController@documenttypelist')->name('admin.documenttypelist')->middleware('auth');
	Route::get('admin/documenttypecreate', 'AdminController@documenttypecreate')->name('admin.documenttypecreate')->middleware('auth');
	Route::post('/admin/documenttypestore', 'AdminController@documenttypestore')->name('admin.documenttypestore')->middleware('auth');
	Route::get('/admin/documenttypeedit/{id}', 'AdminController@documenttypeedit')->middleware('auth');
	Route::post('/admin/documenttypeupdate', 'AdminController@documenttypeupdate')->name('admin.documenttypeupdate')->middleware('auth');
	Route::get('/admin/documenttypedestroy/{id}', 'AdminController@documenttypedestroy')->middleware('auth');
	Route::get('/admin/documenttypestatus/{id}', 'AdminController@documenttypestatus')->middleware('auth');

	/*User Module permission*/

	Route::get('/admin/usermodulepermissionlist', 'AdminController@usermodulepermissionlist')->name('admin.usermodulepermissionlist')->middleware('auth');
	Route::get('admin/usermodulepermissioncreate', 'AdminController@usermodulepermissioncreate')->name('admin.usermodulepermissioncreate')->middleware('auth');
	Route::post('/admin/usermodulepermissionstore', 'AdminController@usermodulepermissionstore')->name('admin.usermodulepermissionstore')->middleware('auth');
	Route::get('/admin/usermodulepermissionedit/{id}', 'AdminController@usermodulepermissionedit')->name('admin.usermodulepermissionedit')->middleware('auth');
	Route::post('/admin/usermodulepermissionupdate', 'AdminController@usermodulepermissionupdate')->name('admin.usermodulepermissionupdate')->middleware('auth');
	Route::get('/admin/usermodulepermissiondestroy/{id}', 'AdminController@usermodulepermissiondestroy')->middleware('auth');
	Route::get('/admin/usermodulepermissionstatus/{id}', 'AdminController@usermodulepermissionstatus')->middleware('auth');
	...
	/*Key word*/
	Route::get('/admin/keywordlist', 'AdminController@keywordlist')->name('admin.keywordlist')->middleware('auth');
	Route::post('/admin/keywordstore', 'AdminController@keywordstore')->name('admin.keywordstore')->middleware('auth');
	Route::get('/admin/keywordedit/{id}', 'AdminController@keywordedit')->middleware('auth');
	Route::post('/admin/keywordupdate', 'AdminController@keywordupdate')->name('admin.keywordupdate')->middleware('auth');
	Route::get('/admin/keyworddestroy/{id}', 'AdminController@keyworddestroy')->middleware('auth');
	Route::get('/admin/keywordstatus/{id}', 'AdminController@keywordstatus')->middleware('auth');
...
Route::group(['middleware' => ['auth', 'App\Http\Middleware\DocumentMiddleware']], function () {

	Route::get('/contributor', 'DocumentController@contributorhome')->name('contributorhome')->middleware('auth');

	/*Govt Order */

	Route::post('/contributor/getfielddepartment', 'DocumentController@getfielddepartment')->name('contributor.getfielddepartment')->middleware('auth');

	Route::get('/contributor/govtorderlist', 'DocumentController@govtorderlist')->name('contributor.govtorderlist')->middleware('auth');
	Route::get('contributor/govtordercreate', 'DocumentController@govtordercreate')->name('contributor.govtordercreate')->middleware('auth');
	Route::post('/contributor/govtorderstore', 'DocumentController@govtorderstore')->name('contributor.govtorderstore')->middleware('auth');
	Route::get('/contributor/govtorderedit/{id}', 'DocumentController@govtorderedit')->middleware('auth');
	Route::post('/contributor/govtorderupdate', 'DocumentController@govtorderupdate')->name('contributor.govtorderupdate')->middleware('auth');
	Route::get('/contributor/govtorderdestroy/{id}', 'DocumentController@govtorderdestroy')->middleware('auth');
	Route::get('/contributor/govtorderstatus/{id}', 'DocumentController@govtorderstatus')->middleware('auth');

	/*Cabinet Decision*/

	Route::get('/contributor/cabinetdecisionlist', 'DocumentController@cabinetdecisionlist')->name('contributor.cabinetdecisionlist')->middleware('auth');
	Route::get('contributor/cabinetdecisioncreate', 'DocumentController@cabinetdecisioncreate')->name('contributor.cabinetdecisioncreate')->middleware('auth');
	Route::post('/contributor/cabinetdecisionstore', 'DocumentController@cabinetdecisionstore')->name('contributor.cabinetdecisionstore')->middleware('auth');
	Route::get('/contributor/cabinetdecisionedit/{id}', 'DocumentController@cabinetdecisionedit')->middleware('auth');
	Route::post('/contributor/cabinetdecisionupdate', 'DocumentController@cabinetdecisionupdate')->name('contributor.cabinetdecisionupdate')->middleware('auth');
	Route::get('/contributor/cabinetdecisiondestroy/{id}', 'DocumentController@cabinetdecisiondestroy')->middleware('auth');
	Route::get('/contributor/cabinetdecisionstatus/{id}', 'DocumentController@cabinetdecisionstatus')->middleware('auth');

	/*Circulars*/

	Route::get('/contributor/circularlist', 'DocumentController@circularlist')->name('contributor.circularlist')->middleware('auth');
	Route::get('contributor/circularcreate', 'DocumentController@circularcreate')->name('contributor.circularcreate')->middleware('auth');
	Route::post('/contributor/circularstore', 'DocumentController@circularstore')->name('contributor.circularstore')->middleware('auth');
	Route::get('/contributor/circularedit/{id}', 'DocumentController@circularedit')->middleware('auth');
	Route::post('/contributor/circularupdate', 'DocumentController@circularupdate')->name('contributor.circularupdate')->middleware('auth');
	Route::get('/contributor/circulardestroy/{id}', 'DocumentController@circulardestroy')->middleware('auth');
	Route::get('/contributor/circularstatus/{id}', 'DocumentController@circularstatus')->middleware('auth');

	/*Right to Information*/
	/*rtidocument changed to policy*/

	Route::get('/contributor/rtidocuments', 'DocumentController@rtidocuments')->name('contributor.rtidocuments')->middleware('auth');
	Route::get('contributor/rticreate', 'DocumentController@rticreate')->name('contributor.rticreate')->middleware('auth');
	Route::post('/contributor/rtistore', 'DocumentController@rtistore')->name('contributor.rtistore')->middleware('auth');
	Route::get('/contributor/rtiedit/{id}', 'DocumentController@rtiedit')->middleware('auth');
	Route::post('/contributor/rtiupdate', 'DocumentController@rtiupdate')->name('contributor.rtiupdate')->middleware('auth');
	Route::get('/contributor/rtidestroy/{id}', 'DocumentController@rtidestroy')->middleware('auth');
	Route::get('/contributor/rtistatus/{id}', 'DocumentController@rtistatus')->middleware('auth');


	/*Acts and Rules */
	Route::get('/contributor/actandruleslist', 'DocumentController@actandruleslist')->name('contributor.actandruleslist')->middleware('auth');
	Route::get('contributor/actandrulescreate', 'DocumentController@actandrulescreate')->name('contributor.actandrulescreate')->middleware('auth');
	Route::post('/contributor/actandrulesstore', 'DocumentController@actandrulesstore')->name('contributor.actandrulesstore')->middleware('auth');
	Route::get('/contributor/actandrulesedit/{id}', 'DocumentController@actandrulesedit')->middleware('auth');
	Route::post('/contributor/actandrulesupdate', 'DocumentController@actandrulesupdate')->name('contributor.actandrulesupdate')->middleware('auth');
	Route::get('/contributor/actandrulesdestroy/{id}', 'DocumentController@actandrulesdestroy')->middleware('auth');
	Route::get('/contributor/actandrulesstatus/{id}', 'DocumentController@actandrulesstatus')->middleware('auth');

	/*Ordinance*/

	Route::get('/contributor/ordinancelist', 'DocumentController@ordinancelist')->name('contributor.ordinancelist')->middleware('auth');
	Route::get('contributor/ordinancecreate', 'DocumentController@ordinancecreate')->name('contributor.ordinancecreate')->middleware('auth');
	Route::post('/contributor/ordinancestore', 'DocumentController@ordinancestore')->name('contributor.ordinancestore')->middleware('auth');
	Route::get('/contributor/ordinanceedit/{id}', 'DocumentController@ordinanceedit')->middleware('auth');
	Route::post('/contributor/ordinanceupdate', 'DocumentController@ordinanceupdate')->name('contributor.ordinanceupdate')->middleware('auth');
	Route::get('/contributor/ordinancedestroy/{id}', 'DocumentController@ordinancedestroy')->middleware('auth');
	Route::get('/contributor/ordinancestatus/{id}', 'DocumentController@ordinancestatus')->middleware('auth');

	/*Notification*/

	Route::get('/contributor/notificationlist', 'DocumentController@notificationlist')->name('contributor.notificationlist')->middleware('auth');
	Route::get('contributor/notificationcreate', 'DocumentController@notificationcreate')->name('contributor.notificationcreate')->middleware('auth');
	Route::post('/contributor/notificationstore', 'DocumentController@notificationstore')->name('contributor.notificationstore')->middleware('auth');
	Route::get('/contributor/notificationedit/{id}', 'DocumentController@notificationedit')->middleware('auth');
	Route::post('/contributor/notificationupdate', 'DocumentController@notificationupdate')->name('contributor.notificationupdate')->middleware('auth');
	Route::get('/contributor/notificationdestroy/{id}', 'DocumentController@notificationdestroy')->middleware('auth');
	Route::get('/contributor/notificationstatus/{id}', 'DocumentController@notificationstatus')->middleware('auth');

	/*Document - Guidelines*/

	Route::get('/contributor/docguidelineslist', 'DocumentController@docguidelineslist')->name('contributor.docguidelineslist')->middleware('auth');
	Route::get('contributor/docguidelinescreate', 'DocumentController@docguidelinescreate')->name('contributor.docguidelinescreate')->middleware('auth');
	Route::post('/contributor/docguidelinesstore', 'DocumentController@docguidelinesstore')->name('contributor.docguidelinesstore')->middleware('auth');
	Route::get('/contributor/docguidelinesedit/{id}', 'DocumentController@docguidelinesedit')->middleware('auth');
	Route::post('/contributor/docguidelinesupdate', 'DocumentController@docguidelinesupdate')->name('contributor.docguidelinesupdate')->middleware('auth');
	Route::get('/contributor/docguidelinesdestroy/{id}', 'DocumentController@docguidelinesdestroy')->middleware('auth');
	Route::get('/contributor/docguidelinesstatus/{id}', 'DocumentController@docguidelinesstatus')->middleware('auth');

	/*Citizen Charters*/

	Route::get('/contributor/citizencharterlist', 'DocumentController@citizencharterlist')->name('contributor.citizencharterlist')->middleware('auth');
	Route::get('contributor/citizenchartercreate', 'DocumentController@citizenchartercreate')->name('contributor.citizenchartercreate')->middleware('auth');
	Route::post('/contributor/citizencharterstore', 'DocumentController@citizencharterstore')->name('contributor.citizencharterstore')->middleware('auth');
	Route::get('/contributor/citizencharteredit/{id}', 'DocumentController@citizencharteredit')->middleware('auth');
	Route::post('/contributor/citizencharterupdate', 'DocumentController@citizencharterupdate')->name('contributor.citizencharterupdate')->middleware('auth');
	Route::get('/contributor/citizencharterdestroy/{id}', 'DocumentController@citizencharterdestroy')->middleware('auth');
	Route::get('/contributor/citizencharterstatus/{id}', 'DocumentController@citizencharterstatus')->middleware('auth');
	/*Disciplinary Action*/

	Route::get('/contributor/disciplinarylist', 'DocumentController@disciplinarylist')->name('contributor.disciplinarylist')->middleware('auth');
	Route::get('contributor/disciplinarycreate', 'DocumentController@disciplinarycreate')->name('contributor.disciplinarycreate')->middleware('auth');
	Route::post('/contributor/disciplinarystore', 'DocumentController@disciplinarystore')->name('contributor.disciplinarystore')->middleware('auth');
	Route::get('/contributor/disciplinaryedit/{id}', 'DocumentController@disciplinaryedit')->middleware('auth');
	Route::post('/contributor/disciplinaryupdate', 'DocumentController@disciplinaryupdate')->name('contributor.disciplinaryupdate')->middleware('auth');
	Route::get('/contributor/disciplinarydestroy/{id}', 'DocumentController@disciplinarydestroy')->middleware('auth');
	Route::get('/contributor/disciplinarystatus/{id}', 'DocumentController@disciplinarystatus')->middleware('auth');


	/*Document FAQ*/

	Route::get('/contributor/documentfaqlist', 'DocumentController@documentfaqlist')->name('contributor.documentfaqlist')->middleware('auth');
	Route::get('contributor/documentfaqcreate', 'DocumentController@documentfaqcreate')->name('contributor.documentfaqcreate')->middleware('auth');
	Route::post('/contributor/documentfaqstore', 'DocumentController@documentfaqstore')->name('contributor.documentfaqstore')->middleware('auth');
	Route::get('/contributor/documentfaqedit/{id}', 'DocumentController@documentfaqedit')->middleware('auth');
	Route::post('/contributor/documentfaqupdate', 'DocumentController@documentfaqupdate')->name('contributor.documentfaqupdate')->middleware('auth');
	Route::get('/contributor/documentfaqdestroy/{id}', 'DocumentController@documentfaqdestroy')->middleware('auth');
	Route::get('/contributor/documentfaqstatus/{id}', 'DocumentController@documentfaqstatus')->middleware('auth');


	/*Work Study Report*/

	Route::get('/contributor/workstudyreportlist', 'DocumentController@workstudyreportlist')->name('contributor.workstudyreportlist')->middleware('auth');
	Route::get('contributor/workstudyreportcreate', 'DocumentController@workstudyreportcreate')->name('contributor.workstudyreportcreate')->middleware('auth');
	Route::post('/contributor/workstudyreportstore', 'DocumentController@workstudyreportstore')->name('contributor.workstudyreportstore')->middleware('auth');
	Route::get('/contributor/workstudyreportedit/{id}', 'DocumentController@workstudyreportedit')->middleware('auth');
	Route::post('/contributor/workstudyreportupdate', 'DocumentController@workstudyreportupdate')->name('contributor.workstudyreportupdate')->middleware('auth');
	Route::get('/contributor/workstudyreportdestroy/{id}', 'DocumentController@workstudyreportdestroy')->middleware('auth');
	Route::get('/contributor/workstudyreportstatus/{id}', 'DocumentController@workstudyreportstatus')->middleware('auth');


	/*General Report*/

	Route::get('/contributor/generalreportlist', 'DocumentController@generalreportlist')->name('contributor.generalreportlist')->middleware('auth');
	Route::get('contributor/generalreportcreate', 'DocumentController@generalreportcreate')->name('contributor.generalreportcreate')->middleware('auth');
	Route::post('/contributor/generalreportstore', 'DocumentController@generalreportstore')->name('contributor.generalreportstore')->middleware('auth');
	Route::get('/contributor/generalreportedit/{id}', 'DocumentController@generalreportedit')->middleware('auth');
	Route::post('/contributor/generalreportupdate', 'DocumentController@generalreportupdate')->name('contributor.generalreportupdate')->middleware('auth');
	Route::get('/contributor/generalreportdestroy/{id}', 'DocumentController@generalreportdestroy')->middleware('auth');
	Route::get('/contributor/generalreportstatus/{id}', 'DocumentController@generalreportstatus')->middleware('auth');

	/*Publications*/

	Route::get('/contributor/publicationlist', 'DocumentController@publicationlist')->name('contributor.publicationlist')->middleware('auth');
	Route::get('contributor/publicationcreate', 'DocumentController@publicationcreate')->name('contributor.publicationcreate')->middleware('auth');
	Route::post('/contributor/publicationstore', 'DocumentController@publicationstore')->name('contributor.publicationstore')->middleware('auth');
	Route::get('/contributor/publicationedit/{id}', 'DocumentController@publicationedit')->middleware('auth');
	Route::post('/contributor/publicationupdate', 'DocumentController@publicationupdate')->name('contributor.publicationupdate')->middleware('auth');
	Route::get('/contributor/publicationdestroy/{id}', 'DocumentController@publicationdestroy')->middleware('auth');
	Route::get('/contributor/publicationstatus/{id}', 'DocumentController@publicationstatus')->middleware('auth');

	/*State Budget*/

	Route::get('/contributor/statebudgetlist', 'DocumentController@statebudgetlist')->name('contributor.statebudgetlist')->middleware('auth');
	Route::get('contributor/statebudgetcreate', 'DocumentController@statebudgetcreate')->name('contributor.statebudgetcreate')->middleware('auth');
	Route::post('/contributor/statebudgetstore', 'DocumentController@statebudgetstore')->name('contributor.statebudgetstore')->middleware('auth');
	Route::get('/contributor/statebudgetedit/{id}', 'DocumentController@statebudgetedit')->middleware('auth');
	Route::post('/contributor/statebudgetupdate', 'DocumentController@statebudgetupdate')->name('contributor.statebudgetupdate')->middleware('auth');
	Route::get('/contributor/statebudgetdestroy/{id}', 'DocumentController@statebudgetdestroy')->middleware('auth');
	Route::get('/contributor/statebudgetstatus/{id}', 'DocumentController@statebudgetstatus')->middleware('auth');

	/*Economic Review*/

	Route::get('/contributor/economicreviewlist', 'DocumentController@economicreviewlist')->name('contributor.economicreviewlist')->middleware('auth');
	Route::get('contributor/economicreviewcreate', 'DocumentController@economicreviewcreate')->name('contributor.economicreviewcreate')->middleware('auth');
	Route::post('/contributor/economicreviewstore', 'DocumentController@economicreviewstore')->name('contributor.economicreviewstore')->middleware('auth');
	Route::get('/contributor/economicreviewedit/{id}', 'DocumentController@economicreviewedit')->middleware('auth');
	Route::post('/contributor/economicreviewupdate', 'DocumentController@economicreviewupdate')->name('contributor.economicreviewupdate')->middleware('auth');
	Route::get('/contributor/economicreviewdestroy/{id}', 'DocumentController@economicreviewdestroy')->middleware('auth');
	Route::get('/contributor/economicreviewstatus/{id}', 'DocumentController@economicreviewstatus')->middleware('auth');

	/*Five Year Plan*/

	Route::get('/contributor/fiveyearplanlist', 'DocumentController@fiveyearplanlist')->name('contributor.fiveyearplanlist')->middleware('auth');
	Route::get('contributor/fiveyearplancreate', 'DocumentController@fiveyearplancreate')->name('contributor.fiveyearplancreate')->middleware('auth');
	Route::post('/contributor/fiveyearplanstore', 'DocumentController@fiveyearplanstore')->name('contributor.fiveyearplanstore')->middleware('auth');
	Route::get('/contributor/fiveyearplanedit/{id}', 'DocumentController@fiveyearplanedit')->middleware('auth');
	Route::post('/contributor/fiveyearplanupdate', 'DocumentController@fiveyearplanupdate')->name('contributor.fiveyearplanupdate')->middleware('auth');
	Route::get('/contributor/fiveyearplandestroy/{id}', 'DocumentController@fiveyearplandestroy')->middleware('auth');
	Route::get('/contributor/fiveyearplanstatus/{id}', 'DocumentController@fiveyearplanstatus')->middleware('auth');
	/*RTS Document*/

	Route::get('/contributor/rtsdocumentlist', 'DocumentController@rtsdocumentlist')->name('contributor.rtsdocumentlist')->middleware('auth');
	Route::get('contributor/rtsdocumentcreate', 'DocumentController@rtsdocumentcreate')->name('contributor.rtsdocumentcreate')->middleware('auth');
	Route::post('/contributor/rtsdocumentstore', 'DocumentController@rtsdocumentstore')->name('contributor.rtsdocumentstore')->middleware('auth');
	Route::get('/contributor/rtsdocumentedit/{id}', 'DocumentController@rtsdocumentedit')->middleware('auth');
	Route::post('/contributor/rtsdocumentupdate', 'DocumentController@rtsdocumentupdate')->name('contributor.rtsdocumentupdate')->middleware('auth');
	Route::get('/contributor/rtsdocumentdestroy/{id}', 'DocumentController@rtsdocumentdestroy')->middleware('auth');
	Route::get('/contributor/rtsdocumentstatus/{id}', 'DocumentController@rtsdocumentstatus')->middleware('auth');
	...
	Route::get('/contributor/advertisementlist', 'DocumentController@advertisementlist')->name('contributor.advertisementlist')->middleware('auth');
	Route::get('contributor/advertisementcreate', 'DocumentController@advertisementcreate')->name('contributor.advertisementcreate')->middleware('auth');
	Route::post('/contributor/advertisementstore', 'DocumentController@advertisementstore')->name('contributor.advertisementstore')->middleware('auth');
	Route::get('/contributor/advertisementedit/{id}', 'DocumentController@advertisementedit')->middleware('auth');
	Route::post('/contributor/advertisementupdate', 'DocumentController@advertisementupdate')->name('contributor.advertisementupdate')->middleware('auth');
	Route::get('/contributor/advertisementdestroy/{id}', 'DocumentController@advertisementdestroy')->middleware('auth');
	Route::get('/contributor/advertisementstatus/{id}', 'DocumentController@advertisementstatus')->middleware('auth');

	/*Document - Announcement*/

	Route::get('/contributor/announcementlist', 'DocumentController@announcementlist')->name('contributor.announcementlist')->middleware('auth');
	Route::get('contributor/announcementcreate', 'DocumentController@announcementcreate')->name('contributor.announcementcreate')->middleware('auth');
	Route::post('/contributor/announcementstore', 'DocumentController@announcementstore')->name('contributor.announcementstore')->middleware('auth');
	Route::get('/contributor/announcementedit/{id}', 'DocumentController@announcementedit')->middleware('auth');
	Route::post('/contributor/announcementupdate', 'DocumentController@announcementupdate')->name('contributor.announcementupdate')->middleware('auth');
	Route::get('/contributor/announcementdestroy/{id}', 'DocumentController@announcementdestroy')->middleware('auth');
	Route::get('/contributor/announcementstatus/{id}', 'DocumentController@announcementstatus')->middleware('auth');

	/*Document - Press Release*/

	Route::get('/contributor/pressreleaselist', 'DocumentController@pressreleaselist')->name('contributor.pressreleaselist')->middleware('auth');
	Route::get('contributor/pressreleasecreate', 'DocumentController@pressreleasecreate')->name('contributor.pressreleasecreate')->middleware('auth');
	Route::post('/contributor/pressreleasestore', 'DocumentController@pressreleasestore')->name('contributor.pressreleasestore')->middleware('auth');
	Route::get('/contributor/pressreleaseedit/{id}', 'DocumentController@pressreleaseedit')->middleware('auth');
	Route::post('/contributor/pressreleaseupdate', 'DocumentController@pressreleaseupdate')->name('contributor.pressreleaseupdate')->middleware('auth');
	Route::get('/contributor/pressreleasedestroy/{id}', 'DocumentController@pressreleasedestroy')->middleware('auth');
	Route::get('/contributor/pressreleasestatus/{id}', 'DocumentController@pressreleasestatus')->middleware('auth');
	...
	Route::get('/contributor/tenders', 'DocumentController@tenders')->name('contributor.tenders')->middleware('auth');
	Route::get('contributor/tendercreate', 'DocumentController@tendercreate')->name('contributor.tendercreate')->middleware('auth');
	Route::post('/contributor/tenderstore', 'DocumentController@tenderstore')->name('contributor.tenderstore')->middleware('auth');
	Route::get('/contributor/tenderedit/{id}', 'DocumentController@tenderedit')->middleware('auth');
	Route::post('/contributor/tenderupdate', 'DocumentController@tenderupdate')->name('contributor.tenderupdate')->middleware('auth');
	Route::get('/contributor/tenderdestroy/{id}', 'DocumentController@tenderdestroy')->middleware('auth');
	Route::get('/contributor/tenderstatus/{id}', 'DocumentController@tenderstatus')->middleware('auth');


	/*Document - Quotation*/

	Route::get('/contributor/quotation', 'DocumentController@quotation')->name('contributor.quotation')->middleware('auth');
	Route::get('contributor/quotationcreate', 'DocumentController@quotationcreate')->name('contributor.quotationcreate')->middleware('auth');
	Route::post('/contributor/quotationstore', 'DocumentController@quotationstore')->name('contributor.quotationstore')->middleware('auth');
	Route::get('/contributor/quotationedit/{id}', 'DocumentController@quotationedit')->middleware('auth');
	Route::post('/contributor/quotationupdate', 'DocumentController@quotationupdate')->name('contributor.quotationupdate')->middleware('auth');
	Route::get('/contributor/quotationdestroy/{id}', 'DocumentController@quotationdestroy')->middleware('auth');
	Route::get('/contributor/quotationstatus/{id}', 'DocumentController@quotationstatus')->middleware('auth');
...
/*Story Contributor*/
Route::group(['middleware' => ['auth', 'App\Http\Middleware\StoryContributor']], function () {
	Route::get('/storycontributor', 'StoryContributorController@contributorhome')->name('storycontributorhome')->middleware('auth');

	/*Story*/

	Route::get('/storycontributor/contributorstorylist', 'StoryContributorController@contributorstorylist')->name('storycontributor.contributorstorylist')->middleware('auth');
	Route::get('storycontributor/storycreate', 'StoryContributorController@storycreate')->name('storycontributor.storycreate')->middleware('auth');
	Route::post('/storycontributor/storystore', 'StoryContributorController@storystore')->name('storycontributor.storystore')->middleware('auth');
	Route::get('/storycontributor/storyedit/{id}', 'StoryContributorController@storyedit')->middleware('auth');
	Route::post('/storycontributor/storyupdate', 'StoryContributorController@storyupdate')->name('storycontributor.storyupdate')->middleware('auth');
	Route::get('/storycontributor/storydestroy/{id}', 'StoryContributorController@storydestroy')->middleware('auth');
	Route::get('/storycontributor/storystatus/{id}', 'StoryContributorController@storystatus')->middleware('auth');
	Route::get('/image.imageremove/{id}', 'StoryContributorController@imageremove')->name('imageremove')->middleware('auth');
});


/* Document Moderator*/
Route::group(['middleware' => ['auth', 'App\Http\Middleware\DocumentModerator']], function () {
	Route::get('/documentmoderator', 'DocModeratorController@documentmoderatorhome')->name('documentmoderatorhome')->middleware('auth');
	Route::get('/documentmoderator/contributeditems/{val}', 'DocModeratorController@contributeditems')->name('documentmoderator.contributeditems')->middleware('auth');

	Route::get('/documentmoderator/contributedcabinetdecisionlist/{val}', 'DocModeratorController@contributedcabinetdecisionlist')->name('documentmoderator.contributedcabinetdecisionlist')->middleware('auth');
	Route::get('/documentmoderator/contributedcabinetdecisionverify/{id}', 'DocModeratorController@contributedcabinetdecisionverify')->middleware('auth');
	Route::post('/documentmoderator/contributedcabinetdecisionupdate', 'DocModeratorController@contributedcabinetdecisionupdate')->name('documentmoderator.contributedcabinetdecisionupdate')->middleware('auth');

	Route::get('/documentmoderator/circularlist/{val}', 'DocModeratorController@circularlist')->name('documentmoderator.circularlist')->middleware('auth');
	Route::get('/documentmoderator/circularverify/{id}', 'DocModeratorController@circularverify')->middleware('auth');
	Route::post('/documentmoderator/circularupdate', 'DocModeratorController@circularupdate')->name('documentmoderator.circularupdate')->middleware('auth');

	/*rtidocument changed to policy*/
	Route::get('/documentmoderator/policylist/{val}', 'DocModeratorController@policylist')->name('documentmoderator.policylist')->middleware('auth');
	Route::get('/documentmoderator/policyverify/{id}', 'DocModeratorController@policyverify')->middleware('auth');
	Route::post('/documentmoderator/policyupdate', 'DocModeratorController@policyupdate')->name('documentmoderator.policyupdate')->middleware('auth');


	Route::get('/documentmoderator/actandruleslist/{val}', 'DocModeratorController@actandruleslist')->name('documentmoderator.actandruleslist')->middleware('auth');
	Route::get('/documentmoderator/actandrulesverify/{id}', 'DocModeratorController@actandrulesverify')->middleware('auth');
	Route::post('/documentmoderator/actandrulesupdate', 'DocModeratorController@actandrulesupdate')->name('documentmoderator.actandrulesupdate')->middleware('auth');

	Route::get('/documentmoderator/ordinancelist/{val}', 'DocModeratorController@ordinancelist')->name('documentmoderator.ordinancelist')->middleware('auth');
	Route::get('/documentmoderator/ordinanceverify/{id}', 'DocModeratorController@ordinanceverify')->middleware('auth');
	Route::post('/documentmoderator/ordinanceupdate', 'DocModeratorController@ordinanceupdate')->name('documentmoderator.ordinanceupdate')->middleware('auth');

	Route::get('/documentmoderator/notificationlist/{val}', 'DocModeratorController@notificationlist')->name('documentmoderator.notificationlist')->middleware('auth');
	Route::get('/documentmoderator/notificationverify/{id}', 'DocModeratorController@notificationverify')->middleware('auth');
	Route::post('/documentmoderator/notificationupdate', 'DocModeratorController@notificationupdate')->name('documentmoderator.notificationupdate')->middleware('auth');

	Route::get('/documentmoderator/docguidelineslist/{val}', 'DocModeratorController@docguidelineslist')->name('documentmoderator.docguidelineslist')->middleware('auth');
	Route::get('/documentmoderator/docguidelinesverify/{id}', 'DocModeratorController@docguidelinesverify')->middleware('auth');
	Route::post('/documentmoderator/docguidelinesupdate', 'DocModeratorController@docguidelinesupdate')->name('documentmoderator.docguidelinesupdate')->middleware('auth');


	Route::get('/documentmoderator/citizencharterlist/{val}', 'DocModeratorController@citizencharterlist')->name('documentmoderator.citizencharterlist')->middleware('auth');
	Route::get('/documentmoderator/citizencharterverify/{id}', 'DocModeratorController@citizencharterverify')->middleware('auth');
	Route::post('/documentmoderator/citizencharterupdate', 'DocModeratorController@citizencharterupdate')->name('documentmoderator.citizencharterupdate')->middleware('auth');

	Route::get('/documentmoderator/disciplinarylist/{val}', 'DocModeratorController@disciplinarylist')->name('documentmoderator.disciplinarylist')->middleware('auth');
	Route::get('/documentmoderator/disciplinaryverify/{id}', 'DocModeratorController@disciplinaryverify')->middleware('auth');
	Route::post('/documentmoderator/disciplinaryupdate', 'DocModeratorController@disciplinaryupdate')->name('documentmoderator.disciplinaryupdate')->middleware('auth');


	Route::get('/documentmoderator/documentfaqlist/{val}', 'DocModeratorController@documentfaqlist')->name('documentmoderator.documentfaqlist')->middleware('auth');
	Route::get('/documentmoderator/documentfaqverify/{id}', 'DocModeratorController@documentfaqverify')->middleware('auth');
	Route::post('/documentmoderator/documentfaqupdate', 'DocModeratorController@documentfaqupdate')->name('documentmoderator.documentfaqupdate')->middleware('auth');


	Route::get('/documentmoderator/workstudyreportlist/{val}', 'DocModeratorController@workstudyreportlist')->name('documentmoderator.workstudyreportlist')->middleware('auth');
	Route::get('/documentmoderator/workstudyreportverify/{id}', 'DocModeratorController@workstudyreportverify')->middleware('auth');
	Route::post('/documentmoderator/workstudyreportupdate', 'DocModeratorController@workstudyreportupdate')->name('documentmoderator.workstudyreportupdate')->middleware('auth');


	Route::get('/documentmoderator/generalreportlist/{val}', 'DocModeratorController@generalreportlist')->name('documentmoderator.generalreportlist')->middleware('auth');
	Route::get('/documentmoderator/generalreportverify/{id}', 'DocModeratorController@generalreportverify')->middleware('auth');
	Route::post('/documentmoderator/generalreportupdate', 'DocModeratorController@generalreportupdate')->name('documentmoderator.generalreportupdate')->middleware('auth');


	Route::get('/documentmoderator/publicationlist/{val}', 'DocModeratorController@publicationlist')->name('documentmoderator.publicationlist')->middleware('auth');
	Route::get('/documentmoderator/publicationverify/{id}', 'DocModeratorController@publicationverify')->middleware('auth');
	Route::post('/documentmoderator/publicationupdate', 'DocModeratorController@publicationupdate')->name('documentmoderator.publicationupdate')->middleware('auth');


	Route::get('/documentmoderator/statebudgetlist/{val}', 'DocModeratorController@statebudgetlist')->name('documentmoderator.statebudgetlist')->middleware('auth');
	Route::get('/documentmoderator/statebudgetverify/{id}', 'DocModeratorController@statebudgetverify')->middleware('auth');
	Route::post('/documentmoderator/statebudgetupdate', 'DocModeratorController@statebudgetupdate')->name('documentmoderator.statebudgetupdate')->middleware('auth');


	Route::get('/documentmoderator/economicreviewlist/{val}', 'DocModeratorController@economicreviewlist')->name('documentmoderator.economicreviewlist')->middleware('auth');
	Route::get('/documentmoderator/economicreviewverify/{id}', 'DocModeratorController@economicreviewverify')->middleware('auth');
	Route::post('/documentmoderator/economicreviewupdate', 'DocModeratorController@economicreviewupdate')->name('documentmoderator.economicreviewupdate')->middleware('auth');


	Route::get('/documentmoderator/fiveyearplanlist/{val}', 'DocModeratorController@fiveyearplanlist')->name('documentmoderator.fiveyearplanlist')->middleware('auth');
	Route::get('/documentmoderator/fiveyearplanverify/{id}', 'DocModeratorController@fiveyearplanverify')->middleware('auth');
	Route::post('/documentmoderator/fiveyearplanupdate', 'DocModeratorController@fiveyearplanupdate')->name('documentmoderator.fiveyearplanupdate')->middleware('auth');


	Route::get('/documentmoderator/rtsdocumentlist/{val}', 'DocModeratorController@rtsdocumentlist')->name('documentmoderator.rtsdocumentlist')->middleware('auth');
	Route::get('/documentmoderator/rtsdocumentverify/{id}', 'DocModeratorController@rtsdocumentverify')->middleware('auth');
	Route::post('/documentmoderator/rtsdocumentupdate', 'DocModeratorController@rtsdocumentupdate')->name('documentmoderator.rtsdocumentupdate')->middleware('auth');
});

/* Document Approver*/
Route::group(['middleware' => ['auth', 'App\Http\Middleware\DocumentApprover']], function () {
	Route::get('/documentapprover', 'DocApproverController@documentapproverhome')->name('documentapproverhome')->middleware('auth');
	Route::get('/documentapprover/contributeditems/{val}', 'DocModeratorController@contributeditems')->name('documentapprover.contributeditems')->middleware('auth');

	Route::get('/documentapprover/contributedcabinetdecisionlist/{val}', 'DocModeratorController@contributedcabinetdecisionlist')->name('documentapprover.contributedcabinetdecisionlist')->middleware('auth');
	Route::get('/documentapprover/contributedcabinetdecisionverify/{id}', 'DocModeratorController@contributedcabinetdecisionverify')->middleware('auth');
	Route::post('/documentapprover/contributedcabinetdecisionupdate', 'DocModeratorController@contributedcabinetdecisionupdate')->name('documentapprover.contributedcabinetdecisionupdate')->middleware('auth');

	Route::get('/documentapprover/circularlist/{val}', 'DocModeratorController@circularlist')->name('documentapprover.circularlist')->middleware('auth');
	Route::get('/documentapprover/circularverify/{id}', 'DocModeratorController@circularverify')->middleware('auth');
	Route::post('/documentapprover/circularupdate', 'DocModeratorController@circularupdate')->name('documentapprover.circularupdate')->middleware('auth');


	/*rtidocument changed to policy*/

	Route::get('/documentapprover/policylist/{val}', 'DocModeratorController@policylist')->name('documentapprover.policylist')->middleware('auth');
	Route::get('/documentapprover/policyverify/{id}', 'DocModeratorController@policyverify')->middleware('auth');
	Route::post('/documentapprover/policyupdate', 'DocModeratorController@policyupdate')->name('documentapprover.policyupdate')->middleware('auth');


	Route::get('/documentapprover/actandruleslist/{val}', 'DocModeratorController@actandruleslist')->name('documentapprover.actandruleslist')->middleware('auth');
	Route::get('/documentapprover/actandrulesverify/{id}', 'DocModeratorController@actandrulesverify')->middleware('auth');
	Route::post('/documentapprover/actandrulesupdate', 'DocModeratorController@actandrulesupdate')->name('documentapprover.actandrulesupdate')->middleware('auth');

	Route::get('/documentapprover/ordinancelist/{val}', 'DocModeratorController@ordinancelist')->name('documentapprover.ordinancelist')->middleware('auth');
	Route::get('/documentapprover/ordinanceverify/{id}', 'DocModeratorController@ordinanceverify')->middleware('auth');
	Route::post('/documentapprover/ordinanceupdate', 'DocModeratorController@ordinanceupdate')->name('documentapprover.ordinanceupdate')->middleware('auth');

	Route::get('/documentapprover/notificationlist/{val}', 'DocModeratorController@notificationlist')->name('documentapprover.notificationlist')->middleware('auth');
	Route::get('/documentapprover/notificationverify/{id}', 'DocModeratorController@notificationverify')->middleware('auth');
	Route::post('/documentapprover/notificationupdate', 'DocModeratorController@notificationupdate')->name('documentapprover.notificationupdate')->middleware('auth');

	Route::get('/documentapprover/docguidelineslist/{val}', 'DocModeratorController@docguidelineslist')->name('documentapprover.docguidelineslist')->middleware('auth');
	Route::get('/documentapprover/docguidelinesverify/{id}', 'DocModeratorController@docguidelinesverify')->middleware('auth');
	Route::post('/documentapprover/docguidelinesupdate', 'DocModeratorController@docguidelinesupdate')->name('documentapprover.docguidelinesupdate')->middleware('auth');


	Route::get('/documentapprover/citizencharterlist/{val}', 'DocModeratorController@citizencharterlist')->name('documentapprover.citizencharterlist')->middleware('auth');
	Route::get('/documentapprover/citizencharterverify/{id}', 'DocModeratorController@citizencharterverify')->middleware('auth');
	Route::post('/documentapprover/citizencharterupdate', 'DocModeratorController@citizencharterupdate')->name('documentapprover.citizencharterupdate')->middleware('auth');

	Route::get('/documentapprover/disciplinarylist/{val}', 'DocModeratorController@disciplinarylist')->name('documentapprover.disciplinarylist')->middleware('auth');
	Route::get('/documentapprover/disciplinaryverify/{id}', 'DocModeratorController@disciplinaryverify')->middleware('auth');
	Route::post('/documentapprover/disciplinaryupdate', 'DocModeratorController@disciplinaryupdate')->name('documentapprover.disciplinaryupdate')->middleware('auth');


	Route::get('/documentapprover/documentfaqlist/{val}', 'DocModeratorController@documentfaqlist')->name('documentapprover.documentfaqlist')->middleware('auth');
	Route::get('/documentapprover/documentfaqverify/{id}', 'DocModeratorController@documentfaqverify')->middleware('auth');
	Route::post('/documentapprover/documentfaqupdate', 'DocModeratorController@documentfaqupdate')->name('documentapprover.documentfaqupdate')->middleware('auth');


	Route::get('/documentapprover/workstudyreportlist/{val}', 'DocModeratorController@workstudyreportlist')->name('documentapprover.workstudyreportlist')->middleware('auth');
	Route::get('/documentapprover/workstudyreportverify/{id}', 'DocModeratorController@workstudyreportverify')->middleware('auth');
	Route::post('/documentapprover/workstudyreportupdate', 'DocModeratorController@workstudyreportupdate')->name('documentapprover.workstudyreportupdate')->middleware('auth');


	Route::get('/documentapprover/generalreportlist/{val}', 'DocModeratorController@generalreportlist')->name('documentapprover.generalreportlist')->middleware('auth');
	Route::get('/documentapprover/generalreportverify/{id}', 'DocModeratorController@generalreportverify')->middleware('auth');
	Route::post('/documentapprover/generalreportupdate', 'DocModeratorController@generalreportupdate')->name('documentapprover.generalreportupdate')->middleware('auth');


	Route::get('/documentapprover/publicationlist/{val}', 'DocModeratorController@publicationlist')->name('documentapprover.publicationlist')->middleware('auth');
	Route::get('/documentapprover/publicationverify/{id}', 'DocModeratorController@publicationverify')->middleware('auth');
	Route::post('/documentapprover/publicationupdate', 'DocModeratorController@publicationupdate')->name('documentapprover.publicationupdate')->middleware('auth');


	Route::get('/documentapprover/statebudgetlist/{val}', 'DocModeratorController@statebudgetlist')->name('documentapprover.statebudgetlist')->middleware('auth');
	Route::get('/documentapprover/statebudgetverify/{id}', 'DocModeratorController@statebudgetverify')->middleware('auth');
	Route::post('/documentapprover/statebudgetupdate', 'DocModeratorController@statebudgetupdate')->name('documentapprover.statebudgetupdate')->middleware('auth');


	Route::get('/documentapprover/economicreviewlist/{val}', 'DocModeratorController@economicreviewlist')->name('documentapprover.economicreviewlist')->middleware('auth');
	Route::get('/documentapprover/economicreviewverify/{id}', 'DocModeratorController@economicreviewverify')->middleware('auth');
	Route::post('/documentapprover/economicreviewupdate', 'DocModeratorController@economicreviewupdate')->name('documentapprover.economicreviewupdate')->middleware('auth');


	Route::get('/documentapprover/fiveyearplanlist/{val}', 'DocModeratorController@fiveyearplanlist')->name('documentapprover.fiveyearplanlist')->middleware('auth');
	Route::get('/documentapprover/fiveyearplanverify/{id}', 'DocModeratorController@fiveyearplanverify')->middleware('auth');
	Route::post('/documentapprover/fiveyearplanupdate', 'DocModeratorController@fiveyearplanupdate')->name('documentapprover.fiveyearplanupdate')->middleware('auth');


	Route::get('/documentapprover/rtsdocumentlist/{val}', 'DocModeratorController@rtsdocumentlist')->name('documentapprover.rtsdocumentlist')->middleware('auth');
	Route::get('/documentapprover/rtsdocumentverify/{id}', 'DocModeratorController@rtsdocumentverify')->middleware('auth');
	Route::post('/documentapprover/rtsdocumentupdate', 'DocModeratorController@rtsdocumentupdate')->name('documentapprover.rtsdocumentupdate')->middleware('auth');
});

/*Story Moderator*/
Route::group(['middleware' => ['auth', 'App\Http\Middleware\StoryModerator']], function () {
	Route::get('/storymoderator', 'StoryModeratorController@storymoderatorhome')->name('storymoderatorhome')->middleware('auth');
	Route::get('/storymoderator/storyitems/{val}', 'StoryModeratorController@storyitems')->name('storymoderator.storyitems')->middleware('auth');

	Route::get('/storymoderator/moderatedstorylist/{val}', 'StoryModeratorController@moderatedstorylist')->name('storymoderator.moderatedstorylist')->middleware('auth');
	Route::get('/storymoderator/moderatedstoryverify/{id}', 'StoryModeratorController@moderatedstoryverify')->middleware('auth');
	Route::post('/storymoderator/moderatedstoryupdate', 'StoryModeratorController@moderatedstoryupdate')->name('storymoderator.moderatedstoryupdate')->middleware('auth');
});

/*Story Approver*/
Route::group(['middleware' => ['auth', 'App\Http\Middleware\StoryApprover']], function () {
	Route::get('/storyapprover', 'StoryApproverController@storyapproverhome')->name('storyapproverhome')->middleware('auth');
	Route::get('/storyapprover/storyitems/{val}', 'StoryApproverController@storyitems')->name('storyapprover.storyitems')->middleware('auth');

	Route::get('/storyapprover/approvedstorylist/{val}', 'StoryApproverController@approvedstorylist')->name('storyapprover.approvedstorylist')->middleware('auth');
	Route::get('/storyapprover/approvedstoryapprove/{id}', 'StoryApproverController@approvedstoryapprove')->middleware('auth');
	Route::post('/storyapprover/approvedstoryupdate', 'StoryApproverController@approvedstoryupdate')->name('storyapprover.approvedstoryupdate')->middleware('auth');
});

/*District User*/
Route::group(['middleware' => ['auth', 'App\Http\Middleware\DistrictUser']], function () {

	Route::get('/districtusr', 'DistrictUserController@districtusrhome')->name('districtusrhome')->middleware('auth');

	Route::get('/districtusr/districtpgmlist', 'DistrictUserController@districtpgmlist')->name('districtusr.districtpgmlist')->middleware('auth');
	Route::get('/districtusr/newdistrictpgmlist', 'DistrictUserController@newdistrictpgmlist')->name('districtusr.newdistrictpgmlist')->middleware('auth');
	Route::get('districtusr/districtpgmcreate', 'DistrictUserController@districtpgmcreate')->name('districtusr.districtpgmcreate')->middleware('auth');
	Route::post('/districtusr/districtpgmstore', 'DistrictUserController@districtpgmstore')->name('districtusr.districtpgmstore')->middleware('auth');
	Route::get('/districtusr/districtpgmedit/{id}', 'DistrictUserController@districtpgmedit')->middleware('auth');
	// Route::get('/siteadmin/viewdetailsarticle/{id}', 'WebadminController@viewdetailsarticle')->middleware('auth');
	// Route::get('/siteadmin/articleuplddet/{id}', 'WebadminController@articleuplddet')->middleware('auth');
	Route::post('/districtusr/districtpgmupdate', 'DistrictUserController@districtpgmupdate')->name('districtusr.districtpgmupdate')->middleware('auth');
	Route::get('/districtusr/districtpgmdestroy/{id}', 'DistrictUserController@districtpgmdestroy')->middleware('auth');
	Route::get('/districtusr/districtpgmstatus/{id}', 'DistrictUserController@districtpgmstatus')->middleware('auth');
	Route::get('/districtusr/districtpgmposterdel/{id}', 'DistrictUserController@districtpgmposterdel')->middleware('auth');
	Route::get('/districtusr/districtpgmfiledel/{id}', 'DistrictUserController@districtpgmfiledel')->middleware('auth');
...
Route::group(['middleware' => ['auth', 'App\Http\Middleware\SiteAdmin']], function () {
	...
	Route::get('/siteadmin/logotypecheck/{id}', 'SiteadminController@logotypecheck')->name('siteadmin.logotypecheck')->middleware('auth');
	...
	Route::get('/siteadmin/newarticlelist', 'WebadminController@newarticlelist')->name('siteadmin.newarticlelist')->middleware('auth');
	...
	Route::get('/siteadmin/bannerlist', 'WebadminController@bannerlist')->name('siteadmin.bannerlist')->middleware('auth');
	Route::post('/siteadmin/bannerstore', 'WebadminController@bannerstore')->name('siteadmin.bannerstore')->middleware('auth');
	Route::get('/siteadmin/banneredit/{id}', 'WebadminController@banneredit')->middleware('auth');
	Route::post('/siteadmin/bannerupdate', 'WebadminController@bannerupdate')->name('siteadmin.bannerupdate')->middleware('auth');
	Route::get('/siteadmin/bannerdestroy/{id}', 'WebadminController@bannerdestroy')->middleware('auth');
	Route::get('/siteadmin/bannerstatus/{id}', 'WebadminController@bannerstatus')->middleware('auth');

	/* What's News */
	Route::get('/siteadmin/whatisnewlist', 'SiteadminController@whatisnewlist')->name('siteadmin.whatisnewlist')->middleware('auth');
	Route::get('/siteadmin/addwhatisnewlist', 'SiteadminController@addwhatisnewlist')->name('siteadmin.addwhatisnewlist')->middleware('auth');
	// Route::get('/siteadmin/whatisnewedit/{id}', 'SiteadminController@whatisnewedit')->name('siteadmin.whatisnewedit')->middleware('auth');
