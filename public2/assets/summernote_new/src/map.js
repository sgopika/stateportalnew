(function(factory) {
  ...
  var mapPlugin = function(context) {
    ...
    const EMBED_URL = 'https://www.google.com/maps/embed/v1/place?key=API_KEY&q=PLACE'.replace(
      'API_KEY',
      options.map.apiKey
    );
