...
class SiteadminController extends Controller
{
    ...
    public function articleposterdel(Request $request,$id){
        if ($request->ajax()) {
    ...
    public function activitytypestore(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'name' => app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg(),
            'malname' => app('App\Http\Controllers\RegexvaluesglobController')->getMaltitlereg()
        ]);
    ...
    public function activitytypeupdate(Request $request)
    {
        ...
        if ($request->ajax()) {
            $chkrows = Activitytype::where('id', '!=', $request->hidden_id)->where('entitle', $request->name)->exists() ? 1 : 0;
    ...
    public function headerbuttonstore(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'iconclass'     => app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg(),
            'colorclass'     => 'required|min:3|max:50',
            'menutypeid'    => 'required',
            'filename'      => 'sometimes|nullable|mimes:jpg,jpeg,png,pdf|max:1100',
            'urlpath'       => 'sometimes|nullable',
    ...
    {
        if ($request->ajax()) {
            DB::table('footerlinks')->where('id', $id)->delete();
        }
    ...
    public function logostore(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'logourl' => 'required',
            'logotype' => 'required',
            'logofile'      => 'sometimes|nullable|mimes:jpg,jpeg,png,pdf|max:1100',
        ]);
        if ($validator->fails()) {
            return response()->json(['errors' => $validator->errors()->first()]);
        }
    ...
    public function logoupdate(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $chkrows = Logo::where('entooltip', $request->entooltip)->where('id', '!=', $request->hidden_id)->exists() ? 1 : 0;
            if ($chkrows == 0) {
    ...
    public function footerstore(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'filename'  => 'required|mimes:jpg,jpeg,png,pdf|max:1000000',
            'alttext'   => app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg(),
            'name'      => app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg(),
            'malname'   => app('App\Http\Controllers\RegexvaluesglobController')->getMaltitlereg(),
            'subname'   => app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg(),
            'malsubname'=> app('App\Http\Controllers\RegexvaluesglobController')->getMaltitlereg(),
            'iconclass' => app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg()
    ...
    public function footerupdate(Request $request)
    {
        ...
        // ]);
         $validator = Validator::make($request->all(), [
            'filename'  => 'mimes:jpg,jpeg,png,pdf|max:1000000',
            'alttext'   => app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg(),
            'name'      => app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg(),
            'malname'   => app('App\Http\Controllers\RegexvaluesglobController')->getMaltitlereg(),
            'subname'   => app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg(),
    ...
    public function footermenustore(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
           'filename'  => 'required|mimes:jpg,jpeg,png,pdf|max:1100',
            ...
            'name'      => app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg(),
            'malname'   => app('App\Http\Controllers\RegexvaluesglobController')->getMaltitlereg(),
            'summernoteeng'  => app('App\Http\Controllers\RegexvaluesglobController')->getSumtitlereg(),
            'summernotemal'  => app('App\Http\Controllers\RegexvaluesglobController')->getSumtitlereg(),
        ...
        if ($request->ajax()) {
            ...
            if ($chkrows == 0) {
                ...
                return response()->json(['errors' => 'Already a Footer menu with same name exists.']);
            }
        }
    }
    ...
    {
        $validator = Validator::make($request->all(), [
           'filename'  => 'sometimes|mimes:jpg,jpeg,png,pdf|max:1100',
            'alttext'   => app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg(),
            'name'      => app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg(),
            'malname'   => app('App\Http\Controllers\RegexvaluesglobController')->getMaltitlereg(),
            'summernoteeng'  => app('App\Http\Controllers\RegexvaluesglobController')->getSumtitlereg(),
        ...
        if ($request->ajax()) {
            ...
            $chkrows = Footermenu::where('id', '!=', $request->hidden_id)->where('entitle', $request->name)->exists() ? 1 : 0;
            if ($chkrows == 0) {
    ...
    public function footerlinkupdate(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $chkrows = Footerlink::where('id', '!=', $request->hidden_id)->where('entitle', $request->name)->exists() ? 1 : 0;
            if ($chkrows == 0) {
    ...
    public function socialmediaupdate(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $chkrows = Socialmedia::where('id', '!=', $request->hidden_id)->where('entitle', $request->name)->exists() ? 1 : 0;
            // dd($chkrows);
            if ($chkrows == 0) {
    ...
    public function mainmenuupdate(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            /*$chkrows= Mainmenu::where('entitle',$request->name)->where('id','!=',$request->hidden_id)->exists() ? 1 : 0;
            if($chkrows==0)
            {*/
    ...
    public function submenucreate(Request $request)
    {
        if ($request->ajax()) {
            ...
            $article     = DB::table('articles')->where('status', 1)->orderBy('id', 'asc')->get();
            $deptcategories     = DB::table('deptcategories')->where('status', 1)->orderBy('id', 'asc')->get();


            return response()->json(['menutype' => $menutype, 'mainmenu' => $mainmenu, 'article' => $article,'deptcategories' => $deptcategories]);
        }
    }
    ...
    public function submenustore(Request $request)
    {
        $request->validate([
            ...
            'mainmenuid' => 'required',
            'menutypeid' => 'required',
            'pointto' =>  app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg(),
            'filename'    => 'sometimes|nullable|mimes:jpg,jpeg,png,pdf|max:1100',
            'urlpath'    => 'sometimes|nullable'
        ...
        if ($request->ajax()) {
            ...
            if ($chkrows == 0) {
                ...
                else if ($menutypeid == 13) {
                    $fileName = $request->departmentid;
                } else {
                    $fileName = $request->urlpath;
                }
    ...
    public function submenuedit(Request $request, $id)
    {
        if ($request->ajax()) {
            ...
            $article     = DB::table('articles')->where('status', 1)->orderBy('id', 'asc')->get();
            $deptcategories     = DB::table('deptcategories')->where('status', 1)->orderBy('id', 'asc')->get();
            return response()->json(['resultdata' => $resultdata, 'menutype' => $menutype, 'mainmenu' => $mainmenu, 'article' => $article,'deptcategories' => $deptcategories]);
        }
    }
    ...
    public function subsubmenulist(Request $request)
    {
        $uid = Auth::user()->id;
        $listdata = DB::table('subsubmenus')
            ->select('id', 'entitle', 'maltitle', 'entooltip', 'maltooltip', 'status')
            ->where('users_id', $uid)
            ->get();


        return view('siteadmin.subsubmenulist', compact('listdata'));
    }

    public function subsubmenucreate(Request $request)
    {
        if ($request->ajax()) {


            $menutype     = DB::table('menulinktypes')->where('status', 1)->orderBy('id', 'asc')->get();
            $mainmenu     = DB::table('submenus')->where('status', 1)->orderBy('id', 'asc')->get();
            $article     = DB::table('articles')->where('status', 1)->orderBy('id', 'asc')->get();


            return response()->json(['menutype' => $menutype, 'mainmenu' => $mainmenu, 'article' => $article]);
        }
    }

    public function subsubmenustore(Request $request)
    {
        ...
        if ($request->ajax()) {
            $chkrows = Subsubmenu::where('entitle', $request->name)->exists() ? 1 : 0;
            if ($chkrows == 0) {
                $menutypeid = $request->menutypeid;
                if ($menutypeid == 3) {
                    $date = date('dmYH:i:s');
                    $fileName = 'subsubmenu' . $date . '.' . $request->filename->extension();
                    $request->filename->move(public_path('Subsubmenu'), $fileName);
                } else if ($menutypeid == 4) {
                    $fileName = $request->articleid;
                } else {
                    $fileName = $request->urlpath;
                ...
                return response()->json(['errors' => 'Already a Sub submenu with same name exists.']);
            }
        }
    }

    public function subsubmenuedit(Request $request, $id)
    {
        if ($request->ajax()) {
            $resultdata = Subsubmenu::find($id);
            // dd($resultdata);
            $menutype     = DB::table('menulinktypes')->where('status', 1)->orderBy('id', 'asc')->get();
            $mainmenu     = DB::table('submenus')->where('status', 1)->orderBy('id', 'asc')->get();
            $article     = DB::table('articles')->where('status', 1)->orderBy('id', 'asc')->get();
            return response()->json(['resultdata' => $resultdata, 'menutype' => $menutype, 'mainmenu' => $mainmenu, 'article' => $article]);
        }
    }

    public function subsubmenuupdate(Request $request)
    {
...
// dd($form_data);
            ...
            Subsubmenu::whereId($request->hidden_id)->update($form_data);
            return response()->json(['success' => 'Data is successfully updated']);
            /*} else {
                return response()->json(['errors' => 'Already a submenu with same name exists.']);
            } */
    ...
    public function subsubmenudestroy(Request $request, $id)
    {
        if ($request->ajax()) {
            Subsubmenu::findOrFail($id)->delete();
        }
        return response()->json(['success' => 'Data is successfully updated']);
    }

    public function subsubmenustatus(Request $request, $id)
    {
        if ($request->ajax()) {
            $getstatus = DB::table('subsubmenus')
                ->select('status')
                ->where('id', $id)
                ->first();
            ...
            if ($status == 1) {
                $upd_status = array('status' => 2);
                DB::table('subsubmenus')->where('id', $id)->update($upd_status);
                return response()->json(['success' => 'Data Updated successfully.']);
            } else {
    ...
    public function whatisnewstore(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'icon' => app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg()
        ]);
        if ($validator->fails()) {
            return response()->json(['errors' => $validator->errors()->first()]);
        }
        ...
        if ($request->ajax()) {
            $chkrows = Componentarticle::where('components_id', 3)->where('entitle', $request->entitle)->exists() ? 1 : 0;
            // dd($chkrows);
            if ($chkrows == 0) {
    ...
    public function whatisnewedit(Request $request, $id)
    {
            ...
            // dd($lockstatus);
            if ($lockstatus == 0) {
                return view('siteadmin.whatsnew_edit', compact('id', 'resultdata'));
            } else {
    ...
    public function whatisnewupdate(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $chkrows = Componentarticle::where('id', '!=', $request->hidden_id)->where('entitle', $request->entitle)->where('components_id', 3)->exists() ? 1 : 0;
            //    dd($chkrows);
            if ($chkrows == 0) {
                if (isset($request->displaystatus)) {
                    $dplystat = 1;
                ...
                $updated_data= Componentarticle::whereId($request->hidden_id)->update($form_data);
                if($updated_data)
                {
                    // dd(true);
                    $entitle='Last Updated';
    ...
    {
        if ($request->ajax()) {
            $updated_data=Componentarticle::findOrFail($id)->delete();
        }
        if($updated_data)
                {
                    // dd(true);
    ...
    public function addwhatisnewlist()
    {
        return view('siteadmin.whatsnew_add');
    }
    ...
    {
        return view('siteadmin.addnewdepartment');
    }
    ...
    public function aboutdepartmentstore(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'maltooltip' => app('App\Http\Controllers\RegexvaluesglobController')->getSumtitlereg(),
            'entitle'   => app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg(),
            'maltitle'  => app('App\Http\Controllers\RegexvaluesglobController')->getMaltitlereg(),
            'ensubtitle' => app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg(),
            'malsubtitle' => app('App\Http\Controllers\RegexvaluesglobController')->getMaltitlereg(),
    ...
    public function aboutdepartmentedit(Request $request, $id)
    {
        ...
        $resultdata = Componentarticle::find($id);
        $lockstatus = $resultdata->lock_status;
        return view('siteadmin.aboutdepartmentedit', compact('resultdata'));
        if ($lockstatus == 0) {
            // return response()->json(['resultdata' => $resultdata]);
    ...
    public function aboutdepartmentupdate(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $chkrows = Componentarticle::where('components_id', 4)->where('id', '!=', $request->hidden_id)->where('entitle', $request->entitle)->exists() ? 1 : 0;
            if ($chkrows == 0) {
    ...
    public function aboutportalcreate(Request $request)
    {
        return view('siteadmin.aboutportalcreate');
    }
    ...
    public function aboutportaledit(Request $request, $id)
    {
        ...
        $lockstatusdata = '';
        if ($lockstatus == 0) {
            return view('siteadmin.aboutportaledit', compact('id', 'resultdata', 'lockstatusdata'));
        } else {
            $lockstatusdata = 'The About portal is Locked, so cannot be edited.';
            return view('siteadmin.aboutportaledit', compact('id', 'resultdata', 'lockstatusdata'));
        }
        // if ($request->ajax()) {
        //     $resultdata = Componentarticle::find($id);
    ...
    public function aboutportalupdate(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $chkrows = Componentarticle::where('components_id', 5)->where('id', '!=', $request->hidden_id)->where('entitle', '=', $request->entitle)->exists() ? 1 : 0;
            if ($chkrows == 0) {
    ...
    public function contactusstore(Request $request)
    {
        ...
        //     'ensubtitle' => 'required|max:100|min:3|regex:/(^[-0-9A-Za-z\s ]+$)/',
        //     'malsubtitle' => 'required|max:100|min:3',
        //     'encontent' => 'required|max:5000|min:3',
        //     'malcontent' => 'required|max:10000|min:3',
        //     'icon' => 'required|max:150|min:2'
    ...
    public function archivepolicycreate(Request $request)
    {
        return view('siteadmin.archivepolicycreate');
    }
    ...
    {
        $resultdata = Componentarticle::find($id);
        return view('siteadmin.archivepolicyedit', compact('resultdata'));
    }
    ...
    public function supportcenterstore(Request $request)
    {
        ...
        //     'maltooltip'     => 'required|min:3|max:250',
        //     'entitle'   => 'required|min:3|max:250|regex:/(^[-0-9A-Za-z\s ]+$)/',
        //     'maltitle'  => 'required|min:3|max:250',
        //     'ensubtitle' => 'required|max:250|min:3|regex:/(^[-0-9A-Za-z\s ]+$)/',
        //     'malsubtitle' => 'required|max:250|min:3',
        //     'encontent' => 'required|max:5000|min:3',
        //     'malcontent' => 'required|max:10000|min:3',
        //     'icon' => 'required|max:150|min:2'
    ...
    public function supportcenterupdate(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $chkrows = Componentarticle::where('components_id', 8)->where('id', '!=', $request->hidden_id)->where('entitle',$request->name)->exists() ? 1 : 0;
            if ($chkrows == 0) {
    ...
    public function helpupdate(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $chkrows = Componentarticle::where('components_id', 9)->where('entitle',$request->name)->where('id', '!=', $request->hidden_id)->exists() ? 1 : 0;
            if ($chkrows == 0) {
    ...
    public function guidelineupdate(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $chkrows = Componentarticle::where('components_id', 10)->where('entitle',$request->name)->where('id', '!=', $request->hidden_id)->exists() ? 1 : 0;
            if ($chkrows == 0) {
    ...
    public function serviceinfostore(Request $request)
    {
        ...
        //     'malsubtitle' => 'required|max:100|min:3',
        //     'encontent' => 'required|max:1000|min:3',
        //     'malcontent' => 'required|max:2000|min:3',
        //     'icon' => 'required|max:150|min:2'
...
*/
    ...
    public function serviceinfoupdate(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $chkrows = Componentarticle::where('components_id', 11)->where('entitle', $request->entitle)->where('id', '!=', $request->hidden_id)->exists() ? 1 : 0;
            if ($chkrows == 0) {
    ...
    {
        $resultdata = Componentarticle::find($id);
        return view('siteadmin.addresswithmapedit', compact('resultdata'));
        // if ($request->ajax()) {
        //     $resultdata = Componentarticle::find($id);
        //     return response()->json(['resultdata' => $resultdata]);
        // }
    ...
    public function addresswithmapcreate(Request $request)
    {
        return view('siteadmin.addresswithmapcreate');
    }
...
*/
    ...
    public function sitecompinfoupdate(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $chkrows = Componentarticle::where('components_id', 13)->where('entitle',$request->name)->where('id', '!=', $request->hidden_id)->exists() ? 1 : 0;
            if ($chkrows == 0) {
    ...
    public function hyperlinkpolicyupdate(Request $request)
    {
       $validator = Validator::make($request->all(), [
        ...
        if ($request->ajax()) {
            ...
            $chkrows = Componentarticle::where('components_id', 16)->where('entitle',$request->name)->where('id', '!=', $request->hidden_id)->exists() ? 1 : 0;
            if ($chkrows == 0) {
    ...
    public function privacypolicyupdate(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            // $chkrows = Componentarticle::where('components_id', 17)->where('entitle', $request->entitle)->exists() ? 1 : 0;
            $chkrows = Componentarticle::where('components_id', 17)->where('id', '!=', $request->hidden_id)->where('entitle',$request->name)->exists() ? 1 : 0;
            // dd($chkrows);
            if ($chkrows == 0) {
                if (isset($request->displaystatus)) {
                    $dplystat = 1;
    ...
    public function deptintrocreate(Request $request)
    {
        return view('siteadmin.deptintrocreate');
    }
    ...
    public function deptintrostore(Request $request)
    {
        $request->validate([
            ...
            'malname1'      =>  'required|min:3|max:100|regex:/(^[\P{Malayalam}_.,]+$)/',
            'malname2'      =>  'required|min:3|max:100|regex:/(^[\P{Malayalam}_.,]+$)/',
            'desgn1'        =>  'required|min:3|max:50|regex:/(^[-0-9A-Za-z\s ]+$)/',
            'desgn2'        =>  'required|min:3|max:50|regex:/(^[-0-9A-Za-z\s ]+$)/',
            'maldesgn1'     =>  'required|min:3|max:100|regex:/(^[\P{Malayalam}_.,]+$)/',
            'maldesgn2'     =>  'required|min:3|max:100|regex:/(^[\P{Malayalam}_.,]+$)/',
            'entooltip'     =>  'required|min:3|max:50|regex:/(^[-0-9A-Za-z\s ]+$)/',
            'maltooltip'    =>  'required|min:3|max:100|regex:/(^[\P{Malayalam}_.,]+$)/',
            'entitle'       =>  'required|min:3|max:50|regex:/(^[-0-9A-Za-z\s ]+$)/',
            'maltitle'      =>  'required|min:3|max:100|regex:/(^[\P{Malayalam}_.,]+$)/',
            'ensubtitle'    =>  'required|max:50|min:3|regex:/(^[-0-9A-Za-z\s ]+$)/',
            'malsubtitle'   =>  'required|max:100|min:3|regex:/(^[\P{Malayalam}_.,]+$)/',
            'enbrief'       =>  'required|max:1000|min:3',
            'malbrief'      =>  'required|max:2000|min:3',
            'encontent'     =>  'required|max:5000|min:3',
            'malcontent'    =>  'required|max:10000|min:3'
    ...
    public function deptintroedit_new(Request $request, $id)
    {
        // dd($id);
        $resultdata = Deptintroduction::find($id);

        return view('siteadmin.deptintroedit_new', compact('id', 'resultdata'));
    }
    ...
    public function deptintroupdate(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            // $chkrows = Deptintroduction::where('enuser1', $request->name1)->where('entitle',$request->entitle)->exists() ? 1 : 0;
            $chkrows = Deptintroduction::where('enuser1', '!=', $request->name1)->where('entitle', $request->entitle)->exists() ? 1 : 0;
            // dd($chkrows);
            if ($chkrows == 0) {
    ...
    public function servicelinkupdate(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $chkrows = Componentarticle::where('components_id', 19)->where('entitle', $request->entitle)->where('id', '!=', $request->hidden_id)->exists() ? 1 : 0;
            if ($chkrows == 0) {
    ...
    public function addshortalertlist(Request $request)
    { 
        return view('siteadmin.addshortalertlist');
    ...
    public function shortalertstore(Request $request)
    {
        ...
        if ($request->ajax()) {
            $chkrows = Shortalert::where('entitle', $request->entitle)->exists() ? 1 : 0;
            // dd($chkrows);
            if ($chkrows == 0) {
                if (isset($request->displaystatus)) {
                    $dplystat = 1;
    ...
    public function editshortalert(Request $request,$id)
    {
        // dd($id);
        $resultdata = Shortalert::find($id);
        return view('siteadmin.editshortalert',compact('id','resultdata'));
    }
    ...
    public function shortalertupdate(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $chkrows = Shortalert::where('id', '!=', $request->hidden_id)->where('entitle', $request->entitle)->exists() ? 1 : 0;
            //    dd($chkrows);
            if ($chkrows == 0) {
                ...
                $updated_data=Shortalert::whereId($request->hidden_id)->update($form_data);
                if($updated_data)
                {
                    // dd(true);
                    $entitle='Last Updated';
    ...
    {
        if ($request->ajax()) {
            $updated_data= Shortalert::findOrFail($id)->delete();
        }
        if($updated_data)
                {
                    // dd(true);
    ...
    public function addlongalertlist()
    {
        return view('siteadmin.longalertlist_add');
    }
...
public function editlongalertlist(Request $request,$id)
{
    // dd(true);
    $resultdata = Longalert::find($id);
    return view('siteadmin.longalertlist_edit',compact('id','resultdata'));
}
...
//  dd(true);
        ...
        if ($request->ajax()) {
            ...
            $chkrows = Longalert::where('id', '!=', $request->hidden_id)->where('entitle', '=', $request->entitle)->exists() ? 1 : 0;
        //    dd($request->enbrief);
            if ($chkrows == 0) {
                if (isset($request->displaystatus)) {
                    $dplystat = 1;
                ...
                $updated_data=Longalert::whereId($request->hidden_id)->update($form_data);
                if($updated_data)
                {
                    // dd(true);
                    $entitle='Last Updated';
    ...
    {
        if ($request->ajax()) {
          $updated_data=  Longalert::findOrFail($id)->delete();
        }
        if($updated_data)
                {
                    // dd(true);
    ...
    public function mediaalertcreate(Request $request)
    {
        ...
        return view('siteadmin.addmediaalert', compact('filetype', 'contenttype'));
        // }
    }
    ...
    public function mediaalertstore(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'encontent' => app('App\Http\Controllers\RegexvaluesglobController')->getSumtitlereg(),
            'malcontent' => app('App\Http\Controllers\RegexvaluesglobController')->getSumtitlereg(),
            'image' => 'required|mimes:jpg,jpeg,png,mp3,mp4|max:15360',
            'alttext'   => app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg(),
...
*/
    ...
    public function mediaalertedit(Request $request, $id)
    {
        ...
        $contenttypes_id = $resultdata->contenttypes_id;
        $filetypes_id = $resultdata->filetypes_id;

        $filetype     = DB::table('filetypes')->where('status', 1)->orderBy('id', 'asc')->get();
        $contenttype  = DB::table('contenttypes')->where('status', 1)->orderBy('id', 'asc')->get();
        $file_ex1 = $resultdata->file;
        $file_ex2 = explode('.', $file_ex1);
        $file_ex = $file_ex2[1];
        // dd($contenttype);
        // return response()->json(['resultdata' => $resultdata, 'filetype' => $filetype, 'contenttype' => $contenttype, 'file_ex' => $file_ex]);
        return view('siteadmin.editmediaalert', compact('resultdata', 'contenttype', 'filetype', 'contenttypes_id', 'filetypes_id'));
        // echo 'ho';
        // }
    }
    ...
    public function mediaalertupdate(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'encontent' => app('App\Http\Controllers\RegexvaluesglobController')->getSumtitlereg(),
            'malcontent' => app('App\Http\Controllers\RegexvaluesglobController')->getSumtitlereg(),
            'image' => 'sometimes|mimes:jpg,jpeg,png,mp3,mp4|max:15360',
            'alttext'   => app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg(),
            'size' =>  app('App\Http\Controllers\RegexvaluesglobController')->getNumsizedurareg(),
            'duration' =>  app('App\Http\Controllers\RegexvaluesglobController')->getNumsizedurareg(),
            'filetypes_id' => 'required',
        ...
        $chkrows = Mediaalert::where('id', '!=', $request->hidden_id)->where('entitle', '=', $request->entitle)->exists() ? 1 : 0;
        // dd( $chkrows);
        if ($chkrows == 0) {
            ...
            // dd($request->filetypes_id);
            $updated_data=Mediaalert::whereId($request->hidden_id)->update($form_data);
            if($updated_data)
                {
                    // dd(true);
                    $entitle='Last Updated';
    ...
    {
        if ($request->ajax()) {
          $updated_data=  Mediaalert::findOrFail($id)->delete();
        }
        if($updated_data)
                {
                    // dd(true);
