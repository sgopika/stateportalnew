...
class AppadminController extends Controller
{
    ...
    public function designationupdate(Request $request)
    {
        ...
        if($request->ajax())
        {
            $chkrows= Designation::where('entitle',$request->name)->where([['id','!=',$request->hidden_id],['entitle','=',$request->name]])
            ->orWhere([['id','!=',$request->hidden_id],['maltitle','=',$request->malname]])
            ->exists() ? 1 : 0;
            if($chkrows==0){
	            $form_data = array(
	                'entitle'    =>  $request->name,
    ...
    public function departmentupdate(Request $request)
    {
        ...
        if($request->ajax())
        {
            $chkrows= Department::where('entitle',$request->name)->where([['id','!=',$request->hidden_id],['entitle','=',$request->name]])
            ->orWhere([['id','!=',$request->hidden_id],['maltitle','=',$request->malname]])
            ->exists() ? 1 : 0;
            if($chkrows==0){
	            $form_data = array(
    ...
    public function hierarchyupdate(Request $request)
    {
        ...
        if($request->ajax())
        {
            $chkrows= Hierarchy::where('entitle',$request->name)->where([['id','!=',$request->hidden_id],['entitle','=',$request->name]])
            ->orWhere([['id','!=',$request->hidden_id],['maltitle','=',$request->malname]])
            ->exists() ? 1 : 0;
            if($chkrows==0){
	            $form_data = array(
    ...
    public function membershiprequeststore(Request $request)
    {
        ...
        if($request->ajax())
        {
            $chkrows= Membershiprequest::where([['id','!=',$request->hidden_id],['name','=',$request->name],['mobile','=',$request->mobile],['email','=',$request->mobile]])->exists() ? 1 : 0;
    ...
    public function staffupdate(Request $request)
    {
        ...
        if(isset($request->poster1))
		{
	        ...
	        $request->poster1->move(public_path('Staff'), $posterName1);
