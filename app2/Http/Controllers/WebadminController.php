...
class WebadminController extends Controller
{
    ...
    public function articleupdate(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            if ($chkrows == 0) {
                ...
                $updated_data=Article::whereId($request->hidden_id)->update($form_data);
    ...
    {
        if ($request->ajax()) {
            $updated_data= Article::findOrFail($id)->delete();
    ...
    public function createappdeartmentlist(Request $request)
    {
        $listdata = DB::table('appdepartments')
        ->select('id', 'entitle', 'maltitle', 'status')
        ->get();

    return view('webadmin.createappdeartmentlist', compact('listdata'));
    }
    public function appdepartmentstore(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'entitle'          => app('App\Http\Controllers\RegexvaluesglobController')->getEntitlereg(),
            'maltitle'       => app('App\Http\Controllers\RegexvaluesglobController')->getMaltitlereg(),
            'enabout'     => app('App\Http\Controllers\RegexvaluesglobController')->getEnSumtitlereg(),
            'malabout'    => app('App\Http\Controllers\RegexvaluesglobController')->getMalSumtitlereg(),
            'enstructure'     => app('App\Http\Controllers\RegexvaluesglobController')->getEnSumtitlereg(),
            'malstructure'    => app('App\Http\Controllers\RegexvaluesglobController')->getMalSumtitlereg(),
            'encontact'     => app('App\Http\Controllers\RegexvaluesglobController')->getEnSumtitlereg(),
            'malcontact'    => app('App\Http\Controllers\RegexvaluesglobController')->getMalSumtitlereg(),
            // 'enservices'     => app('App\Http\Controllers\RegexvaluesglobController')->getEnSumtitlereg(),
            // 'malservices'    => app('App\Http\Controllers\RegexvaluesglobController')->getMalSumtitlereg(),
            // 'enrelatedlinks'     => app('App\Http\Controllers\RegexvaluesglobController')->getEnSumtitlereg(),
            // 'malrelatedlinks'    => app('App\Http\Controllers\RegexvaluesglobController')->getMalSumtitlereg(),
...
// dd($enabout);
    ...
    public function editappdeartmentlist(Request $request,$id)
    {
    return view('webadmin.editappdeartmentlist',compact('id'));
    }
    ...
    public function createappsectionlist(Request $request)
    {
        // dd(true);
        $uid = Auth::user()->id;
        $listdata = DB::table('appsections')
        ...
        return view('webadmin.createappsectionlist', compact('listdata','uid'));
    }
    ...
    public function appsectionstore(Request $request)
    {
        ...
        $request->validate([
            ...
            'ensectiondetails'   => 'required|min:3|max:1000',
...
public function editappsectionlist(Request $request,$id)
{
    // dd($id);
    $resultdata = Appsection::find($id);
    $appdepartment = DB::table('appdepartments')->where('status', 1)->orderBy('id', 'asc')->get();
    return view('webadmin.editappsectionlist', compact('resultdata','appdepartment','id'));
