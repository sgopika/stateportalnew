...
class DeptasstController extends Controller
{
    ...
    public function appdepartmentstore(Request $request)
    {
         ...
         $request->validate([
            ...
            'enabout'   =>'required|min:3|max:5000|regex:/(^[-0-9A-Za-z\s ]+$)/',
            'malabout'  =>'required|min:3|max:10000',
            'enstructure'   =>'required|min:3|max:5000|regex:/(^[-0-9A-Za-z\s ]+$)/',
            'malstructure'  =>'required|min:3|max:10000',
            'encontact'   =>'required|min:3|max:5000|regex:/(^[-0-9A-Za-z\s ]+$)/',
            'malcontact'  =>'required|min:3|max:10000',
            'enrelatedlinks'   =>'required|min:3|max:5000|regex:/(^[-0-9A-Za-z\s ]+$)/',
            'malrelatedlinks'  =>'required|min:3|max:10000',
            'enservices'   =>'required|min:3|max:5000',
            'malservices'  =>'required|min:3|max:10000'
    ...
    public function appdepartmentupdate(Request $request)
    {
        $request->validate([
            'entitle'   =>'required|min:3|max:250|regex:/(^[-0-9A-Za-z\s ]+$)/',
            'maltitle'  =>'required|min:3|max:250',
            'enabout'   =>'required|min:3|max:10000|regex:/(^[-0-9A-Za-z.,()&;\/\s ]+$)/',
            'malabout'  =>'required|min:3|max:10000',
            'enstructure'   =>'required|min:3|max:10000',
            'malstructure'  =>'required|min:3|max:10000',
            'encontact'   =>'required|min:3|max:10000|regex:/(^[-0-9A-Za-z.,()&;\/\s \:]+$)/',
            'malcontact'  =>'required|min:3|max:10000',
            'enrelatedlinks'   =>'required|min:3|max:10000|regex:/(^[-0-9A-Za-z\s \&;:,.]+$)/',
            'malrelatedlinks'  =>'required|min:3|max:10000',
            'enservices'   =>'required|min:3|max:10000',
            'malservices'  =>'required|min:3|max:10000'
