...
Route::get('/gallerypreview', 'PortalController@gallerypreview')->name('gallerypreview');
Route::get('/activitydetail/{id}', 'PortalController@activitydetail')->name('activitydetail');
Route::get('/articledetail/{id}', 'PortalController@articledetail')->name('articledetail');
Route::get('/gallerypage/{id}', 'PortalController@gallerypage')->name('gallerypage');
Route::get('/modalpop/{id}', 'PortalController@modalpop')->name('modalpop');
Route::get('/submenuslist/{id}', 'PortalController@submenuslist')->name('submenuslist');
Route::get('/deptdetails', 'PortalController@deptdetails')->name('deptdetails');
Route::get('/deptdetailview/{id}', 'PortalController@deptdetailview')->name('deptdetailview');
Route::get('/subdetail/{id}/{pid}', 'PortalController@subdetail')->name('subdetail');
Route::get('/subsubdetail/{id}/{pid}', 'PortalController@subsubdetail')->name('subsubdetail');
Route::get('/feedback', 'PortalController@feedback')->name('feedback');
Route::get('/contactus', 'PortalController@contactus')->name('contactus');
Route::get('/mainarticles/{id}', 'PortalController@mainarticles')->name('mainarticles');
Route::get('/deptintrodetail/{id}', 'PortalController@deptintrodetail')->name('deptintrodetail');
Route::get('/newsletterpreview/{id}', 'PortalController@newsletterpreview')->name('newsletterpreview');
Route::get('/setvaluesencrypt/{id}', 'PortalController@setvaluesencrypt')->name('setvaluesencrypt');
Route::get('/sitemap', 'PortalController@index')->name('sitemap');
Route::get('/mediaalertdetail', 'PortalController@mediaalertdetail')->name('mediaalertdetail');
Route::get('/whatsnewdetailwise/{id}', 'PortalController@whatsnewdetailwise')->name('whatsnewdetailwise');
Route::get('/whatsnewdetail', 'PortalController@whatsnewdetail')->name('whatsnewdetail');
Route::post('/feedbackstore', 'PortalController@feedbackstore')->name('feedbackstore');
Route::post('/search', 'PortalController@search')->name('search');

Route::get('/mainlogin2', 'PortalController@mainlogin2')->name('mainlogin2');
Route::get('/setvalueshomepage2', 'PortalController@setvalueshomepage2')->name('setvalueshomepage2');
Route::get('/appdepartmentdetail/{catid}', 'PortalController@appdepartmentdetail')->name('appdepartmentdetail');
Route::get('/appdepartmentcontent/{id}/{type}', 'PortalController@appdepartmentcontent')->name('appdepartmentcontent');
Route::get('/departmentdetail/{id}', 'PortalController@departmentdetail')->name('departmentdetail');
Route::get('/appsectioncontent/{id}', 'PortalController@appsectioncontent')->name('appsectioncontent');
...
Route::group(['middleware' => ['auth', 'App\Http\Middleware\SiteAdmin']], function () {
	...
	Route::get('/siteadmin/articleposterdel/{id}', 'SiteadminController@articleposterdel')->middleware('auth');
	
	Route::get('/webadmin/articleposterdel/{id}', 'WebadminController@articleposterdel')->middleware('auth');
	Route::get('/editor/articleposterdel/{id}', 'EditorController@articleposterdel')->middleware('auth');
	...
	/* Sub Menu */
	Route::get('/siteadmin/subsubmenulist', 'SiteadminController@subsubmenulist')->name('siteadmin.subsubmenulist')->middleware('auth');
	Route::get('siteadmin/subsubmenucreate', 'SiteadminController@subsubmenucreate')->name('siteadmin.subsubmenucreate')->middleware('auth');
	Route::post('/siteadmin/subsubmenustore', 'SiteadminController@subsubmenustore')->name('siteadmin.subsubmenustore')->middleware('auth');
	Route::get('/siteadmin/subsubmenuedit/{id}', 'SiteadminController@subsubmenuedit')->middleware('auth');
	Route::post('/siteadmin/subsubmenuupdate', 'SiteadminController@subsubmenuupdate')->name('siteadmin.subsubmenuupdate')->middleware('auth');
	Route::get('/siteadmin/subsubmenudestroy/{id}', 'SiteadminController@subsubmenudestroy')->middleware('auth');
	Route::get('/siteadmin/subsubmenustatus/{id}', 'SiteadminController@subsubmenustatus')->middleware('auth');
	...
	Route::get('/siteadmin/addnewdepartment', 'SiteadminController@addnewdepartment')->name('siteadmin.addnewdepartment')->middleware('auth');
	...
	Route::get('/siteadmin/aboutportaledit/{id}', 'SiteadminController@aboutportaledit')->name('siteadmin.aboutportaledit')->middleware('auth');
	...
	Route::get('/siteadmin/aboutportalcreate', 'SiteadminController@aboutportalcreate')->name('siteadmin.aboutportalcreate')->middleware('auth');
	...
	Route::get('/siteadmin/archivepolicycreate', 'SiteadminController@archivepolicycreate')->name('siteadmin.archivepolicycreate')->middleware('auth');
	...
	Route::get('/siteadmin/addresswithmapcreate', 'SiteadminController@addresswithmapcreate')->name('siteadmin.addresswithmapcreate')->middleware('auth');
	...
	Route::get('siteadmin/deptintroedit_new/{id}', 'SiteadminController@deptintroedit_new')->middleware('auth');
	...
	Route::get('siteadmin/widgetlinkcreate', 'WebadminController@widgetlinkcreate')->name('siteadmin.widgetlinkcreate')->middleware('auth');
	...
	Route::get('/siteadmin/addshortalertlist', 'SiteadminController@addshortalertlist')->middleware('auth');
	Route::post('/siteadmin/shortalertstore', 'SiteadminController@shortalertstore')->name('siteadmin.shortalertstore')->middleware('auth');
	Route::get('/siteadmin/editshortalert/{id}', 'SiteadminController@editshortalert')->middleware('auth');
	...
	Route::get('/siteadmin/addlongalertlist', 'SiteadminController@addlongalertlist')->middleware('auth');
	Route::get('/siteadmin/longalertlist_add', 'SiteadminController@longalertlist_add')->name('siteadmin.longalertlist_add')->middleware('auth');
	Route::post('/siteadmin/longalertstore', 'SiteadminController@longalertstore')->name('siteadmin.longalertstore')->middleware('auth');
	Route::get('/siteadmin/editlongalertlist/{id}', 'SiteadminController@editlongalertlist')->middleware('auth');
	...
	Route::get('siteadmin/activityadd', 'WebadminController@activityadd')->name('siteadmin.activityadd')->middleware('auth');
	...
	Route::get('/siteadmin/downloadlist', 'WebadminController@downloadlist')->name('siteadmin.downloadlist')->middleware('auth');
	Route::get('siteadmin/downloadcreate', 'WebadminController@downloadcreate')->name('siteadmin.downloadcreate')->middleware('auth');
	Route::post('/siteadmin/downloadstore', 'WebadminController@downloadstore')->name('siteadmin.downloadstore')->middleware('auth');
	Route::get('/siteadmin/downloadedit/{id}', 'WebadminController@downloadedit')->middleware('auth');
	Route::post('/siteadmin/downloadupdate', 'WebadminController@downloadupdate')->name('siteadmin.downloadupdate')->middleware('auth');
	Route::get('/siteadmin/downloaddestroy/{id}', 'WebadminController@downloaddestroy')->middleware('auth');
	Route::get('/siteadmin/downloadstatus/{id}', 'WebadminController@downloadstatus')->middleware('auth');
	Route::get('/siteadmin/downloadfiletypelist/{id}', 'WebadminController@downloadfiletypelist')->middleware('auth');
...
Route::group(['middleware' => ['auth', 'App\Http\Middleware\WebAdmin']], function () {
	...
	Route::get('/webadmin/buttonlist', 'SiteadminController@buttonlist')->name('webadmin.buttonlist')->middleware('auth');
	Route::get('webadmin/btncreate', 'SiteadminController@btncreate')->name('webadmin.btncreate')->middleware('auth');
	Route::post('/webadmin/buttonstore', 'SiteadminController@buttonstore')->name('webadmin.buttonstore')->middleware('auth');
	Route::get('/webadmin/buttonedit/{id}', 'SiteadminController@buttonedit')->middleware('auth');
	Route::post('/webadmin/buttonupdate', 'SiteadminController@buttonupdate')->name('webadmin.buttonupdate')->middleware('auth');
	Route::get('/webadmin/buttondestroy/{id}', 'SiteadminController@buttondestroy')->middleware('auth');
	Route::get('/webadmin/buttonstatus/{id}', 'SiteadminController@buttonstatus')->middleware('auth');
	...
	Route::get('webadmin/appdepartmentcreate', 'WebadminController@appdepartmentcreate')->name('webadmin.appdepartmentcreate')->middleware('auth');
	Route::get('webadmin/createappdeartmentlist', 'WebadminController@createappdeartmentlist')->name('webadmin.createappdeartmentlist')->middleware('auth');
	...
	Route::get('webadmin/editappdeartmentlist/{id}', 'WebadminController@editappdeartmentlist')->name('webadmin.editappdeartmentlist')->middleware('auth');
	...
	Route::get('webadmin/createappsectionlist', 'WebadminController@createappsectionlist')->name('webadmin.createappsectionlist')->middleware('auth');
    ...
    Route::get('/webadmin/editappsectionlist/{id}', 'WebadminController@editappsectionlist')->middleware('auth');
	...
	Route::get('webadmin/widgetlinkcreate', 'WebadminController@widgetlinkcreate')->name('webadmin.widgetlinkcreate')->middleware('auth');
	...
	/* Sub Menu */
	Route::get('/webadmin/subsubmenulist', 'SiteadminController@subsubmenulist')->name('webadmin.subsubmenulist')->middleware('auth');
	Route::get('webadmin/subsubmenucreate', 'SiteadminController@subsubmenucreate')->name('webadmin.subsubmenucreate')->middleware('auth');
	Route::post('/webadmin/subsubmenustore', 'SiteadminController@subsubmenustore')->name('webadmin.subsubmenustore')->middleware('auth');
	Route::get('/webadmin/subsubmenuedit/{id}', 'SiteadminController@subsubmenuedit')->middleware('auth');
	Route::post('/webadmin/subsubmenuupdate', 'SiteadminController@subsubmenuupdate')->name('webadmin.subsubmenuupdate')->middleware('auth');
	Route::get('/webadmin/subsubmenudestroy/{id}', 'SiteadminController@subsubmenudestroy')->middleware('auth');
	Route::get('/webadmin/subsubmenustatus/{id}', 'SiteadminController@subsubmenustatus')->middleware('auth');
...
Route::group(['middleware' => ['auth', 'App\Http\Middleware\Depthead']], function () {
	...
	Route::get('/depthead/shortalertlist', 'SiteadminController@shortalertlist')->name('depthead.shortalertlist')->middleware('auth');
	Route::get('/depthead/addshortalertlist', 'SiteadminController@addshortalertlist')->middleware('auth');
	Route::post('/depthead/shortalertstore', 'SiteadminController@shortalertstore')->name('depthead.shortalertstore')->middleware('auth');
	Route::get('/depthead/editshortalert/{id}', 'SiteadminController@editshortalert')->middleware('auth');
	Route::get('/depthead/shortalertedit/{id}', 'SiteadminController@shortalertedit')->middleware('auth');
	Route::post('/depthead/shortalertupdate', 'SiteadminController@shortalertupdate')->name('depthead.shortalertupdate')->middleware('auth');
	Route::get('/depthead/shortalertdestroy/{id}', 'SiteadminController@shortalertdestroy')->middleware('auth');
	Route::get('/depthead/shortalertstatus/{id}', 'SiteadminController@shortalertstatus')->middleware('auth');
});
});