...
class SiteadminController extends Controller
{
 ...
 public function btncreate(Request $request)
    ...
    public function logolist(Request $request)
    {
        ...
        return view('siteadmin.logolist',compact('listdata'));
    }

     public function logotypecheck(Request $request, $id)
    {
        if($request->ajax())
        {
            $chkrows= Logo::where('logotype','!=',$id)->where('status',1)->exists() ? 1 : 0;
            //dd($chkrows);
            if($chkrows==0)
            {
    ...
    public function logoupdate(Request $request)
    {
        ...
        if($request->ajax())
        {
             ...
             $chkrows= Logo::where('id','!=',$request->hidden_id)->where('entooltip',$request->entooltip)->exists() ? 1 : 0;
            if($chkrows==0)
            {
...
/* Title  */
    ...
    public function footerupdate(Request $request)
    {
        ...
        if($request->ajax())
        {
            $chkrows= Footer::where('id','!=',$request->hidden_id)->where('alt',$request->alttext)->exists() ? 1 : 0;
            if($chkrows==0){
    ...
    public function footermenustore(Request $request)
    {
        $request->validate([
            ...
            'name'  =>'required|min:3|max:20|regex:/(^[-0-9A-Za-z\s ]+$)/',
            'malname'  =>'required|min:3|max:50|regex:/(^[\P{Malayalam}_.,]+$)/',
            'summernoteeng'  =>'required|min:3|max:5000',
            'summernotemal'  =>'required|min:3|max:5000'
 ...
 /* Footer Link */
    ...
    public function mainmenuupdate(Request $request)
    {
        ...
        if($request->ajax())
        {
            ...
            $chkrows= Mainmenu::where('id','!=',$request->hidden_id)->where('entitle',$request->name)->exists() ? 1 : 0;
            if($chkrows==0)
            {
    ...
    public function submenuupdate(Request $request)
    {
        ...
        if($request->ajax())
        {
            ...
            $chkrows= Submenu::where('id','!=',$request->hidden_id)->where('entitle',$request->name)->exists() ? 1 : 0;
            if($chkrows==0)
            {
...
/* What's New */
    ...
    public function aboutdepartmentupdate(Request $request)
    {
        ...
        if($request->ajax())
        {
            ...
            $chkrows= Componentarticle::where('components_id',4)->where('entooltip',$request->hidden_id)->where('id','!=',$request->entooltip)->exists() ? 1 : 0;
            if($chkrows==0){
...
public function guidelinelist(Request $request)
       ...
       public function guidelinestore(Request $request)
    {
        ...
        if($request->ajax())
        {
            $chkrows= Footermenu::where('entitle',$request->name)->where('components_id',11)->exists() ? 1 : 0;
            if($chkrows==0){
                 if(isset($request->displaystatus)){
                            $dplystat = 1;
                        } else {
    ...
    public function guidelineupdate(Request $request)
    {
        ...
        if($request->ajax())
        {
            ...
            $chkrows= Footermenu::where('components_id',11)->where('id','!=',$request->hidden_id)->exists() ? 1 : 0;
            if($chkrows==0){
...
public function copyrightpolicylist(Request $request)
       ...
       public function copyrightpolicystore(Request $request)
    {
        ...
        if($request->ajax())
        {
             $chkrows= Footermenu::where('entitle',$request->name)->where('components_id',16)->exists() ? 1 : 0;
            if($chkrows==0){
    ...
    public function copyrightpolicyupdate(Request $request)
    {
        ...
        if($request->ajax())
        {
            ...
            $chkrows= Footermenu::where('components_id',16)->where('id','!=',$request->hidden_id)->exists() ? 1 : 0;
            if($chkrows==0){                
    ...
    public function hyperlinkpolicyupdate(Request $request)
    {
       $request->validate([
        ...
        if($request->ajax())
        {
            ...
            $chkrows= Footermenu::where('entitle',$request->name)->where('id','!=',$request->hidden_id)->exists() ? 1 : 0;
             //dd($chkrows);
            if($chkrows==0){
...
public function privacypolicylist(Request $request)
       ...
       public function privacypolicystore(Request $request)
    {
        ...
        if($request->ajax())
        {
            $chkrows= Footermenu::where('entitle',$request->name)->where('components_id',18)->exists() ? 1 : 0;
            if($chkrows==0){
    ...
    public function privacypolicyupdate(Request $request)
    {
        ...
        if($request->ajax())
        {
            ...
            $chkrows= Footermenu::where('components_id',18)->where('id','!=',$request->hidden_id)->exists() ? 1 : 0;
            if($chkrows==0){
...
public function termsandconditionlist(Request $request)
       ...
       public function termsandconditionstore(Request $request)
    {
       $request->validate([
        ...
        if($request->ajax())
        {
            $chkrows= Footermenu::where('entitle',$request->name)->where('components_id',19)->exists() ? 1 : 0;
            if($chkrows==0){
    ...
    public function termsandconditionupdate(Request $request)
    {
       $request->validate([
        ...
        if($request->ajax())
        {
            ...
            $chkrows= Footermenu::where('components_id',19)->where('id','!=',$request->hidden_id)->exists() ? 1 : 0;
            if($chkrows==0){
...
public function servicelinklist(Request $request)
       ...
       public function servicelinkstore(Request $request)
    {
        ...
        // //     'encontent'=>'required|max:1000|min:3',
        // //     'malcontent'=>'required|max:1000|min:3',
        // //     'urlpath'=>'required|max:1000|min:3',
        // //     'icon'=>'required|max:150|min:2'
...
// dd($request->all());
        ...
        if($request->ajax())
        {
            $chkrows= Componentarticle::where('entitle',$request->name)->where('components_id',20)->exists() ? 1 : 0;
            if($chkrows==0){
                 if(isset($request->displaystatus)){
                            $dplystat = 1;
                        } else {
    ...
    public function servicelinkupdate(Request $request)
    {
        ...
        if($request->ajax())
        {
            ...
            $chkrows= Componentarticle::where('components_id',20)->where('id','!=',$request->hidden_id)->where('entooltip','=',$request->entooltip)->exists() ? 1 : 0;
            if($chkrows==0){
