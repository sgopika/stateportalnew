...
class WebadminController extends Controller
{
    ...
    public function bannerstore(Request $request)
    {
		$request->validate([
            ...
            'image' => 'required|mimes:jpg,jpeg,png,mp4|max:1100',
            ...
            if($chkrows==0){
	            ...
	            $resultsave->save();
	            return redirect('siteadmin/bannerlist')->with('success', 'Banner Added!');
	        } else {
	        	return redirect('siteadmin/bannerlist')->with('errors', 'Already a Banner with same name exists.');
	        }    
    ...
    public function bannerupdate(Request $request)
    {
		$request->validate([
            ...
            'imageedit' => 'mimes:jpg,jpeg,png,mp4|max:1100',
            ...
            if($chkrows==0){
	            ...
	            return redirect('siteadmin/bannerlist')->with('success', 'Banner Updated!');
	        } else {
	        	return redirect('siteadmin/bannerlist')->with('errors', 'Already a Banner with same name exists.');
	        }    
    ...
    public function promocampaignstore(Request $request)
    {
		$request->validate([
            ...
            'size'=>'required|max:50|min:2|regex:/(^[0-9.\s ]+$)/',
            'duration'=>'required|max:50|min:2|regex:/(^[0-9.\s ]+$)/',
    ...
    public function promocampaignupdate(Request $request)
    {
		$request->validate([
            ...
            'size1'=>'required|max:50|min:2|regex:/(^[0-9.\s ]+$)/',
            'duration1'=>'required|max:50|min:2|regex:/(^[0-9.\s ]+$)/',
    ...
    public function galleryupdate(Request $request)
    {
		$request->validate([
            ...
            'maltitle1'	=>'required|min:3|max:50|regex:/(^[\P{Malayalam}_.,]+$)/',
            'maltooltip1'	=>'required|min:3|max:50|regex:/(^[\P{Malayalam}_.,]+$)/',
            'imageedit' => 'mimes:jpg,jpeg,png|max:1100',
            'alttext1'	=>'required|min:3|max:20',
 ...
 //            'malsubtitle'	=>'required|min:3|max:100|regex:/(^[\P{Malayalam}_.,]+$)/',
 //            'entooltip'	=>'required|min:3|max:20|regex:/(^[-0-9A-Za-z\s ]+$)/',
 //            'maltooltip'	=>'required|min:3|max:50|regex:/(^[\P{Malayalam}_.,]+$)/',
 //            'enauthor'	=>'required|min:3|max:200',
 ...
 //            'entooltip1'	=>'required|min:3|max:20|regex:/(^[-0-9A-Za-z\s ]+$)/',
 //            'maltooltip1'	=>'required|min:3|max:50|regex:/(^[\P{Malayalam}_.,]+$)/',
 //            'enauthor1'	=>'required|min:3|max:200',
 ...
 //    }
    ...
    public function appdepartmentstore(Request $request)
    {
         ...
         $request->validate([
            ...
            'enstructure'   =>'required|min:3|max:1000',
            'malstructure'  =>'required|min:3|max:1000',
            'encontact'   =>'required|min:3|max:1000',
            'malcontact'  =>'required|min:3|max:1000',
            'enrelatedlinks'   =>'required|min:3|max:1000',
    ...
    public function appsectionstore(Request $request)
    {
         ...
         $request->validate([
            ...
            'malsectionname'  =>'required|min:3|max:50|regex:/(^[\P{Malayalam}_.,]+$)/',
