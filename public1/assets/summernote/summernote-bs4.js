  ...
  Table_createClass(Table, [{
    ...
    */
    ...
    value: function createTable(colCount, rowCount, options) {
      ...
      trHTML = trs.join('');
      var $table = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<table class='+'teste'+'>' + trHTML + '</table>');
...
function () {
  ...
  Buttons_createClass(Buttons, [{
    ...
    value: function addTablePopoverButtons() {
      var _this5 = this;
      this.context.memo('button.mergeRow', function () {
        return _this5.button({
          className: 'btn-md',
          contents: _this5.ui.icon(_this5.options.icons.rollback),
          tooltip:'Merge Column',
          click: function(){
         
          //   $('.sabstab').on('click', 'tbody tr td:first-child', function(e) {  
          //     var text = $(this).siblings('td').find('span').text();
          //     alert(text+"h");
          // });
          
          $('.sabstab tr').each(function (e) {
...
external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.extend(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a.summernote, {
  ...
  options: {
    ...
    popover: {
      ...
      table: [['add', ['mergeRow','addRowDown', 'addRowUp', 'addColLeft', 'addColRight']], ['delete', ['deleteRow', 'deleteCol', 'deleteTable']]],
